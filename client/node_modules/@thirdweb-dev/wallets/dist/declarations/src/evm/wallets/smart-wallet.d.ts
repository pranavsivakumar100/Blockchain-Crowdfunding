...
import type { SmartWalletConfig, SmartWalletConnectionArgs, TransactionOptions } from "../connectors/smart-wallet/types";
...
export { type AccessibleSmartWallets, getAllSigners, getAllSmartWallets, getSmartWalletAddress, isSmartWalletDeployed, getUserOpReceipt, } from "../connectors/smart-wallet/utils";
...
export declare class SmartWallet extends AbstractClientWallet<SmartWalletConfig, SmartWalletConnectionArgs> {
     ...
     * @returns `TransactionResult` containing the transaction receipt.
     */
    sendBatch(transactions: Transaction[], options?: TransactionOptions): Promise<providers.TransactionResponse>;
    /**
     ...
     */
    executeRaw(transaction: utils.Deferrable<providers.TransactionRequest>, options?: TransactionOptions): Promise<TransactionResult>;
    /**
     ...
     * @returns
     */
    estimate(transaction: Transaction<any>, options?: TransactionOptions): Promise<{
        ether: string;
     ...
     * @returns
     */
    estimateRaw(transactions: utils.Deferrable<providers.TransactionRequest>, options?: TransactionOptions): Promise<{
        ether: string;
        wei: import("ethers").BigNumber;
        details: {
            deployGasLimit: import("ethers").BigNumber;
     ...
     * @returns The transaction result
     */
    sendBatchRaw(transactions: utils.Deferrable<providers.TransactionRequest>[], options?: TransactionOptions): Promise<providers.TransactionResponse>;
    /**
     ...
     * @returns The transaction receipt
     */
    executeBatchRaw(transactions: utils.Deferrable<providers.TransactionRequest>[], options?: TransactionOptions): Promise<TransactionResult>;
    /**
     ...
     */
    connect(connectOptions?: ConnectParams<SmartWalletConnectionArgs> | undefined): Promise<string>;
}
