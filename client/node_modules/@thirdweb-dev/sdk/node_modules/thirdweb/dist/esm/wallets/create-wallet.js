            ...
            const wallet = {
                ...
                autoConnect: async (options) => {
                    ...
                    if (id !== "walletConnect" && injectedProvider(id)) {
                        const { autoConnectInjectedWallet } = await import("./injected/index.js");
                ...
                connect: async (options) => {
                    ...
                    if (injectedProvider(id)) {
                        const { connectInjectedWallet } = await import("./injected/index.js");
...
export function inAppWallet(createOptions) {
    ...
    return {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
            const { autoConnectInAppWallet } = await import("./in-app/core/wallet/index.js");
        ...
        connect: async (options) => {
            const { connectInAppWallet } = await import("./in-app/core/wallet/index.js");
...
function coinbaseWalletSDK(createOptions) {
    ...
    return {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
            const { autoConnectCoinbaseWalletSDK } = await import("./coinbase/coinbaseSDKWallet.js");
        ...
        connect: async (options) => {
            const { connectCoinbaseWalletSDK } = await import("./coinbase/coinbaseSDKWallet.js");
