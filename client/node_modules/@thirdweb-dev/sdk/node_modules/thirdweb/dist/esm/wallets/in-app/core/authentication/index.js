...
import { AuthProvider, UserWalletStatus, } from "./type.js";
...
async function getInAppWalletConnector(client) {
    ...
    let ewSDK;
    if (isBrowser()) {
        const { InAppWebConnector } = await import("../../web/lib/web-connector.js");
...
export const oauthStrategyToAuthProvider = {
