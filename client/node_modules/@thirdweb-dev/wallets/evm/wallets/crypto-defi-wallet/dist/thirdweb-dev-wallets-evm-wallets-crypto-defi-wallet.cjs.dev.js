  ...
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        } = await Promise.resolve().then(function () { return require('../../../connectors/crypto-defi-wallet/dist/thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.cjs.dev.js'); });
