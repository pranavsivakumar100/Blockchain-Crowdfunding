...
// node_modules/@thirdweb-dev/wallets/dist/embedded-wallet-cc3ca3c9.browser.esm.js
init_shim();
init_lib();
var import_utils = __toESM(require_utils());
var EMBEDDED_WALLET_PATH = "/sdk/2022-08-12/embedded-wallet";
var GET_IFRAME_BASE_URL = () => {
...
var AuthProvider = function(AuthProvider2) {
  ...
  AuthProvider2["CUSTOM_AUTH_ENDPOINT"] = "CustomAuthEndpoint";
...
var EmbeddedWallet = class {
  ...
  async getEthersJsSigner(network) {
    const signer = new EthersSigner({
      clientId: this.clientId,
      provider: getDefaultProvider(network?.rpcEndpoint ?? o[this.chain]),
...
//# sourceMappingURL=chunk-4JII2AG5.js.map
