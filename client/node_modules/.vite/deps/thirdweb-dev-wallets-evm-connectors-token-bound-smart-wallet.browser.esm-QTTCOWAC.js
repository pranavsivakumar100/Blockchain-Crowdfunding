...
var TokenBoundSmartWalletConnector = class extends SmartWalletConnector {
  constructor(input) {
    super({
      ...input,
  ...
  defaultFactoryInfo() {
    return {
      createAccount: async (factory) => {
        return factory.prepare("createAccount", [this.tbaConfig.accountImplementation, this.chainId, this.tbaConfig.tokenContract, this.tbaConfig.tokenId, this.tbaConfig.salt, ethers_exports.utils.toUtf8Bytes("")]);
      },
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-token-bound-smart-wallet.browser.esm-QTTCOWAC.js.map
