import { b4 as getChainProvider, aO as fetchPublishedContractFromPolygon, aN as THIRDWEB_DEPLOYER$1, aP as fetchAndCacheDeployMetadata, aC as getCreate2FactoryAddress, aL as encodeConstructorParamsForImplementation, aK as computeDeploymentInfo, aA as isContractDeployed, ab as resolveImplementation, K as fetchContractMetadataFromAddress, at as fetchSourceFilesFromMetadata, a6 as extractConstructorParamsFromAbi, a9 as resolveContractUriFromAddress, aW as getContractPublisherAddress, af as fetchExtendedReleaseMetadata, cw as RPCConnectionHandler, aR as resolveAddress, Y as getDefaultGasOverrides, aS as signTypedDataInternal, aY as ChainId, cx as ContractWrapper, a$ as NATIVE_TOKEN_ADDRESS, cy as extractFeatures, ag as detectFeatures, aX as getMultichainRegistryAddress, bp as AbiSchema, aD as computeCreate2FactoryTransaction, aU as CONTRACT_ADDRESSES, cz as AddressZero, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, aI as computeForwarderAddress, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bM as CommonPlatformFeeSchema, bL as CommonPrimarySaleSchema, bN as CommonTrustedForwarderSchema, bI as CommonContractSchema, bK as CommonRoyaltySchema, bO as CommonSymbolSchema, aG as computeDeploymentAddress, aF as getInitBytecodeWithSalt, aZ as setSupportedChains, j as getContractTypeForRemoteName, b9 as getSignerAndProvider, ap as getCompositeABI, b7 as isChainConfig, aV as getContractAddressByChainId, cA as getProcessEnv, bY as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, b3 as EventType } from './index-81088817.esm.js';
import { isBrowser, ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-74b0a151.esm.js';
...
import { b as buildTransactionFunction, T as Transaction, a as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-9e0768a4.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-73cb814d.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-7593638c.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-7d5c3667.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-1b30abfb.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
