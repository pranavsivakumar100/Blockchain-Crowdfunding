...
var oneKeyWallet = require('./oneKeyWallet-a2aea93b.cjs.prod.js');
...
var bloctoWallet = require('./bloctoWallet-136abd18.cjs.prod.js');
var frameWallet = require('./frameWallet-e31b92ab.cjs.prod.js');
var wallets = require('@thirdweb-dev/wallets');
var formElements = require('./formElements-91b0967f.cjs.prod.js');
var reactIcons = require('@radix-ui/react-icons');
var styled = require('@emotion/styled');
var jsxRuntime = require('react/jsx-runtime');
var magicLink = require('./magicLink-27f7a94d.cjs.prod.js');
var paperWallet = require('./paperWallet-b65bee17.cjs.prod.js');
var safeWallet = require('./safeWallet-d433c7a6.cjs.prod.js');
var walletConnectV1 = require('./walletConnectV1-1855361a.cjs.prod.js');
var useSafe = require('./useSafe-f5dd3a9e.cjs.prod.js');
var useMagic = require('./useMagic-71db0387.cjs.prod.js');
var payments = require('@thirdweb-dev/payments');
...
require('./Tooltip-f7119a2a.cjs.prod.js');
...
const UploadIconSecondary = /* @__PURE__ */styled__default["default"](reactIcons.UploadIcon)(() => {
...
const DropContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
...
const ReconnectLocalWallet = props => {
  ...
  if (showExport) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(oneKeyWallet.ExportLocalWallet, {
...
const localWallet = config => {
  return {
    ...
    meta: {
      ...
      name: "Guest Wallet",
      iconURL: coinbaseWallet.isMobile() ? phoneIcon : desktopIcon
    },
...
const MagicEdenConnectUI = props => {
  const [screen, setScreen] = React.useState("connecting");
  const locale = formElements.useTWLocale().wallets.magicEdenWallet;
  const {
    walletConfig,
    connected
  } = props;
...
const magicEdenWallet = options => {
  return {
    ...
    create: walletOptions => new wallets.MagicEdenWallet(walletOptions),
    connectUI: MagicEdenConnectUI,
    isInstalled() {
      return !!wallets.getInjectedMagicEdenProvider();
    }
  };
};
...
const XDefiConnectUI = props => {
  const [screen, setScreen] = React.useState("connecting");
  const locale = formElements.useTWLocale().wallets.xdefiWallet;
  const {
    walletConfig,
    connected
  } = props;
...
const xdefiWallet = options => {
  return {
    ...
    create: walletOptions => new wallets.XDEFIWallet(walletOptions),
    connectUI: XDefiConnectUI,
    isInstalled() {
      return !!wallets.getInjectedXDEFIProvider();
    }
  };
};
...
const smartWallet = (walletConfig, config) => {
  return {
    ...
    selectUI: walletConfig.selectUI ? props => /*#__PURE__*/jsxRuntime.jsx(SmartSelectUI, {
      ...props,
      personalWalletConfig: walletConfig
    }) : undefined,
...
const SmartSelectUI = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PersonalWalletSelectUI, {
    walletConfig: props.personalWalletConfig,
    connect: options => {
...
const coreWallet = options => {
  return {
    ...
    create: walletOptions => {
      ...
      coinbaseWallet.handelWCSessionRequest(wallet, coreWalletUris);
      return wallet;
    },
...
const cryptoDefiWallet = options => {
  return {
    id: wallets.CryptoDefiWallet.id,
    recommended: options?.recommended,
    meta: {
    ...
    create: walletOptions => {
      const wallet = new wallets.CryptoDefiWallet({
        ...walletOptions,
        projectId: options?.projectId,
        qrcode: false
      });
      coinbaseWallet.handelWCSessionRequest(wallet, cryptoDefiWalletUris);
      return wallet;
    },
...
function isWalletInstalled() {
  return !!wallets.getInjectedCryptoDefiWalletProvider();
}
...
const RabbyScan = props => {
  ...
  const locale = formElements.useTWLocale().wallets.rabbyWallet;
...
const RabbyConnectUI = props => {
  ...
  if (screen === "scanning") {
    return /*#__PURE__*/jsxRuntime.jsx(RabbyScan, {
      onBack: props.goBack,
      onConnected: props.connected,
      onGetStarted: () => {
        setScreen("get-started");
...
const rabbyWallet = options => {
  return {
    ...
    create: walletOptions => {
      const wallet = new wallets.RabbyWallet({
        ...walletOptions,
        projectId: options?.projectId,
        qrcode: false
      });
    ...
    isInstalled() {
      return !!wallets.getInjectedRabbyProvider();
    }
  };
};
...
const coin98Wallet = options => {
  return {
    ...
    create: walletOptions => {
      const wallet = new wallets.Coin98Wallet({
        ...walletOptions,
        projectId: options?.projectId,
        qrcode: false
      });
...
function isCoin98Installed() {
  return !!wallets.getInjectedCoin98Provider();
}
...
const imTokenWallet = options => {
  return {
    id: wallets.ImTokenWallet.id,
    recommended: options?.recommended,
    meta: {
      ...wallets.ImTokenWallet.meta
    },
    create: walletOptions => {
      const wallet = new wallets.ImTokenWallet({
        ...walletOptions,
        projectId: options?.projectId,
        qrcode: false
      });
...
const PaymentsSDKContext = /* @__PURE__ */React.createContext(defaultContextValue);
const PaymentsSDKProvider = _ref => {
  ...
  const [chainName_, setChainName] = React.useState(chainName);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PaymentsSDKContext.Provider, {
    value: contextValue,
    children: children
  });
};
const usePaymentsSDKContext = () => {
  return React.useContext(PaymentsSDKContext);
};
...
const Spinner = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    id: "loader",
    className: css.cx(loader, className)
  });
};
...
const wrapperStyle = css.css`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate3d(-50%, -50%, 0);
`;
const spinnerStyle = css.css`
  color: #000000;
  width: 2rem;
  height: 2rem;
`;
...
function CheckoutWithCard(props) {
  const {
    ...
    appName,
    options = {
      ...payments.DEFAULT_BRAND_OPTIONS
    },
    onPaymentSuccess,
    onReview,
    onError,
  ...
  const [isCardDetailIframeLoading, setIsCardDetailIframeLoading] = React.useState(true);
  const onCardDetailLoad = React.useCallback(() => {
    setIsCardDetailIframeLoading(false);
  }, []);
  const CheckoutWithCardIframeContainerRef = React.useRef(null);
  ...
  React.useEffect(() => {
    ...
    payments.createCheckoutWithCardElement({
      clientId,
      sdkClientSecret,
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    ,
    "data-thirdweb-sdk-version": `${oneKeyWallet.packageJson.name}@${oneKeyWallet.packageJson.version}`,
    children: isCardDetailIframeLoading && /*#__PURE__*/jsxRuntime.jsx(SpinnerWrapper, {})
  });
}
...
const Button = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("button", {
    ...
    className: css.cx(buttonClass, props.className),
...
const VerifyOwnershipWithPaper = _ref => {
    ...
    const handleMessage = event => {
      ...
      switch (data.eventType) {
        ...
        case VERIFY_OWNERSHIP_WITH_PAPER_EVENT_TYPE.USER_LOGIN_FAILED:
          if (onError) {
            onError({
              code: payments.PaymentsSDKErrorCode.UserLoginFailed,
              error: new Error(payments.PaymentsSDKErrorCode.UserLoginFailed)
            });
          }
          break;
  ...
  const url = new URL("/sdk/v1/login-with-paper", payments.PAPER_APP_URL);
...
const PaperCheckout = _ref => {
  ...
  const checkoutUrl = new URL(`/checkout/${checkoutId}`, payments.PAPER_APP_URL);
  ...
  const clickableElement = children || /*#__PURE__*/jsxRuntime.jsx("button", {
    style: {
    ...
    case PaperCheckoutDisplay.MODAL:
      {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(PaperCheckoutModal, {
    ...
    case PaperCheckoutDisplay.DRAWER:
      {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(PaperCheckoutDrawer, {
          clickableElement: clickableElement,
          checkoutUrl: checkoutUrl.href,
          width: options.width,
          isOpen: isOpen,
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("a", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx("button", {
          ...
          children: "\xD7"
        }), isOpen && /*#__PURE__*/jsxRuntime.jsx("iframe", {
          src: checkoutUrl,
          width: "100%",
          height: "100%"
        })]
...
const PaperCheckoutModal = _ref3 => {
  ...
  const [innerHeight, setInnerHeight] = React.useState(height);
  React.useEffect(() => setInnerHeight(window.innerHeight), []);
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx("a", {
      onClick: onOpen,
      children: clickableElement
...
exports.embeddedWallet = oneKeyWallet.embeddedWallet;
exports.inAppWallet = oneKeyWallet.embeddedWallet;
...
exports.useInAppWallet = oneKeyWallet.useEmbeddedWallet;
exports.useInAppWalletSendVerificationEmail = oneKeyWallet.useEmbeddedWalletSendVerificationEmail;
exports.useInAppWalletUserEmail = oneKeyWallet.useEmbeddedWalletUserEmail;
...
Object.defineProperty(exports, 'ImTokenWallet', {
  enumerable: true,
  get: function () { return wallets.ImTokenWallet; }
});
...
Object.defineProperty(exports, 'PayWithCryptoErrorCode', {
  enumerable: true,
  get: function () { return payments.PayWithCryptoErrorCode; }
});
Object.defineProperty(exports, 'PaymentsSDKErrorCode', {
  enumerable: true,
  get: function () { return payments.PaymentsSDKErrorCode; }
});
exports.CheckoutWithCard = CheckoutWithCard;
exports.LoginWithPaper = VerifyOwnershipWithPaper;
exports.PaperCheckout = PaperCheckout;
exports.PaperCheckoutDisplay = PaperCheckoutDisplay;
exports.PaymentsSDKProvider = PaymentsSDKProvider;
exports.VerifyOwnershipWithPaper = VerifyOwnershipWithPaper;
exports.coin98Wallet = coin98Wallet;
exports.coreWallet = coreWallet;
exports.cryptoDefiWallet = cryptoDefiWallet;
exports.es = es;
exports.imTokenWallet = imTokenWallet;
exports.ja = ja;
exports.localWallet = localWallet;
exports.magicEdenWallet = magicEdenWallet;
exports.okxWallet = okxWallet;
exports.rabbyWallet = rabbyWallet;
exports.smartWallet = smartWallet;
exports.usePaymentsSDKContext = usePaymentsSDKContext;
