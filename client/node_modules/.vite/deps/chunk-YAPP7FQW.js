...
var require_BaseAccount_factory = __commonJS({
  "node_modules/@account-abstraction/contracts/dist/types/factories/BaseAccount__factory.js"(exports) {
    ...
    var ethers_1 = (init_lib(), __toCommonJS(lib_exports2));
    var _abi = [
      {
        inputs: [],
        name: "entryPoint",
...
var require_EntryPoint_factory = __commonJS({
  "node_modules/@account-abstraction/contracts/dist/types/factories/EntryPoint__factory.js"(exports) {
    ...
    var EntryPoint__factory = function(_super) {
...
var AbstractWallet = class extends eventemitter3_default {
  ...
  async verifySignature(message, signature, address, _chainId) {
    try {
...
// node_modules/@thirdweb-dev/wallets/dist/headers-343e228e.browser.esm.js
init_shim();
var pkg = {
...
// node_modules/@thirdweb-dev/wallets/dist/constants-2f331a16.browser.esm.js
init_shim();
init_lib();
...
async function checkContractWalletSignature(message, signature, address, chainId, clientId, secretKey) {
  ...
  const provider = new lib_exports.StaticJsonRpcProvider({
    url: rpcUrl,
  ...
  try {
    const res = await walletContract.isValidSignature(utils_exports.hashMessage(message), signature);
...
var MANAGED_ACCOUNT_GAS_BUFFER = 5e4;
...
//# sourceMappingURL=chunk-YAPP7FQW.js.map
