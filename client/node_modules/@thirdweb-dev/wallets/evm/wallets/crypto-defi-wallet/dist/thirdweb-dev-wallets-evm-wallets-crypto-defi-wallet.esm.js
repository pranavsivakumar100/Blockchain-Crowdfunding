...
import { a as AbstractClientWallet } from '../../../../dist/base-272d4047.esm.js';
import { w as walletIds } from '../../../../dist/walletIds-c34dbb3f.esm.js';
import { T as TW_WC_PROJECT_ID } from '../../../../dist/wc-f2c5150f.esm.js';
import { g as getInjectedCryptoDefiWalletProvider } from '../../../../dist/getInjectedCryptoDefiWalletProvider-6883e68f.esm.js';
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        } = await import('../../../connectors/crypto-defi-wallet/dist/thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.esm.js');
