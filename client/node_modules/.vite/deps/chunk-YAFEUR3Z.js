...
init_shim();
var import_shim25 = __toESM(require_shim());
"use client";
var useSyncExternalStore = import_shim25.useSyncExternalStore;
...
// node_modules/@thirdweb-dev/react-core/dist/useBuyWithCryptoStatus-c156a33f.browser.esm.js
init_shim();
...
// node_modules/@thirdweb-dev/auth/dist/auth-9bd95804.browser.esm.js
init_shim();
init_lib();
...
var AddressSchema2 = z.string().refine((arg) => utils_exports.isAddress(arg), (out) => {
  return {
...
var AccountTypeSchema = z.literal("evm");
...
var AuthenticateOptionsSchema = z.object({
  domain: z.string(),
  issuerAddress: AddressSchema2.optional(),
...
async function verifySignature(message, signature, address, chainId, clientId, secretKey) {
  ...
  return checkContractWalletSignature(message, signature, address, chainId, clientId, secretKey);
}
...
async function verifyLoginPayload(_ref4) {
  ...
  if (parsedOptions?.validateNonce !== void 0) {
    try {
  ...
  const chainId = payload.payload.chain_id ? parseInt(payload.payload.chain_id) : void 0;
...
async function authenticateJWT(_ref4) {
  ...
  if (parsedOptions?.validateTokenId !== void 0) {
    try {
...
var ThirdwebThemeContext = (0, import_react2.createContext)(void 0);
var ThirdwebAuthContext = (0, import_react2.createContext)(void 0);
function useThirdwebAuthContext() {
  return (0, import_react2.useContext)(ThirdwebAuthContext);
}
var isWalletConnectReceiverEnabled = (wallet) => {
...
var personalWalletToWrapperWallet = /* @__PURE__ */ new Map();
var ThirdwebWalletContext = (0, import_react2.createContext)(void 0);
function useWalletConnectionSetup(data, initialValue) {
  ...
  const [signer, setSigner] = (0, import_react2.useState)(void 0);
  const [connectionStatus, setConnectionStatus] = (0, import_react2.useState)(initialValue.connectionStatus);
  const [activeWallet, setActiveWallet] = (0, import_react2.useState)();
  const [createdWalletInstance, setCreatedWalletInstance] = (0, import_react2.useState)();
  const [activeWalletConfig, setActiveWalletConfig] = (0, import_react2.useState)();
  const [chainId, setChainId] = (0, import_react2.useState)(void 0);
  const [walletAddress, setWalletAddress] = (0, import_react2.useState)(void 0);
  const walletParams = (0, import_react2.useMemo)(() => {
    return {
      chains,
  ...
  const createWalletInstance = (0, import_react2.useCallback)((walletConfig) => {
  ...
  const setConnectedWallet = (0, import_react2.useCallback)(async function(wallet, connectParams) {
  ...
  const storeLastActiveChainId = (0, import_react2.useCallback)(async (_chainId) => {
  ...
  const switchChain = (0, import_react2.useCallback)(async (_chainId) => {
    if (!activeWallet) {
  ...
  const connectWallet = (0, import_react2.useCallback)(async function() {
  ...
  const onWalletDisconnect = (0, import_react2.useCallback)(() => {
    setConnectionStatus("disconnected");
    setSigner(void 0);
  ...
  const disconnectWallet = (0, import_react2.useCallback)(async () => {
    if (!activeWallet) {
      onWalletDisconnect();
      return;
    }
...
function ThirdwebWalletProvider(props) {
  ...
  const [isAutoConnecting, setIsAutoConnecting] = (0, import_react2.useState)(false);
  const [walletConnectHandler, setWalletConnectHandler] = (0, import_react2.useState)();
  ...
  const autoConnectTriggered = (0, import_react2.useRef)(false);
  (0, import_react2.useEffect)(() => {
    ...
    async function autoconnect() {
      ...
      if (walletObj.personalWallets && !_personalWalletInfo) {
        if (walletInfo.walletId === walletIds.magicLink && walletInfo.connectParams && "oauthProvider" in walletInfo.connectParams) {
  ...
  const signerConnected = (0, import_react2.useRef)();
  (0, import_react2.useEffect)(() => {
    if (!props.signerWallet) {
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebWalletContext.Provider, {
    value: {
      address,
      chainId,
...
function useWalletContext() {
  const ctx = (0, import_react2.useContext)(ThirdwebWalletContext);
  if (!ctx) {
...
var ThirdwebAuthProvider = (_ref) => {
  ...
  const authContext = (0, import_react2.useMemo)(() => {
    if (!value) {
      return void 0;
    }
    const context = {
  ...
  return (0, import_jsx_runtime.jsxs)(ThirdwebAuthContext.Provider, {
    value: authContext,
    children: [children, (0, import_jsx_runtime.jsx)(ChangeActiveWalletOnAccountSwitch, {})]
  });
};
...
function useUpdateChainsWithClientId(supportedChains, activeChain, clientId) {
  const supportedChainsWithKey = (0, import_react2.useMemo)(() => {
    return supportedChains.map((chain) => updateChainRPCs(chain, clientId));
  }, [supportedChains, clientId]);
  const activeChainIdOrObjWithKey = (0, import_react2.useMemo)(() => {
...
var QueryClientProviderWithDefault = (_ref) => {
  ...
  const queryClientWithDefault = (0, import_react2.useMemo)(() => {
...
var ThirdwebConfigContext = (0, import_react2.createContext)(void 0);
var ThirdwebConfigProvider = (_ref) => {
  let {
    value,
    children
  } = _ref;
  return (0, import_jsx_runtime.jsx)(ThirdwebConfigContext.Provider, {
    value,
    children
  });
};
function useThirdwebConfigContext() {
  const context = (0, import_react2.useContext)(ThirdwebConfigContext);
  invariant(context, "useThirdwebConfigContext() hook must be used within a <ThirdwebProvider/>");
  return context;
}
var ThirdwebSDKContext = (0, import_react2.createContext)({});
var __DEV__ = import_process.default.env.NODE_ENV !== "production";
function useSDKContext() {
  const ctx = (0, import_react2.useContext)(ThirdwebSDKContext);
...
var ThirdwebConnectedWalletContext = (0, import_react2.createContext)(void 0);
var ThirdwebConnectedWalletProvider = (_ref) => {
  ...
  const [contextValue, setContextValue] = (0, import_react2.useState)({
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebConnectedWalletContext.Provider, {
    value: contextValue,
    children
  });
};
function useThirdwebConnectedWalletContext() {
  const context = (0, import_react2.useContext)(ThirdwebConnectedWalletContext);
...
var WrappedThirdwebSDKProvider = (_ref) => {
  ...
  const activeChainId = (0, import_react2.useMemo)(() => {
    if (!activeChain) {
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebSDKContext.Provider, {
    value: ctxValue,
    children
  });
};
var ThirdwebSDKProvider = (props) => {
  const {
    signer,
    children,
    queryClient,
  ...
  const supportedChainsNonNull = (0, import_react2.useMemo)(() => {
  ...
  const mergedChains = (0, import_react2.useMemo)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebConfigProvider, {
    value: {
      chains: mergedChains,
      clientId
    },
    children: (0, import_jsx_runtime.jsx)(QueryClientProviderWithDefault, {
      queryClient,
      children: (0, import_jsx_runtime.jsx)(WrappedThirdwebSDKProvider, {
        signer,
        supportedChains: mergedChains,
        clientId,
        activeChain: activeChainIdOrObjWithKey,
        ...restProps,
        children: (0, import_jsx_runtime.jsx)(ThirdwebConnectedWalletProvider, {
          signer,
          children
        })
      })
...
var ThirdwebProviderCore = (props) => {
  const {
    activeChain,
  ...
  const activeChainWithKey = (0, import_react2.useMemo)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebThemeContext.Provider, {
    value: props.theme,
    children: (0, import_jsx_runtime.jsx)(ThirdwebWalletProvider, {
      ...
      children: (0, import_jsx_runtime.jsx)(ThirdwebSDKProviderWrapper, {
        ...
        children: (0, import_jsx_runtime.jsx)(ThirdwebAuthProvider, {
...
var ThirdwebSDKProviderWrapper = (_ref) => {
  let {
    children,
    ...props
  } = _ref;
  const signer = useWalletContext()?.signer;
  return (0, import_jsx_runtime.jsx)(ThirdwebSDKProvider, {
    signer,
    ...props,
    children
  });
...
function useAddress() {
  const context = (0, import_react2.useContext)(ThirdwebConnectedWalletContext);
  const walletCtx = (0, import_react2.useContext)(ThirdwebWalletContext);
  if (walletCtx) {
...
function useChainId() {
  ...
  invariant(context, "useChainId() hook must be used within a <ThirdwebProvider/> or <ThirdwebSDKProvider/> component");
  return context.chainId;
}
function useChain() {
  const chainId = useChainId();
  const chains = useSupportedChains();
  const chain = (0, import_react2.useMemo)(() => {
    return chains.find((_chain) => _chain.chainId === chainId);
  }, [chainId, chains]);
  const unknownChain = (0, import_react2.useMemo)(() => {
    if (!chain) {
...
function useNetwork() {
  ...
  const switchNetwork = (0, import_react2.useCallback)(async (_chainId) => {
    setLoading(true);
    setError(void 0);
    try {
...
var usePersonalWalletAddress = () => {
  const [personalWalletAddress, setPersonalWalletAddress] = (0, import_react2.useState)();
  const activeWallet = useWallet();
  (0, import_react2.useEffect)(() => {
    (async () => {
      const possiblePersonalWallet = activeWallet?.getPersonalWallet();
      if (!possiblePersonalWallet) {
        setPersonalWalletAddress(void 0);
        return;
      }
...
function useContractEvents(contract, eventName) {
  ...
  const queryClient = useQueryClient();
  const activeChainId = useSDKChainId();
  const cacheKey = (0, import_react2.useMemo)(() => createCacheKeyWithNetwork(eventName ? cacheKeys.contract.events.getEvents(contractAddress, eventName) : cacheKeys.contract.events.getAllEvents(contractAddress), activeChainId), [activeChainId, contractAddress, eventName]);
  (0, import_react2.useEffect)(() => {
...
function useCreateDirectListingBatch(contract) {
  ...
  return useMutation(async (data) => {
    requiredParamInvariant(contract, "No Contract instance provided");
    invariant(walletAddress, "No wallet connected, cannot create listing");
    invariant(contract.directListings.createListingsBatch, "contract does not support directListings.createListingsBatch");
...
function useTotalCirculatingSupply(contract, tokenId) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.totalCirculatingSupply(contractAddress, tokenId ?? void 0), async () => {
    requiredParamInvariant(contract, "No Contract instance provided");
    if (erc1155) {
...
function useUpdateNFTMetadata(contract) {
  const activeChainId = useSDKChainId();
  const contractAddress = contract?.getAddress();
  const queryClient = useQueryClient();
  const {
...
function useIsAddressRole(contract, role, walletAddress) {
  ...
  if (data?.includes(lib_exports.AddressZero)) {
    return true;
  }
...
function useLogin() {
  ...
  const login = useMutation({
    mutationFn: async () => {
      ...
      await authConfig.secureStorage?.setItem(AUTH_TOKEN_STORAGE_KEY, token2);
      queryClient.invalidateQueries(cacheKeys.auth.user());
      return token2;
    }
  });
...
function useSigner() {
  ...
  invariant(context, "useSigner() hook must be used within a <ThirdwebProvider/> or <ThirdwebSDKProvider/> component");
  return context.signer;
}
...
function shortenString(str) {
  let extraShort = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
function shortenIfAddress(address) {
  let extraShort = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
  if (address && utils_exports.isAddress(address)) {
...
function isPossibleEVMAddress(address, ignoreEns) {
  ...
  return utils_exports.isAddress(address);
}
function useWatchTransactions(watchTransactionParams) {
  ...
  const [transactions, setTransactions] = (0, import_react2.useState)([]);
  (0, import_react2.useEffect)(() => {
    if (!address || !network) {
      return;
    }
...
function useBuyWithCryptoStatus(params) {
  const [refetchInterval, setRefetchInterval] = (0, import_react2.useState)(DEFAULT_POLL_INTERVAL);
  return useQuery({
    queryKey: ["swapStatus", params?.transactionHash],
    queryFn: async () => {
      if (!params) {
      ...
      if (swapStatus_.status === "COMPLETED" || swapStatus_.status === "FAILED") {
...
var EmotionCacheContext = React12.createContext(
  ...
  withEmotionCache = function withEmotionCache3(func) {
    return function(props) {
      ...
      if (cache === null) {
        ...
        return React12.createElement(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var ThemeContext = React12.createContext({});
if (import_process.default.env.NODE_ENV !== "production") {
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  for (var key in props) {
    if (hasOwn.call(props, key) && key !== "css" && key !== typePropName && (import_process.default.env.NODE_ENV === "production" || key !== labelPropName)) {
      newProps[key] = props[key];
    }
  }
  newProps.ref = ref;
  newProps.className = className;
  return React12.createElement(React12.Fragment, null, React12.createElement(Insertion, {
    cache,
    serialized,
    isStringTag: typeof WrappedComponent === "string"
  }), React12.createElement(WrappedComponent, newProps));
});
if (import_process.default.env.NODE_ENV !== "production") {
...
var Global = withEmotionCache(function(props, cache) {
  ...
  var serialized = serializeStyles([styles], void 0, React13.useContext(ThemeContext));
  if (!isBrowser2) {
    var _ref;
    ...
    return React13.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  hasRendered = true;
  return React13.createElement(React13.Fragment, null, React13.createElement(Insertion3, {
    cache,
    serializedArr
  }), ele);
});
...
// node_modules/@thirdweb-dev/react/dist/formElements-504267f1.browser.esm.js
init_shim();
...
var CustomThemeCtx = (0, import_react8.createContext)(darkThemeObj);
function CustomThemeProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(CustomThemeCtx.Provider, {
    value: themeObj,
    children
  });
}
function useCustomTheme() {
  return (0, import_react8.useContext)(CustomThemeCtx);
}
...
var ModalDescription = StyledP((props) => {
  const theme = useCustomTheme();
  return {
    all: "unset",
    display: "block",
...
var BackButton = (props) => {
  return (0, import_jsx_runtime3.jsx)(IconButton, {
    ...
    type: "button",
    children: (0, import_jsx_runtime3.jsx)(ChevronLeftIcon, {
      width: iconSize.md,
      height: iconSize.md
    })
  });
};
var HelperLink = StyledAnchor((props) => {
  const theme = useCustomTheme();
  return {
    all: "unset",
    cursor: "pointer",
...
var Skeleton = (props) => {
  return (0, import_jsx_runtime3.jsx)(SkeletonDiv, {
    style: {
      height: props.height,
...
var Img = (props) => {
  ...
  if (!propSrc) {
    return (0, import_jsx_runtime3.jsx)(Skeleton, {
      width: widthPx,
      height: heightPx
    });
  }
  ...
  return (0, import_jsx_runtime3.jsxs)("div", {
    ...
    children: [!isLoaded && (0, import_jsx_runtime3.jsx)(Skeleton, {
      width: widthPx,
      height: heightPx
...
`;
var ScreenBottomContainer = StyledDiv(() => {
  const theme = useCustomTheme();
  return {
...
function ModalHeader(props) {
  ...
  return (0, import_jsx_runtime3.jsxs)("div", {
    ...
    children: [onBack && (0, import_jsx_runtime3.jsx)(BackButton, {
      onClick: onBack,
      style: {
        position: "absolute",
        left: 0,
    ...
    }), (0, import_jsx_runtime3.jsxs)(Container, {
      flex: "row",
      gap: "xs",
      center: "both",
      children: [imgSrc && (0, import_jsx_runtime3.jsx)(Img, {
        src: imgSrc,
        width: iconSize.md,
        height: iconSize.md
      }), typeof title === "string" ? (0, import_jsx_runtime3.jsx)(ModalTitle, {
        children: title
      }) : title]
    })]
  });
...
var ThirdwebLocaleContext = (() => (0, import_react8.createContext)(enDefault()))();
function useTWLocale() {
  return (0, import_react8.useContext)(ThirdwebLocaleContext);
}
var reservedScreens = {
  main: "main",
...
var compactModalMaxHeight = "650px";
...
var WalletModalOpen = (0, import_react8.createContext)(false);
var SetWalletModalOpen = (0, import_react8.createContext)(void 0);
var ModalConfigCtx = (0, import_react8.createContext)({
  title: "",
  theme: "dark",
  data: void 0,
  modalSize: "wide"
});
var SetModalConfigCtx = (0, import_react8.createContext)(() => {
});
var WalletUIStatesProvider = (props) => {
  const [isWalletModalOpen, setIsWalletModalOpen] = (0, import_react8.useState)(false);
  const enforceCompact = !canFitWideModal();
  const locale = useTWLocale();
  const [modalConfig, setModalConfig] = (0, import_react8.useState)({
  ...
  return (0, import_jsx_runtime3.jsx)(WalletModalOpen.Provider, {
    value: isWalletModalOpen,
    children: (0, import_jsx_runtime3.jsx)(SetWalletModalOpen.Provider, {
      value: setIsWalletModalOpen,
      children: (0, import_jsx_runtime3.jsx)(ModalConfigCtx.Provider, {
        value: modalConfig,
        children: (0, import_jsx_runtime3.jsx)(SetModalConfigCtx.Provider, {
...
var useIsWalletModalOpen = () => {
  return (0, import_react8.useContext)(WalletModalOpen);
};
var useSetIsWalletModalOpen = () => {
  const context = (0, import_react8.useContext)(SetWalletModalOpen);
  if (context === void 0) {
    throw new Error("useSetWalletModalOpen must be used within a ThirdwebProvider");
  }
  return context;
};
var useSetWalletModalConfig = () => {
  const context = (0, import_react8.useContext)(SetModalConfigCtx);
  const enforceCompact = !canFitWideModal();
  const locale = useTWLocale();
  if (context === void 0) {
...
var ScreenSetupContext = (0, import_react8.createContext)(void 0);
function useSetupScreen() {
  const walletConfigs = useWallets();
  const modalConfig = (0, import_react8.useContext)(ModalConfigCtx);
  ...
  const [screen, setScreen] = (0, import_react8.useState)(initialScreen);
  const prevInitialScreen = (0, import_react8.useRef)(initialScreen);
  const wallet = useWallet();
...
function useScreenContext() {
  const ctx = (0, import_react8.useContext)(ScreenSetupContext);
  if (!ctx) {
...
var TextDivider = (props) => {
  return (0, import_jsx_runtime3.jsx)(TextDividerEl, {
    style: {
      paddingBlock: props.py ? spacing[props.py] : 0
    },
    children: (0, import_jsx_runtime3.jsxs)("span", {
      children: [" ", props.text]
    })
  });
};
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-YAFEUR3Z.js.map
