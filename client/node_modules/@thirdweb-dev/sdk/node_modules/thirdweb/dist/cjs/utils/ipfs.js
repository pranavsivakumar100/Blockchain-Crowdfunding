...
exports.getBaseUriFromBatch = exports.uploadOrExtractURIs = exports.findIPFSCidFromUri = exports.resolveScheme = void 0;
...
function resolveScheme(options) {
    if (options.uri.startsWith("ipfs://")) {
        ...
        return `${gateway.replace("{clientId}", clientId).split("/ipfs")[0]}/ipfs/${cid}`;
    }
...
exports.findIPFSCidFromUri = findIPFSCidFromUri;
/**
