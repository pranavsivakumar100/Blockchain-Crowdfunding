...
import { g as googleIconUri, a as appleIconUri, f as facebookIconUri, I as InputSelectionUI, v as validateEmail, e as emailIcon, T as ToolTip, b as genericTokenIcon, s as smartWalletIcon } from './Tooltip-e9cf5bf1.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-86b76acd.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-86b76acd.esm.js').then(function (n) { return n.u; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-86b76acd.esm.js').then(function (n) { return n.n; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-86b76acd.esm.js').then(function (n) { return n.l; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-28a32ce9.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-a75bbbbb.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-274867c5.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-86b76acd.esm.js').then(function (n) { return n.q; });
