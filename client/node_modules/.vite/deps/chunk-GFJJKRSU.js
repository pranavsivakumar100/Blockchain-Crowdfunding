      ...
      __asyncDelegator = function(o2) {
        ...
        function verb(n3, f3) {
          i2[n3] = o2[n3] ? function(v2) {
            return (p2 = !p2) ? { value: __await(o2[n3](v2)), done: n3 === "return" } : f3 ? f3(v2) : v2;
          } : f3;
        }
      };
    ...
    function hashBlocks(wh, wl, hh, hl, m2, pos, len) {
      ...
      while (len >= 128) {
        for (var i2 = 0; i2 < 16; i2++) {
          var j = 8 * i2 + pos;
          wh[i2] = binary_1.readUint32BE(m2, j);
          wl[i2] = binary_1.readUint32BE(m2, j + 4);
        }
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p2, q) {
      const a2 = gf(), b3 = gf(), c2 = gf(), d2 = gf(), e2 = gf(), f3 = gf(), g2 = gf(), h3 = gf(), t = gf();
      sub(a2, p2[1], p2[0]);
      sub(t, q[1], q[0]);
      mul(a2, a2, t);
      add(b3, p2[0], p2[1]);
    ...
    function cswap(p2, q, b3) {
      for (let i2 = 0; i2 < 4; i2++) {
        sel25519(p2[i2], q[i2], b3);
      }
    }
    function pack(r2, p2) {
  ...
  "node_modules/@stablelib/chacha/lib/chacha.js"(exports) {
    ...
    function streamXOR(key, nonce, src, dst, nonceInplaceCounterLength) {
      ...
      for (var i2 = 0; i2 < src.length; i2 += 64) {
        core(block, nc, key);
        for (var j = i2; j < i2 + 64 && j < src.length; j++) {
          dst[j] = src[j] ^ block[j - i2];
        }
...
var require_poly1305 = __commonJS({
  "node_modules/@stablelib/poly1305/lib/poly1305.js"(exports) {
    ...
    function equal(a2, b3) {
      ...
      return constant_time_1.equal(a2, b3);
    }
    exports.equal = equal;
  }
});
...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w3, v2, p2, pos, len) {
      while (len >= 64) {
        var a2 = v2[0];
        var b3 = v2[1];
        var c2 = v2[2];
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j = pos + i2 * 4;
          w3[i2] = binary_1.readUint32BE(p2, j);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e2 >>> 6 | e2 << 32 - 6) ^ (e2 >>> 11 | e2 << 32 - 11) ^ (e2 >>> 25 | e2 << 32 - 25)) + (e2 & f3 ^ ~e2 & g2) | 0) + (h3 + (K[i2] + w3[i2] | 0) | 0) | 0;
...
function unfetch_module_default(e2, n3) {
  return n3 = n3 || {}, new Promise(function(t, r2) {
    ...
    for (var l2 in s2.open(n3.method || "get", e2, true), s2.onload = function() {
      s2.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e3, n4, t2) {
        o2.push(n4 = n4.toLowerCase()), u2.push([n4, t2]), i2[n4] = i2[n4] ? i2[n4] + "," + t2 : t2;
      }), t(a2());
...
var L = class {
  ...
  appendToLogs(e2) {
    this.logs.append(safeJsonStringify({ timestamp: new Date().toISOString(), log: e2 }));
...
var m = class {
  ...
  downloadLogsBlobInBrowser(e2) {
    ...
    o2.href = t, o2.download = `walletconnect-logs-${new Date().toISOString()}.txt`, document.body.appendChild(o2), o2.click(), document.body.removeChild(o2), URL.revokeObjectURL(t);
  }
};
var B = class {
  constructor(e2, t = l) {
...
function k(r2) {
  return g(i({}, r2), { level: r2?.level || c.level });
}
function v(r2, e2 = n2) {
  return r2[e2] || "";
}
...
function E(r2, e2, t = n2) {
  const o2 = w(r2, e2, t), a2 = r2.child({ context: o2 });
  return b(a2, o2, t);
}
function C(r2) {
  var e2, t;
  const o2 = new m((e2 = r2.opts) == null ? void 0 : e2.level, r2.maxSizeInBytes);
  return { logger: (0, import_pino.default)(g(i({}, r2.opts), { level: "trace", browser: g(i({}, (t = r2.opts) == null ? void 0 : t.browser), { write: (a2) => o2.write(a2) }) })), chunkLoggerController: o2 };
}
function I(r2) {
  var e2;
...
var f2 = class {
  constructor(e2) {
    if (this.url = e2, this.events = new import_events.EventEmitter(), this.registering = false, !isWsUrl(e2))
  ...
  register(e2 = this.url) {
    ...
    return this.url = e2, this.registering = true, new Promise((t, n3) => {
      const o2 = new URLSearchParams(e2).get("origin"), s2 = (0, esm_exports.isReactNative)() ? { headers: { origin: o2 } } : { rejectUnauthorized: !isLocalhostUrl(e2) }, i2 = new S2(e2, [], s2);
      b2() ? i2.onerror = (r2) => {
        const l2 = r2;
  ...
  parseError(e2, t = this.url) {
    return parseConnectionError(e2, a(t), "WS");
  }
  resetMaxListeners() {
    this.events.getMaxListeners() > h2 && this.events.setMaxListeners(h2);
  }
  emitError(e2) {
    const t = this.parseError(new Error(e2?.message || `WebSocket connection failed for host: ${a(this.url)}`));
...
***************************************************************************** */
//# sourceMappingURL=chunk-GFJJKRSU.js.map
