 ...
 * @wallet
 */
class CoreWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  /**
   * @internal
   */
  get walletName() {
  ...
  constructor(options) {
    ...
    this.isInjected = !!getInjectedCoreWalletProvider.getInjectedCoreWalletProvider();
  }
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        const {
          CoreWalletConnector
        } = await Promise.resolve().then(function () { return require('../../../connectors/core-wallet/dist/thirdweb-dev-wallets-evm-connectors-core-wallet.cjs.prod.js'); });
        ...
        this.connector = new connector.WagmiAdapter(this.CoreWalletConnector);
      } else {
        const {
 ...
 * @internal
 */
defineProperty._defineProperty(CoreWallet, "id", walletIds.walletIds.coreWallet);
