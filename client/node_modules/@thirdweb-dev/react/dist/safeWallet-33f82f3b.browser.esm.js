import { walletIds, SafeWallet } from '@thirdweb-dev/wallets';
import { useWalletContext, useSupportedChains, useDisconnect } from '@thirdweb-dev/react-core';
import { g as WalletSelection, s as safeChainIdToSlug, j as FormField, k as safeSlugToChainId, d as defaultWallets, H as HeadlessConnectUI } from './safeChainSlug-02e3bfeb.browser.esm.js';
import { useRef, useEffect, useState, useContext } from 'react';
import { b as useTWLocale, C as Container, M as ModalHeader, L as Line, S as Spacer, T as Text, Y as Link, E as ScreenBottomContainer, B as Button, f as ModalConfigCtx, c as ModalDescription, e as Label, i as iconSize, s as spacing, d as Spinner, a5 as StyledSelect, u as useCustomTheme, g as fontSize } from './formElements-504267f1.browser.esm.js';
        ...
        children: [/*#__PURE__*/jsx(Spacer, {
          ...
          onChange: value => {
            ...
            if (value.length > 4) {
              ...
              const _chainId = prefix && prefix in safeSlugToChainId ? safeSlugToChainId[prefix] : undefined;
              if (_chainId && prefix) {
