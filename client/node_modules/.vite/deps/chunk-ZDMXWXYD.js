...
// node_modules/@thirdweb-dev/react/dist/paperWallet-d40558df.browser.esm.js
init_shim();
var import_react14 = __toESM(require_react());

// node_modules/@thirdweb-dev/react/dist/oneKeyWallet-a16d5da8.browser.esm.js
init_shim();
...
var $5d3850c4d0b4e6c7$var$DialogOverlayImpl = (0, import_react11.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react11.createElement)(Combination_default, {
    as: $5e63c961fc1ce211$export$8c6ed5c666ac1360,
    allowPinchZoom: true,
    shards: [
      context.contentRef
...
var EmbeddedWalletFormUI = (props) => {
  ...
  const [inputMode, setInputMode] = (0, import_react12.useState)(selectDefaultInputMode());
  ...
  const switchInputMode = (0, import_react12.useCallback)(() => {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [hasSocialLogins && (0, import_jsx_runtime.jsx)(Container, {
      ...
      children: socialLogins.map((loginMethod) => {
        ...
        return (0, import_jsx_runtime.jsxs)(SocialButton, {
    ...
    }), props.modalSize === "wide" && hasSocialLogins && isEmailEnabled && (0, import_jsx_runtime.jsx)(TextDivider, {
      text: twLocale.connectWallet.or
    }), inputMode !== "none" && (0, import_jsx_runtime.jsxs)(Container, {
      children: [inputMode === "email" ? (0, import_jsx_runtime.jsx)(InputSelectionUI, {
        type,
        onSelect: (value) => {
          props.onSelect({
            email: value
        ...
        emptyErrorMessage,
        submitButtonText: locale.submitEmail
      }), allowSwitchInputMode && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
...
var EmbeddedWalletFormUIScreen = (props) => {
  ...
  const modalConfig = (0, import_react12.useContext)(ModalConfigCtx);
  return (0, import_jsx_runtime.jsxs)(Container, {
    fullHeight: true,
    flex: "column",
    p: "lg",
    ...
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      onBack: screen === props.walletConfig && initialScreen === props.walletConfig ? void 0 : props.onBack,
      title: locale.title
    ...
    }), isCompact && (modalConfig.showThirdwebBranding !== false || modalConfig.termsOfServiceUrl || modalConfig.privacyPolicyUrl) && (0, import_jsx_runtime.jsx)(Spacer, {
      y: "xl"
      ...
      }), modalConfig.showThirdwebBranding !== false && (0, import_jsx_runtime.jsx)(PoweredByThirdweb, {})]
    })]
  });
};
...
var EmbeddedWalletSocialLogin = (props) => {
  ...
  const themeObj = useCustomTheme();
  const [authError, setAuthError] = (0, import_react12.useState)(void 0);
  ...
  const onConnectCalled = (0, import_react12.useRef)(false);
    ...
    children: (0, import_jsx_runtime.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
        ...
        children: [connectionStatus === "connecting" && (0, import_jsx_runtime.jsxs)(Container, {
          ...
          }), authError && (0, import_jsx_runtime.jsx)(Text, {
            color: "danger",
            children: authError
          }), (0, import_jsx_runtime.jsx)(Spacer, {
            y: "lg"
...
function OTPInput(props) {
  ...
  const boxEls = (0, import_react12.useRef)([]);
  (0, import_react12.useEffect)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(Container, {
    ...
    children: new Array(props.digits).fill(null).map((_, i) => {
      return (0, import_jsx_runtime.jsx)(OTPInputBox, {
...
function CreatePassword(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: [props.modalSize === "compact" && (0, import_jsx_runtime.jsx)(Spacer, {
        y: "xxl"
      }), (0, import_jsx_runtime.jsx)(Container, {
        flex: "row",
        center: "x",
        color: "accentText",
        children: (0, import_jsx_runtime.jsx)(BounceContainer, {
          children: (0, import_jsx_runtime.jsx)(LockOpen1Icon, {
            width: iconSize.xxl,
            height: iconSize.xxl
          })
        })
        ...
        children: [(0, import_jsx_runtime.jsx)(Text, {
          ...
          children: [(0, import_jsx_runtime.jsx)(Input, {
            ...
            children: showPassword ? (0, import_jsx_runtime.jsx)(EyeClosedIcon, {}) : (0, import_jsx_runtime.jsx)(EyeOpenIcon, {})
          })]
        }), (0, import_jsx_runtime.jsx)(Spacer, {
          y: "lg"
        }), (0, import_jsx_runtime.jsxs)(Container, {
          ...
          gap: "sm",
          center: "y",
          children: [(0, import_jsx_runtime.jsx)(CheckboxButton, {
            "aria-checked": saved,
            type: "button",
            id: "save-checkbox",
            onClick: () => {
            ...
            children: (0, import_jsx_runtime.jsx)(CheckIcon, {
              width: 20,
              height: 20,
              style: {
                opacity: saved ? 1 : 0,
          ...
          type: "submit",
          children: loading ? (0, import_jsx_runtime.jsx)(Spinner, {
            size: "md",
            color: "accentButtonText"
          }) : locale.submitButton
        }), error && (0, import_jsx_runtime.jsxs)(Container, {
          children: [(0, import_jsx_runtime.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime.jsx)(Text, {
            size: "sm",
...
var CheckboxButton = newStyled(IconButton)(() => {
  const theme = useCustomTheme();
  return {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: (0, import_jsx_runtime.jsxs)("form", {
        ...
        children: [(0, import_jsx_runtime.jsx)(Text, {
        ...
        }), error && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [(0, import_jsx_runtime.jsx)(Spacer, {
            y: "sm"
          }), (0, import_jsx_runtime.jsx)(Text, {
            color: "danger",
          ...
          type: "submit",
          disabled: loading,
          children: loading ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
            children: (0, import_jsx_runtime.jsx)(Spinner, {
              size: "md",
              color: "accentButtonText"
            })
...
var EmbeddedWalletOTPLoginUI = (props) => {
  ...
  const [otpInput, setOtpInput] = (0, import_react12.useState)("");
  const {
    createWalletInstance,
    setConnectedWallet,
    setConnectionStatus
  ...
  const [verifyStatus, setVerifyStatus] = (0, import_react12.useState)("idle");
  const [accountStatus, setAccountStatus] = (0, import_react12.useState)("sending");
  const [screen, setScreen] = (0, import_react12.useState)("base");
  const sendEmailOrSms = (0, import_react12.useCallback)(async () => {
    setOtpInput("");
  ...
  const emailSentOnMount = (0, import_react12.useRef)(false);
  (0, import_react12.useEffect)(() => {
  ...
  if (screen === "create-password") {
    return (0, import_jsx_runtime.jsx)(CreatePassword, {
      modalSize: props.modalSize,
      goBack: props.goBack,
  ...
  if (screen === "enter-password-or-recovery-code") {
    return (0, import_jsx_runtime.jsx)(EnterPasswordOrRecovery, {
      modalSize: props.modalSize,
      goBack: props.goBack,
    ...
    return (0, import_jsx_runtime.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(Container, {
        ...
        children: (0, import_jsx_runtime.jsxs)("form", {
          ...
          children: [(0, import_jsx_runtime.jsxs)(Container, {
          ...
          }), verifyStatus === "payment_required" && (0, import_jsx_runtime.jsxs)(FadeIn, {
            children: [(0, import_jsx_runtime.jsx)(Spacer, {
              y: "md"
            }), (0, import_jsx_runtime.jsx)(Text, {
              size: "sm",
            ...
            children: [accountStatus === "error" && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
              children: (0, import_jsx_runtime.jsx)(Text, {
                size: "sm",
                center: true,
                color: "danger",
            ...
            }), accountStatus === "sending" && (0, import_jsx_runtime.jsxs)(Container, {
              flex: "row",
              center: "both",
              gap: "xs",
              style: {
            ...
            }), typeof accountStatus === "object" && (0, import_jsx_runtime.jsx)(LinkButton, {
...
var DEFAULT_AUTH_OPTIONS = ["email", "phone", "google", "apple", "facebook"];
var embeddedWallet = (options) => {
...
var EmbeddedWalletConnectUI = (props) => {
  const [loginType, setLoginType] = (0, import_react12.useState)(props.selectionData);
  if (loginType) {
    const handleBack = () => {
    ...
    return (0, import_jsx_runtime.jsx)(EmbeddedWalletSocialLogin, {
      ...props,
      goBack: handleBack,
      strategy: loginType
    });
...
var ExportLocalWallet = (props) => {
  ...
  const [password, setPassword] = (0, import_react12.useState)("");
  const [showPassword, setShowPassword] = (0, import_react12.useState)(false);
  const [isWrongPassword, setIsWrongPassword] = (0, import_react12.useState)(false);
  const [passwordIsRequired, setPasswordIsRequired] = (0, import_react12.useState)(false);
  const wallet = props.walletInstance;
  const [savedAddress, setSavedAddress] = (0, import_react12.useState)("");
...
var SavedWalletAddress = StyledP(() => {
  const theme = useCustomTheme();
  return {
    fontSize: fontSize.md,
...
function useClipboard(text) {
  ...
  const [hasCopied, setHasCopied] = (0, import_react12.useState)(false);
  const {
    timeout = 1500,
    ...copyOptions
  ...
  const onCopy = (0, import_react12.useCallback)(() => {
...
var Modal = (props) => {
  const [open, setOpen] = (0, import_react12.useState)(props.open);
  ...
  return (0, import_jsx_runtime.jsxs)($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, {
    ...
    children: [props.trigger && (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$41fb9f06171c75f4, {
      ...
      children: [!props.hide && (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, {
        asChild: true,
        children: (0, import_jsx_runtime.jsx)(Overlay, {
          ref: overlayRef
        })
      }), (0, import_jsx_runtime.jsx)($d3863c46a17e8a28$export$20e40289641fbbb6, {
        trapped: !props.hide,
        children: (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, {
          asChild: true,
...
function useEmbeddedWallet() {
  ...
  const connect = (0, import_react12.useCallback)(async (authParams) => {
  ...
  const sendVerificationEmail = (0, import_react12.useCallback)(async (_ref) => {
    let {
      email
    } = _ref;
...
function useEmbeddedWalletUserEmail() {
  ...
  const emailQuery = useQuery([wallet?.walletId, address, "embeddedWallet-email"], () => {
...
function useEmbeddedWalletUserPhoneNumber() {
  const wallet = useWallet();
  const address = useAddress();
  const emailQuery = useQuery([wallet?.walletId, address, "embeddedWallet-phone-number"], () => {
    if (wallet && wallet.walletId === walletIds.embeddedWallet) {
...
function NetworkSelector(props) {
  ...
  return (0, import_jsx_runtime.jsx)(CustomThemeProvider, {
    ...
    children: (0, import_jsx_runtime.jsx)(Modal, {
      ...
      children: (0, import_jsx_runtime.jsx)(NetworkSelectorContent, {
        ...props
      })
    })
  });
...
function NetworkSelectorContent(props) {
  ...
  const deferredSearchTerm = (0, import_react12.useDeferredValue)(searchTerm);
  ...
  const recentChains = (0, import_react12.useMemo)(() => {
    if (deferredSearchTerm === "") {
  ...
  const handleSwitch = (0, import_react12.useCallback)((chain) => {
    if (onSwitch) {
      onSwitch(chain);
    }
    if (onClose) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    children: [(0, import_jsx_runtime.jsx)(Container, {
      p: "lg",
      children: props.onBack ? (0, import_jsx_runtime.jsx)(ModalHeader, {
        title: locale.title,
        onBack: props.onBack
      ...
      className: "TabsRoot",
      defaultValue: "all",
      children: [props.showTabs !== false && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [(0, import_jsx_runtime.jsx)(Container, {
          px: "lg",
      ...
      }), props.showTabs === false && (0, import_jsx_runtime.jsx)(Spacer, {
        y: "xxs"
...
var NetworkTab = (props) => {
  const allChains = (0, import_react12.useMemo)(() => filterChainByType(props.allChains, props.type), [props.type, props.allChains]);
  const recentChains = (0, import_react12.useMemo)(() => filterChainByType(props.recentChains || [], props.type), [props.type, props.recentChains]);
  const popularChains = (0, import_react12.useMemo)(() => filterChainByType(props.popularChains || [], props.type), [props.type, props.popularChains]);
...
var NetworkList = (0, import_react12.memo)(function NetworkList2(props) {
  const switchChain = useSwitchChain();
  const activeChainId = useChainId();
  const [switchingChainId, setSwitchingChainId] = (0, import_react12.useState)(-1);
  const [errorSwitchingChainId, setErrorSwitchingChainId] = (0, import_react12.useState)(-1);
  ...
  const [isLoading, setIsLoading] = (0, import_react12.useState)(props.chains.length > 100);
  (0, import_react12.useEffect)(() => {
    if (isLoading) {
      setTimeout(() => {
        requestAnimationFrame(() => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime.jsx)(Container, {
      px: "xxs",
      children: (0, import_jsx_runtime.jsx)(NetworkListUl, {
        children: new Array(10).fill(0).map((_, i) => (0, import_jsx_runtime.jsx)(Skeleton, {
          height: "48px"
        }, i))
      })
    });
  ...
  return (0, import_jsx_runtime.jsx)(NetworkListUl, {
    children: props.chains.map((chain) => {
      ...
      return (0, import_jsx_runtime.jsx)("li", {
        children: RenderChain ? (0, import_jsx_runtime.jsx)(RenderChain, {
          switchChain: () => {
            handleSwitch(chain);
          },
          chain,
          ...
          close: props.close
        }) : (0, import_jsx_runtime.jsx)(ChainButton, {
          chain,
          confirming,
...
var ChainButton = (0, import_react12.memo)(function ChainButton2(props) {
  const twLocale = useTWLocale();
  const {
    confirming,
    onClick,
  ...
  return (0, import_jsx_runtime.jsxs)(NetworkButton, {
...
var NetworkButton = StyledButton(() => {
  const theme = useCustomTheme();
  return {
    all: "unset",
    display: "flex",
...
function ReceiveFunds(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      ...
      y: "xl"
    }), (0, import_jsx_runtime.jsxs)(WalletAddressContainer, {
      onClick: onCopy,
      children: [(0, import_jsx_runtime.jsx)(Text, {
        color: "primaryText",
        size: "md",
...
var WalletAddressContainer = StyledButton(() => {
  const theme = useCustomTheme();
  return {
    all: "unset",
    width: "100%",
...
function TokenIcon(props) {
  ...
  if (isNativeToken$1(token)) {
    return (0, import_jsx_runtime.jsx)(NativeTokenIcon, {
...
function formatTokenBalance(balanceData) {
  let showSymbol = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
function TokenSelector(props) {
  ...
  if (screen === "select-chain" && chainSelection) {
    return (0, import_jsx_runtime.jsx)(NetworkSelectorContent, {
      showTabs: false,
      onBack: () => setScreen("base"),
      open: true,
      chains: chainSelection.chains,
      renderChain: (renderChainProps) => {
        return (0, import_jsx_runtime.jsx)(ChainButton, {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "md"
      }), props.chainSelection && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
        children: (0, import_jsx_runtime.jsxs)(Container, {
          px: "lg",
          children: [(0, import_jsx_runtime.jsx)(Text, {
            size: "sm",
            ...
            y: "xxs"
          }), (0, import_jsx_runtime.jsxs)(SelectTokenBtn, {
            fullWidth: true,
            variant: "secondary",
            onClick: () => {
            ...
            children: [(0, import_jsx_runtime.jsx)(ChainIcon, {
              ...
              size: iconSize.lg,
              fallbackImage: fallbackChainIcon
            }), chainQuery.data ? (0, import_jsx_runtime.jsxs)(Text, {
              color: "primaryText",
              size: "sm",
              children: [" ", chainQuery.data.name]
            }) : (0, import_jsx_runtime.jsx)(Skeleton, {
              height: fontSize.md
            }), (0, import_jsx_runtime.jsx)(ChevronDownIcon, {
              width: iconSize.sm,
              height: iconSize.sm,
              style: {
                marginLeft: "auto"
        ...
        y: "md"
      }), (filteredList.length > 0 || !input) && (0, import_jsx_runtime.jsxs)(Container, {
        flex: "column",
        gap: "xs",
        px: "lg",
        scrollY: true,
        ...
        children: [!input && (0, import_jsx_runtime.jsx)(SelectTokenButton, {
          onClick: () => {
      ...
      }), filteredList.length === 0 && tokenQuery.isLoading && (0, import_jsx_runtime.jsx)(Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
      ...
      }), filteredList.length === 0 && !tokenQuery.isLoading && input && (0, import_jsx_runtime.jsxs)(Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
...
function SelectTokenButton(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(SelectTokenBtn, {
    ...
    children: [(0, import_jsx_runtime.jsx)(TokenIcon, {
      token: props.token,
      chainId: props.chainId,
      size: "lg"
    }), (0, import_jsx_runtime.jsxs)(Container, {
      ...
      children: [tokenName ? (0, import_jsx_runtime.jsx)(Text, {
        ...
        height: fontSize.md,
        width: "150px"
      }), tokenBalanceQuery.data ? (0, import_jsx_runtime.jsxs)(Text, {
        size: "xs",
...
function SendFunds(props) {
  ...
  const [token, setToken] = (0, import_react12.useState)(defaultToken);
  const [receiverAddress, setReceiverAddress] = (0, import_react12.useState)("");
  const [amount, setAmount] = (0, import_react12.useState)("0");
...
function SendFundsForm(props) {
  ...
  const isValidReceiverAddress = (0, import_react12.useMemo)(() => {
    return utils_exports.isAddress(receiverAddress);
  }, [receiverAddress]);
  ...
  const tokenName = (props.token && "name" in props.token ? props.token.name : void 0) || balanceQuery?.data?.name;
  const tokenSymbol = (props.token && "symbol" in props.token ? props.token.symbol : void 0) || balanceQuery?.data?.symbol;
  return (0, import_jsx_runtime.jsxs)(Container, {
    p: "lg",
    animate: "fadein",
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      ...
      children: [(0, import_jsx_runtime.jsx)(Label, {
        ...
        children: [sendTokenMutation.isLoading ? locale.sending : locale.submitButton, sendTokenMutation.isLoading && (0, import_jsx_runtime.jsx)(Spinner, {
          size: "sm",
          color: "accentButtonText"
        })]
      })]
...
var Drawer = (0, import_react12.forwardRef)(function Drawer_(props, ref) {
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: (0, import_jsx_runtime.jsxs)(DrawerContainer, {
      ref,
      children: [(0, import_jsx_runtime.jsx)(CrossContainer, {
        children: (0, import_jsx_runtime.jsx)(IconButton, {
          type: "button",
          "aria-label": "Close",
          onClick: props.close,
...
function useDrawer() {
  const drawerRef = (0, import_react12.useRef)(null);
  const drawerOverlayRef = (0, import_react12.useRef)(null);
...
function PaymentSelection() {
  return (0, import_jsx_runtime.jsxs)("div", {
    children: [(0, import_jsx_runtime.jsx)(Text, {
      ...
      children: [(0, import_jsx_runtime.jsx)(CheckButton, {
        isChecked: true,
        variant: "outline",
        children: (0, import_jsx_runtime.jsx)(Container, {
          gap: "xxs",
        ...
        }), (0, import_jsx_runtime.jsx)(FloatingBadge, {
...
var CheckButton = newStyled(Button)((props) => {
  const theme = useCustomTheme();
  return {
    fontSize: fontSize.sm,
...
function TokenSymbol(props) {
  ...
  return (0, import_jsx_runtime.jsx)(NativeTokenSymbol, {
    chainId: props.chainId,
    size: props.size,
    color: props.color
  });
...
function NativeTokenSymbol(props) {
  ...
  if (!data) {
    return (0, import_jsx_runtime.jsx)(Skeleton, {
      width: "70px",
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    children: [(0, import_jsx_runtime.jsx)("div", {
      ...
      children: (0, import_jsx_runtime.jsxs)(Container, {
        ...
        }), (0, import_jsx_runtime.jsx)(TokenSymbol, {
          token: props.token,
          chainId: props.chainId,
          size: "lg",
          color: "secondaryText"
      ...
      flex: "row",
      center: "x",
      children: (0, import_jsx_runtime.jsxs)(TokenButton$1, {
        variant: "secondary",
        fullWidth: true,
        style: {
          fontSize: fontSize.sm
        ...
        children: [(0, import_jsx_runtime.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime.jsx)(TokenIcon, {
            ...
            children: [(0, import_jsx_runtime.jsx)(TokenSymbol, {
              token: props.token,
              chainId: props.chainId,
              size: "sm"
            }), chainQuery.data?.name ? (0, import_jsx_runtime.jsx)(Text, {
              size: "xs",
              color: "secondaryText",
              children: chainQuery.data.name
            }) : (0, import_jsx_runtime.jsx)(Skeleton, {
...
var TokenButton$1 = newStyled(Button)(() => {
  const theme = useCustomTheme();
  return {
    background: theme.colors.walletSelectorButtonHoverBg,
    border: `1px solid ${theme.colors.borderColor}`,
...
var swapTransactionsStore = createStore([]);
var addPendingSwapTransaction = (clientId, txInfo) => {
...
var AccentFailIcon = (props) => {
  return (0, import_jsx_runtime.jsxs)("svg", {
    ...
    }), (0, import_jsx_runtime.jsxs)("defs", {
...
function ConfirmationScreen(props) {
  ...
  const [swapTx, setSwapTx] = (0, import_react12.useState)();
  const isApprovalRequired = props.buyWithCryptoQuote.approval !== void 0;
  const [step, setStep] = (0, import_react12.useState)(isApprovalRequired ? "approval" : "swap");
  ...
  if (swapTx) {
    return (0, import_jsx_runtime.jsx)(WaitingForConfirmation, {
      onBack: () => {
        props.onBack();
      },
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      ...
      y: "lg"
    }), (0, import_jsx_runtime.jsx)(ConfirmItem, {
      label: "Receive",
      children: (0, import_jsx_runtime.jsx)(TokenInfo, {
      ...
      label: "Fees",
      children: (0, import_jsx_runtime.jsx)(SwapFees, {
      ...
      children: (0, import_jsx_runtime.jsx)(Text, {
        color: "primaryText",
        children: shortenString(props.accountAddress, false)
      })
    }), (0, import_jsx_runtime.jsx)(ConfirmItem, {
      label: "Time",
      children: (0, import_jsx_runtime.jsxs)(Text, {
      ...
      y: "lg"
    }), isApprovalRequired && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime.jsxs)(Container, {
        gap: "sm",
        ...
        }), (0, import_jsx_runtime.jsx)(ConnectorLine, {}), (0, import_jsx_runtime.jsx)(Step, {
          isDone: false,
          label: "Confirm",
          isActive: step === "swap"
        })]
    ...
    }), status === "error" && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsxs)(Container, {
        flex: "row",
        gap: "xs",
        center: "y",
      ...
      gap: "xs",
      children: [step === "approval" ? "Approve" : "Confirm", status === "pending" && (0, import_jsx_runtime.jsx)(Spinner, {
        size: "sm",
        color: "accentButtonText"
      })]
    })]
...
function Step(props) {
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Circle, {
      children: props.isDone ? (0, import_jsx_runtime.jsx)(CheckIcon, {
        width: iconSize.sm,
        height: iconSize.sm
      }) : (0, import_jsx_runtime.jsx)(PulsingDot, {
...
function TokenInfo(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsxs)(Container, {
      ...
      }), (0, import_jsx_runtime.jsx)(TokenIcon, {
        token: props.token,
        chainId: props.chainId,
        size: "sm"
      })]
    }), chainQuery.data ? (0, import_jsx_runtime.jsx)(Text, {
      size: "sm",
      children: chainQuery.data.name
    }) : (0, import_jsx_runtime.jsx)(Skeleton, {
      width: "100px",
  ...
  return (0, import_jsx_runtime.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
        ...
        children: [(0, import_jsx_runtime.jsx)(Spacer, {
          y: "xxl"
        }), isSuccess ? (0, import_jsx_runtime.jsx)(CheckCircledIcon, {
          width: iconSize["4xl"],
          height: iconSize["4xl"]
        }) : isFailed ? (0, import_jsx_runtime.jsx)(AccentFailIcon, {
          size: iconSize["4xl"]
        }) : (0, import_jsx_runtime.jsxs)("div", {
          style: {
            position: "relative"
        ...
        }), !isFailed && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [(0, import_jsx_runtime.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime.jsxs)("div", {
            children: [(0, import_jsx_runtime.jsxs)(Text, {
        ...
        y: "xl"
      }), !isFailed && (0, import_jsx_runtime.jsx)(Button, {
        variant: "accent",
        fullWidth: true,
...
function PayWithCrypto(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsxs)(TokenButton, {
        variant: "secondary",
        onClick: props.onSelectToken,
        children: [(0, import_jsx_runtime.jsx)(TokenIcon, {
          token: props.token,
          ...
          }), chainQuery.data?.name ? (0, import_jsx_runtime.jsxs)(Text, {
            size: "xs",
            children: [" ", chainQuery.data.name]
          }) : (0, import_jsx_runtime.jsx)(Skeleton, {
            width: "90px",
        ...
        children: [props.isLoading ? (0, import_jsx_runtime.jsx)(Skeleton, {
          width: "120px",
          height: fontSize.md
        }) : (0, import_jsx_runtime.jsx)(Text, {
          size: "md",
          ...
          center: "y",
          color: "secondaryText",
          children: [(0, import_jsx_runtime.jsx)(WalletIcon, {
            size: fontSize.xs
          }), balanceQuery.data ? (0, import_jsx_runtime.jsx)(Text, {
            size: "xs",
            color: "secondaryText",
...
function useSwapSupportedChains(clientId) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return chains.filter((chain) => chain !== null);
    }
  });
}
...
function SwapScreen(props) {
  ...
  return (0, import_jsx_runtime.jsx)(SwapScreenContent, {
    ...props,
...
function SwapScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react12.useState)();
  const {
    drawerRef,
    drawerOverlayRef,
    onClose
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react12.useState)("");
  const [hasEditedAmount, setHasEditedAmount] = (0, import_react12.useState)(false);
  const isChainSupported = (0, import_react12.useMemo)(() => supportedChains.find((c) => c.chainId === activeChainId), [activeChainId, supportedChains]);
  const defaultChainId = isChainSupported ? activeChainId : 1;
  const [fromChainId, setFromChainId] = (0, import_react12.useState)(defaultChainId);
  const [toChainId, setToChainId] = (0, import_react12.useState)(defaultChainId);
  const [address, setAddress] = (0, import_react12.useState)(activeAddress);
  const [fromToken, setFromToken] = (0, import_react12.useState)(NATIVE_TOKEN);
  const [toToken, setToToken] = (0, import_react12.useState)(props.supportedTokens[toChainId]?.[0] || NATIVE_TOKEN);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const fromTokenBalanceQuery = useMultiChainBalance({
    tokenAddress: isNativeToken$1(fromToken) ? void 0 : fromToken.address,
    chainId: fromChainId
  });
  const [finalizedQuote, setFinalizedQuote] = (0, import_react12.useState)();
  const buyWithCryptoParams = deferredTokenAmount && !finalizedQuote && !(fromChainId === toChainId && fromToken === toToken) ? {
    fromAddress: address,
    fromChainId,
    fromTokenAddress: isNativeToken$1(fromToken) ? NATIVE_TOKEN_ADDRESS : fromToken.address,
    toChainId,
    toTokenAddress: isNativeToken$1(toToken) ? NATIVE_TOKEN_ADDRESS : toToken.address,
  ...
  if (screen === "confirmation" && quoteToConfirm) {
    return (0, import_jsx_runtime.jsx)(ConfirmationScreen, {
      clientId,
      accountAddress: address,
      onBack: () => {
        setFinalizedQuote(void 0);
        setScreen("main");
      },
  ...
  return (0, import_jsx_runtime.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [drawerScreen && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [(0, import_jsx_runtime.jsx)(DrawerOverlay, {
        ...
        children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
          ...
          y: "lg"
        }), !hasEditedAmount && (0, import_jsx_runtime.jsx)(Spacer, {
          y: "xl"
        }), (0, import_jsx_runtime.jsx)(BuyTokenInput, {
          value: tokenAmount,
        ...
        px: "lg",
        children: [hasEditedAmount && (0, import_jsx_runtime.jsxs)("div", {
          children: [(0, import_jsx_runtime.jsx)(PaymentSelection, {}), (0, import_jsx_runtime.jsx)(Spacer, {
            y: "md"
          }), (0, import_jsx_runtime.jsx)(PayWithCrypto, {
            ...
            children: [(0, import_jsx_runtime.jsxs)(Container, {
              ...
              color: "accentText",
              p: "sm",
              children: [(0, import_jsx_runtime.jsx)(ClockIcon, {
                width: iconSize.sm,
                height: iconSize.sm
              }), buyWithCryptoQuoteQuery.isLoading ? (0, import_jsx_runtime.jsx)(Skeleton, {
                height: fontSize.xs,
                width: "50px"
              }) : (0, import_jsx_runtime.jsx)(Text, {
                size: "xs",
            ...
            }), (0, import_jsx_runtime.jsxs)(FeesButton, {
              variant: "secondary",
              onClick: () => {
              ...
              children: [(0, import_jsx_runtime.jsx)(Container, {
                ...
                flex: "row",
                center: "both",
                children: (0, import_jsx_runtime.jsx)(ViewFeeIcon, {
                  size: iconSize.sm
                })
              }), (0, import_jsx_runtime.jsx)(Text, {
                size: "xs",
            ...
            children: [(0, import_jsx_runtime.jsx)(Text, {
              ...
              y: "xxs"
            }), (0, import_jsx_runtime.jsx)(WalletSelectorButton, {
              activeAddress,
              activeWalletConfig: props.activeWalletConfig,
              address,
              activeWallet,
            ...
            flex: "column",
            gap: "md",
            children: isSwapQuoteError && (0, import_jsx_runtime.jsxs)("div", {
              children: [(0, import_jsx_runtime.jsxs)(Container, {
                flex: "row",
                gap: "xs",
                center: "y",
        ...
        }), switchChainRequired && (0, import_jsx_runtime.jsx)(Button, {
          fullWidth: true,
          variant: "accent",
          ...
          children: hasEditedAmount ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [isSwitching && (0, import_jsx_runtime.jsx)(Spinner, {
              size: "sm",
              color: "accentButtonText"
...
function DrawerContent(props) {
  ...
  const isValidAddress = (0, import_react12.useMemo)(() => (0, import_utils3.isAddress)(address), [address]);
  const showError = !!address && !isValidAddress;
  return (0, import_jsx_runtime.jsxs)(DynamicHeight, {
    children: [drawerScreen === "fees" && (0, import_jsx_runtime.jsxs)("div", {
      children: [(0, import_jsx_runtime.jsx)(Text, {
        size: "lg",
        color: "primaryText",
        children: "Fees"
        ...
        y: "lg"
      }), quote && (0, import_jsx_runtime.jsx)(SwapFees, {
        quote,
        align: "left"
      })]
    }), drawerScreen === "address" && (0, import_jsx_runtime.jsxs)("div", {
      children: [(0, import_jsx_runtime.jsx)(Text, {
        size: "lg",
        color: "primaryText",
        children: "Send to"
        ...
        children: [(0, import_jsx_runtime.jsx)(StyledInput, {
      ...
      }), showError && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [(0, import_jsx_runtime.jsx)(Spacer, {
          y: "xxs"
        }), (0, import_jsx_runtime.jsx)(Text, {
          color: "danger",
...
function WalletSelectorButton(props) {
  return (0, import_jsx_runtime.jsxs)(AccountButton, {
    variant: "secondary",
    fullWidth: true,
    onClick: props.onClick,
    children: [props.activeAddress === props.address ? (0, import_jsx_runtime.jsx)(Img, {
      ...
      size: "sm",
      color: "primaryText",
      children: shortenString(props.address, false)
    }), props.chevron && (0, import_jsx_runtime.jsx)(ChevronDownIcon, {
      width: iconSize.sm,
      height: iconSize.sm,
      style: {
        marginLeft: "auto"
...
var FeesButton = newStyled(Button)(() => {
  const theme = useCustomTheme();
  return {
    background: "transparent",
    border: `1px solid transparent`,
...
var AccountButton = newStyled(Button)(() => {
  const theme = useCustomTheme();
  return {
    background: theme.colors.walletSelectorButtonHoverBg,
    border: `1px solid ${theme.colors.borderColor}`,
...
function SwapTransactionsScreen(props) {
  ...
  const inMemoryPendingTxs = (0, import_react12.useSyncExternalStore)(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  const txInfosToShow = [];
  const txHashSet = /* @__PURE__ */ new Set();
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsxs)(Container, {
        ...
        px: "lg",
        expand: true,
        children: [noTransactions && !_historyQuery.isLoading && (0, import_jsx_runtime.jsxs)(Container, {
          flex: "column",
          gap: "md",
          center: "both",
          color: "secondaryText",
        ...
        }), noTransactions && _historyQuery.isLoading && (0, import_jsx_runtime.jsx)(Container, {
          flex: "row",
          center: "both",
          style: {
            minHeight: "250px"
          ...
          return (0, import_jsx_runtime.jsx)(TransactionInfo, {
            txInfo
          }, txInfo.transactionHash);
        }), _historyQuery.isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [(0, import_jsx_runtime.jsx)(Skeleton, {
            width: "100%",
            height: "68px"
          }), (0, import_jsx_runtime.jsx)(Skeleton, {
            width: "100%",
        ...
        p: "lg",
        children: _historyQuery.data && !hidePagination && (0, import_jsx_runtime.jsxs)("div", {
          style: {
            display: "grid",
            gridTemplateColumns: "1fr 1fr",
            gap: spacing.sm
          ...
          children: [(0, import_jsx_runtime.jsxs)(Button, {
            ...
            children: ["Next", (0, import_jsx_runtime.jsx)(ArrowRightIcon, {
              width: iconSize.sm,
              height: iconSize.sm
            })]
          })]
      ...
      p: "lg",
      children: (0, import_jsx_runtime.jsx)(ButtonLink, {
        fullWidth: true,
        variant: "accent",
...
function TransactionInfo(props) {
  ...
  return (0, import_jsx_runtime.jsx)(TxHashLink, {
    ...
    children: (0, import_jsx_runtime.jsxs)(Container, {
      ...
      center: "y",
      gap: "md",
      children: [(0, import_jsx_runtime.jsxs)(IconBox, {
        "data-box": true,
        children: [(0, import_jsx_runtime.jsx)(BuyIcon, {
          size: iconSize.sm
        }), (0, import_jsx_runtime.jsx)("div", {
          style: {
            position: "absolute",
          ...
          children: (0, import_jsx_runtime.jsx)(CryptoIcon, {
            size: iconSize.sm
          })
        })]
      }), (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [(0, import_jsx_runtime.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime.jsxs)(Container, {
            ...
            }), statusMeta.loading && (0, import_jsx_runtime.jsx)(Spinner, {
              size: "xs",
              color: "accentText"
            })]
          }), chainQuery.data?.name ? (0, import_jsx_runtime.jsxs)(Text, {
...
var ConnectedWalletDetails = (props) => {
  ...
  const swapTxs = (0, import_react12.useSyncExternalStore)(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  ...
  const wrapperWallet = activeWallet ? walletContext.getWrapperWallet(activeWallet) : void 0;
  const [overrideWalletIconUrl, setOverrideWalletIconUrl] = (0, import_react12.useState)(void 0);
  const [screen, setScreen] = (0, import_react12.useState)("main");
      ...
      if (activeWallet.walletId === walletIds.embeddedWallet) {
        activeWallet.getLastUsedAuthStrategy().then((auth) => {
          if (auth === "apple") {
            ...
            setOverrideWalletIconUrl(void 0);
          }
        });
  ...
  const trigger = props.detailsBtn ? (0, import_jsx_runtime.jsx)("div", {
    ...
    children: [(0, import_jsx_runtime.jsx)(Img, {
      ...
      flex: "column",
      gap: "xxs",
      children: [activeWallet?.walletId === walletIds.localWallet ? (0, import_jsx_runtime.jsx)(Text, {
        color: "danger",
        size: "xs",
        style: {
          minWidth: "70px"
  ...
  const networkSwitcherButton = (0, import_jsx_runtime.jsxs)(MenuButton, {
    type: "button",
  ...
  const showFaucet = props.hideTestnetFaucet === void 0 ? false : !props.hideTestnetFaucet;
  let buttonsToShow = 3;
  ...
  let content = (0, import_jsx_runtime.jsxs)("div", {
    children: [(0, import_jsx_runtime.jsx)(Spacer, {
      y: "xl"
    }), (0, import_jsx_runtime.jsxs)(Container, {
      px: "lg",
      ...
      px: "lg",
      children: [(0, import_jsx_runtime.jsx)(ConnectedToSmartWallet, {}), (0, import_jsx_runtime.jsx)(EmbeddedWalletDetails, {}), (0, import_jsx_runtime.jsxs)(Container, {
        style: {
          display: "grid",
          gridTemplateColumns: `repeat(${buttonsToShow}, 1fr)`,
          gap: spacing.sm
        },
        children: [props.hideSendButton !== true && (0, import_jsx_runtime.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
        ...
        }), props.hideReceiveButton !== true && (0, import_jsx_runtime.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
        ...
        }), props.hideBuyButton !== true && (0, import_jsx_runtime.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
    ...
    }), buttonsToShow === 0 ? null : (0, import_jsx_runtime.jsx)(Spacer, {
      y: "md"
    }), (0, import_jsx_runtime.jsxs)(Container, {
      px: "md",
      children: [(0, import_jsx_runtime.jsxs)(Container, {
        ...
        children: [networkSwitcherButton, (0, import_jsx_runtime.jsxs)(MenuButton, {
          onClick: () => {
          ...
          children: [(0, import_jsx_runtime.jsx)(TextAlignJustifyIcon, {
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime.jsxs)(Container, {
            flex: "row",
            ...
            }), pendingSwapTxs && pendingSwapTxs.length > 0 && (0, import_jsx_runtime.jsx)(BadgeCount, {
              children: pendingSwapTxs.length
            })]
          })]
        }), personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && (0, import_jsx_runtime.jsx)(WalletSwitcher, {
        ...
        }), showFaucet && (chain?.faucets && chain.faucets.length > 0 || chain?.chainId === c1337.chainId) && (0, import_jsx_runtime.jsxs)(MenuLink, {
        ...
        }), activeWallet?.walletId === walletIds.localWallet && (0, import_jsx_runtime.jsx)("div", {
        ...
        }), props.detailsModalFooter && (0, import_jsx_runtime.jsx)(props.detailsModalFooter, {
          close: () => setIsOpen(false)
        })]
      }), (0, import_jsx_runtime.jsx)(Spacer, {
        y: "md"
      })]
    }), props.hideDisconnect !== true && (0, import_jsx_runtime.jsxs)(Container, {
      children: [(0, import_jsx_runtime.jsx)(Line, {}), (0, import_jsx_runtime.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime.jsx)(Container, {
        px: "md",
        children: (0, import_jsx_runtime.jsxs)(MenuButton, {
    ...
    }), activeWallet?.walletId === walletIds.localWallet && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [(0, import_jsx_runtime.jsx)(Line, {}), (0, import_jsx_runtime.jsx)(Container, {
        py: "md",
        children: (0, import_jsx_runtime.jsx)(Text, {
          size: "xs",
  ...
  if (screen === "network-switcher") {
    content = (0, import_jsx_runtime.jsx)(NetworkSelectorContent, {
      open: true,
      theme: props.theme,
      chains,
    ...
    content = (0, import_jsx_runtime.jsx)(ExportLocalWallet, {
      modalSize: "compact",
    ...
    content = (0, import_jsx_runtime.jsx)(SendFunds, {
    ...
    content = (0, import_jsx_runtime.jsx)(SwapTransactionsScreen, {
      onBack: () => setScreen("main")
    });
  } else if (screen === "buy") {
    content = (0, import_jsx_runtime.jsx)(SwapScreen, {
      onBack: () => setScreen("main"),
      supportedTokens: props.supportedTokens,
      onViewPendingTx: () => setScreen("pending-tx")
    });
  } else if (screen === "receive") {
    content = (0, import_jsx_runtime.jsx)(ReceiveFunds, {
...
var WalletInfoButton = StyledButton(() => {
  const theme = useCustomTheme();
  return {
    all: "unset",
...
function ConnectedToSmartWallet() {
  ...
  const address = useAddress();
  const locale = useTWLocale().connectWallet;
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = (0, import_react12.useState)(false);
  (0, import_react12.useEffect)(() => {
  ...
  const content = (0, import_jsx_runtime.jsxs)(Container, {
    ...
    gap: "xxs",
    center: "both",
    children: [(0, import_jsx_runtime.jsx)(ActiveDot, {}), locale.connectedToSmartWallet]
  });
...
var SignatureScreen = (_ref) => {
  ...
  const {
    auth
  } = (0, import_react12.useContext)(ModalConfigCtx);
  const [status, setStatus] = (0, import_react12.useState)("idle");
  const {
    login
  } = useLogin();
  ...
  const chainId = useChainId();
  const address = useAddress();
  const safeChainSlug = chainId && chainId in safeChainIdToSlug ? safeChainIdToSlug[chainId] : void 0;
  const signIn = (0, import_react12.useCallback)(async () => {
    try {
      setStatus("signing");
      await wait(1e3);
  ...
  if (walletConfig?.isHeadless) {
    return (0, import_jsx_runtime.jsx)(HeadlessSignIn, {
      signIn,
      status
    });
  }
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      center: "y",
      expand: true,
      children: status === "idle" ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [walletConfig && (0, import_jsx_runtime.jsx)(Container, {
          flex: "row",
          center: "x",
          animate: "fadein",
          py: "3xl",
          children: (0, import_jsx_runtime.jsx)(PulsatingContainer, {
            children: (0, import_jsx_runtime.jsx)(Img, {
        ...
        children: [walletConfig && (0, import_jsx_runtime.jsx)(Container, {
          ...
          }), status === "signing" && (0, import_jsx_runtime.jsx)(Text, {
            center: true,
            multiline: true,
            balance: true,
            children: isSafeWallet ? (0, import_jsx_runtime.jsx)(SafeWalletInstruction, {}) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
              children: locale.signingScreen.prompt
            })
          }), isSafeWallet && status === "signing" && (0, import_jsx_runtime.jsxs)(Container, {
            children: [(0, import_jsx_runtime.jsx)(Spacer, {
              y: "sm"
            }), (0, import_jsx_runtime.jsxs)(Button, {
              fullWidth: true,
              ...
              children: [" ", locale.signingScreen.approveTransactionInSafe, (0, import_jsx_runtime.jsx)(ExternalLinkIcon, {
                width: iconSize.sm,
                height: iconSize.sm
              })]
            })]
          }), status === "failed" && (0, import_jsx_runtime.jsxs)(Container, {
            children: [(0, import_jsx_runtime.jsx)(Spacer, {
              y: "sm"
            }), (0, import_jsx_runtime.jsxs)(Button, {
              fullWidth: true,
    ...
    }), (termsOfServiceUrl || privacyPolicyUrl) && (0, import_jsx_runtime.jsx)(Container, {
      p: "md",
      animate: "fadein",
      children: (0, import_jsx_runtime.jsx)(TOS, {
        termsOfServiceUrl,
...
function SafeWalletInstruction() {
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: isSafePersonalWalletHeadless ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
...
function HeadlessSignIn(_ref2) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      ...
      children: [status === "signing" && (0, import_jsx_runtime.jsx)(Spinner, {
        size: "xl",
        color: "accentText"
      }), status === "failed" && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
        children: (0, import_jsx_runtime.jsxs)(Container, {
          children: [(0, import_jsx_runtime.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime.jsx)(Text, {
...
`;
var PulsatingContainer = StyledDiv(() => {
  const theme = useCustomTheme();
  return {
    position: "relative",
    "&::before": {
...
function ConnectWallet(props) {
  ...
  const setModalConfig = (0, import_react12.useContext)(SetModalConfigCtx);
  ...
  const [showSignatureModal, setShowSignatureModal] = (0, import_react12.useState)(false);
  const address = useAddress();
  const {
    user
  } = useUser();
  ...
  const supportedTokens = (0, import_react12.useMemo)(() => {
  ...
  return (0, import_jsx_runtime.jsxs)(CustomThemeProvider, {
    ...
    children: [(0, import_jsx_runtime.jsx)(Modal, {
      ...
      children: (0, import_jsx_runtime.jsx)(SignatureScreen, {
        modalSize: "compact",
...
function SwitchNetworkButton(props) {
  ...
  const switchChain = useSwitchChain();
  const [switching, setSwitching] = (0, import_react12.useState)(false);
  const locale = useTWLocale();
  ...
  return (0, import_jsx_runtime.jsx)(AnimatedButton, {
    ...
    "aria-label": switching ? locale.connectWallet.switchingNetwork : void 0,
...
function StartScreen() {
  ...
  const title = (typeof WelcomeScreen === "object" ? WelcomeScreen?.title : void 0) || locale.welcomeScreen.defaultTitle;
  const subtitle = (typeof WelcomeScreen === "object" ? WelcomeScreen?.subtitle : void 0) || locale.welcomeScreen.defaultSubtitle;
  const img = typeof WelcomeScreen === "object" ? WelcomeScreen?.img : void 0;
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsxs)(Container, {
      ...
      gap: "lg",
      children: (0, import_jsx_runtime.jsxs)("div", {
        children: [showTOS && (0, import_jsx_runtime.jsx)(TOS, {
          termsOfServiceUrl,
          privacyPolicyUrl
        }), showThirdwebBranding !== false && (0, import_jsx_runtime.jsx)(Container, {
          style: {
...
var ConnectModalContent = (props) => {
  ...
  const authConfig = useThirdwebAuthContext();
  const [handleConnectedPending, setIsHandleConnectedPending] = (0, import_react12.useState)(false);
  const handleConnected = (0, import_react12.useCallback)((_wallet) => {
    if (onConnect) {
      onConnect(_wallet);
    }
  ...
  const getWalletUI = (walletConfig) => {
    const ConnectUI2 = walletConfig.connectUI || HeadlessConnectUI;
    return (0, import_jsx_runtime.jsx)(ConnectUI2, {
  ...
  const signatureScreen = (0, import_jsx_runtime.jsx)(SignatureScreen, {
    onDone: onClose,
    modalSize,
    termsOfServiceUrl: modalConfig.termsOfServiceUrl,
    privacyPolicyUrl: modalConfig.privacyPolicyUrl
  });
  return (0, import_jsx_runtime.jsx)(ScreenSetupContext.Provider, {
    ...
    children: isWideModal ? (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [(0, import_jsx_runtime.jsxs)(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
          children: getStarted
...
var ConnectModal = () => {
  ...
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const [hideModal, setHideModal] = (0, import_react12.useState)(false);
  const connectionStatus = useConnectionStatus();
  ...
  const onHide = (0, import_react12.useCallback)(() => setHideModal(true), []);
  const onShow = (0, import_react12.useCallback)(() => setHideModal(false), []);
  return (0, import_jsx_runtime.jsx)(CustomThemeProvider, {
    theme,
    children: (0, import_jsx_runtime.jsx)(Modal, {
      hide: hideModal,
...
function ConnectEmbed(props) {
  ...
  if (show) {
    return (0, import_jsx_runtime.jsx)(WalletUIStatesProvider, {
      ...walletUIStatesProps,
      children: (0, import_jsx_runtime.jsxs)(CustomThemeProvider, {
        theme: walletUIStatesProps.theme,
        children: [(0, import_jsx_runtime.jsx)(ConnectEmbedContent, {
          ...props,
          onConnect: props.onConnect
        }), (0, import_jsx_runtime.jsx)(SyncedWalletUIStates, {
          ...walletUIStatesProps
        })]
      })
    });
...
var ConnectEmbedContent = (props) => {
  ...
  if (isAutoConnecting || connectionStatus === "unknown") {
    ...
    content = (0, import_jsx_runtime.jsx)(ConnectModalContent, {
      screenSetup,
      isOpen: true,
      onClose: () => {
        setScreen(initialScreen);
  ...
  return (0, import_jsx_runtime.jsx)(EmbedContainer, {
    className: props.className,
    style: {
      height: "auto",
    ...
    children: (0, import_jsx_runtime.jsxs)(DynamicHeight, {
      children: [" ", content, " "]
    })
  });
};
...
var ConnectModalInline = (props) => {
  const walletConfigs = useWallets();
  const modalSize = !canFitWideModal() || walletConfigs.length === 1 ? "compact" : props.modalSize;
  ...
  return (0, import_jsx_runtime.jsx)(WalletUIStatesProvider, {
    ...
    children: (0, import_jsx_runtime.jsxs)(CustomThemeProvider, {
      theme: walletUIStatesProps.theme,
      children: [(0, import_jsx_runtime.jsx)(ConnectModalInlineContent, {
        className: props.className,
        modalSize
      }), (0, import_jsx_runtime.jsx)(SyncedWalletUIStates, {
        ...walletUIStatesProps
...
function ConnectModalInlineContent(props) {
  ...
  return (0, import_jsx_runtime.jsx)(ConnectModalInlineContainer, {
    className: props.className,
    style: {
      height: props.modalSize === "compact" ? "auto" : wideModalMaxHeight,
      maxWidth: props.modalSize === "compact" ? modalMaxWidthCompact : modalMaxWidthWide,
      ...props.style
    },
...
var ConnectModalInlineContainer = StyledDiv(() => {
  const theme = useCustomTheme();
  return {
    background: theme.colors.modalBg,
    color: theme.colors.primaryText,
...
var ModelViewer = (0, import_react12.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-457YCNZP.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  } = _ref;
  const [isHovering, setIsHovering] = (0, import_react12.useState)(false);
...
var VideoPlayer = (() => import_react12.default.forwardRef(function Video_Player(_ref2, ref) {
  let {
    src,
    alt,
    poster,
  ...
  const [playing, setPlaying] = (0, import_react12.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react12.useState)(true);
  (0, import_react12.useEffect)(() => {
    if (videoRef.current) {
      if (playing) {
        try {
...
var AudioPlayer = (() => import_react12.default.forwardRef(function Audio_Player(_ref3, ref) {
  let {
    src,
    alt,
    poster,
  ...
  const [playing, setPlaying] = (0, import_react12.useState)(false);
  const [muted, setMuted] = (0, import_react12.useState)(true);
  (0, import_react12.useEffect)(() => {
    if (audioRef.current) {
      if (playing) {
...
var IframePlayer = (() => import_react12.default.forwardRef(function Iframe_Player(_ref4, ref) {
  let {
    src,
    alt,
    poster,
...
var LinkPlayer = (() => import_react12.default.forwardRef(function Link_Player(_ref5, ref) {
  let {
    src,
    alt,
    style,
...
var MediaRenderer = (() => import_react12.default.forwardRef(function Media_Renderer(_ref6, ref) {
  let {
    src,
    poster,
    alt,
  ...
  const videoOrImageSrc = useResolvedMediaType(src ?? void 0, mimeType, gatewayUrl);
  ...
  if (!videoOrImageSrc.mimeType) {
    ...
    return (0, import_jsx_runtime.jsx)(import_react12.Suspense, {
...
function useResolvedMediaType(uri, mimeType, gatewayUrl) {
  const storage = useStorage();
  const resolvedUrl = (0, import_react12.useMemo)(() => {
    if (!uri) {
      return "";
    }
    if (gatewayUrl) {
...
var ThirdwebNftMedia = (() => import_react12.default.forwardRef(function Thirdweb_NftMedia(_ref, ref) {
  let {
    metadata,
    width = "300px",
    height = "300px",
...
var Web3Button = (props) => {
  ...
  const [confirmStatus, setConfirmStatus] = (0, import_react12.useState)("idle");
...
var ThirdwebProvider = (props) => {
  ...
  const signerWalletConfig = (0, import_react12.useMemo)(() => signer ? signerWallet(signer) : void 0, [signer]);
  const ewsRef = (0, import_react12.useRef)(false);
  (0, import_react12.useEffect)(() => {
    if (ewsRef.current) {
      return;
    }
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-3VKGUPKT.js");
  ...
  return (0, import_jsx_runtime.jsx)(ThirdwebLocaleContext.Provider, {
    value: restProps.locale || en(),
    children: (0, import_jsx_runtime.jsx)(WalletUIStatesProvider, {
      theme,
...
function useRainbowWallet() {
  const connect = useConnect();
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-02e3bfeb.browser.esm-7AJCZ7IH.js").then(function(n) {
      return n.R;
    });
...
function useMetamask() {
  const connect = useConnect();
  return (0, import_react12.useCallback)(async (options) => {
    const {
      metamaskWallet
    } = await import("./safeChainSlug-02e3bfeb.browser.esm-7AJCZ7IH.js").then(function(n) {
      return n.n;
...
function useFrameWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-88665c8a.browser.esm-22SDUKFQ.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-JDNCOC2U.js");
    return connect(bloctoWallet({
      appId: options?.appId
    }), options);
  }, [connect]);
}
var useEmbeddedWalletSendVerificationEmail = () => {
  const context = useWalletContext();
  const sendVerificationEmail = (0, import_react12.useCallback)(async (email) => {
    if (!context.clientId) {
...
function usePaperWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-d40558df.browser.esm-7O4UCIHW.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-b4d1e793.browser.esm-ALZX2GYO.js");
...
var oneKeyWalletUris = {
  ios: "onekey-wallet://",
  android: "onekey-wallet://",
  other: "onekey-wallet://"
};
var oneKeyWallet = (options) => {
  return {
    id: OneKeyWallet.id,
    recommended: options?.recommended,
    meta: {
...
var PaperFormUI = (props) => {
  ...
  const googleLogin = async () => {
    try {
      const paperWallet2 = createWalletInstance();
      setConnectionStatus("connecting");
  ...
  return (0, import_jsx_runtime2.jsxs)("div", {
    children: [props.googleLoginSupported && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
      children: [(0, import_jsx_runtime2.jsxs)(SocialButton2, {
        variant: "secondary",
        fullWidth: true,
        onClick: () => {
          googleLogin();
...
var PaperFormUIScreen = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Container, {
    ...
    }), isCompact && (modalConfig.showThirdwebBranding !== false || modalConfig.termsOfServiceUrl || modalConfig.privacyPolicyUrl) && (0, import_jsx_runtime2.jsx)(Spacer, {
      y: "xl"
    }), (0, import_jsx_runtime2.jsxs)(Container, {
      flex: "column",
      gap: "lg",
      children: [(0, import_jsx_runtime2.jsx)(TOS, {
        termsOfServiceUrl: modalConfig.termsOfServiceUrl,
        privacyPolicyUrl: modalConfig.privacyPolicyUrl
      }), modalConfig.showThirdwebBranding !== false && (0, import_jsx_runtime2.jsx)(PoweredByThirdweb, {})]
    })]
  });
};
var SocialButton2 = newStyled(Button)({
  display: "flex",
  justifyContent: "center",
  gap: spacing.sm
});
var PaperOTPLoginUI = (props) => {
  ...
  const [otpInput, setOtpInput] = (0, import_react14.useState)("");
  const [recoveryCode, setRecoveryCode] = (0, import_react14.useState)("");
  const {
    createWalletInstance,
    setConnectedWallet,
    setConnectionStatus
  ...
  const isWideModal = props.modalSize === "wide";
  const [verifyStatus, setVerifyStatus] = (0, import_react14.useState)("idle");
  const [sendEmailStatus, setSendEmailStatus] = (0, import_react14.useState)("sending");
  ...
  const sendEmail = (0, import_react14.useCallback)(async () => {
    setOtpInput("");
    setVerifyStatus("idle");
  ...
  const emailSentOnMount = (0, import_react14.useRef)(false);
  ...
  return (0, import_jsx_runtime2.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime2.jsx)(Container, {
      ...
      children: (0, import_jsx_runtime2.jsxs)("form", {
        ...
        children: [(0, import_jsx_runtime2.jsxs)(Container, {
        ...
        }), verifyStatus === "invalid" && (0, import_jsx_runtime2.jsxs)(Container, {
          animate: "fadein",
          children: [(0, import_jsx_runtime2.jsx)(Spacer, {
            y: "md"
          }), (0, import_jsx_runtime2.jsx)(Text, {
          ...
          p: isWideModal ? void 0 : "lg",
          animate: "fadein",
          children: [sendEmailStatus === "error" && (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {
          ...
          }), typeof sendEmailStatus !== "string" && (0, import_jsx_runtime2.jsx)(LinkButton2, {
            onClick: sendEmail,
            type: "button",
      ...
      children: [(0, import_jsx_runtime2.jsx)(ModalHeader, {
        title: (0, import_jsx_runtime2.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime2.jsx)(Img, {
            ...
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime2.jsxs)(ModalTitle, {
            children: [" ", locale.title, " "]
          })]
        }),
        onBack: goBack
  ...
  return {
    ...
    selectUI(props) {
      return (0, import_jsx_runtime2.jsx)(PaperSelectionUI, {
        ...
        providers: oauthOptions ? oauthOptions?.providers : void 0
      });
    },
    connectUI(props) {
...
var PaperConnectUI = (props) => {
  const [loginType, setLoginType] = (0, import_react14.useState)(props.selectionData);
  if (loginType) {
    const handleBack = () => {
      if (props.modalSize === "wide") {
        setLoginType(void 0);
...
//# sourceMappingURL=chunk-ZDMXWXYD.js.map
