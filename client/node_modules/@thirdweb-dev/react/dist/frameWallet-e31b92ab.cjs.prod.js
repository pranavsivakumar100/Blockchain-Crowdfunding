...
const FrameFailedConnect = props => {
  const locale = formElements.useTWLocale().wallets.frameWallet.connectionFailedScreen;
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.ModalTitle, {
...
const FrameConnectUI = props => {
  ...
  const locale = formElements.useTWLocale().wallets.frameWallet;
  const {
    connect
  } = props;
