import {
  ...
  useWalletConnect,
  useWalletConnectV1
} from "./chunk-ZDMXWXYD.js";
import {
  walletConnectV1
} from "./chunk-UYSHLRXC.js";
import {
  magicLink
} from "./chunk-BB3ODL4J.js";
import "./chunk-B2SOXMTM.js";
import {
  safeWallet
} from "./chunk-FZSLUR5Y.js";
import {
  frameWallet
} from "./chunk-4XXVZ6RE.js";
import {
  ConnectingScreen,
...
import "./chunk-4HTEFHVR.js";
import {
  getInjectedXDEFIProvider
} from "./chunk-HDO5EHV6.js";
import "./chunk-ZPPT4XVB.js";
import "./chunk-GKDFJ6GX.js";
import "./chunk-YAPP7FQW.js";
import {
...
import "./chunk-4JII2AG5.js";
import "./chunk-U573SYRD.js";
import "./chunk-IZWHDSTB.js";
import "./chunk-7OTRP6A5.js";
import "./chunk-FFUJKP4A.js";
import {
...
import "./chunk-GFJJKRSU.js";
import "./chunk-7FC4DLRO.js";
import "./chunk-TPZ4ZNQE.js";
import "./chunk-774J2MD3.js";
import {
...
// node_modules/@thirdweb-dev/react/dist/useSafe-0347b406.browser.esm.js
init_shim();
...
function useSafe() {
  ...
  return (0, import_react.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-33f82f3b.browser.esm-NSFCL26P.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-b62f2f1d.browser.esm.js
init_shim();
...
function useMagic() {
  ...
  return (0, import_react2.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-d1f280cc.browser.esm-6PWZBPK6.js");
    return connect(magicLink2(options), options);
  }, [connect]);
}

// node_modules/@thirdweb-dev/payments/dist/thirdweb-dev-payments.browser.esm.js
init_shim();
var isDev = () => {
  return !!(window.localStorage.getItem("IS_PAPER_DEV") === "true");
};
var isOldPaperDomain = () => window.location.hostname === "paper.xyz" || window.location.hostname.endsWith(".paper.xyz");
var isThirdwebDomain = () => window.location.hostname === "thirdweb.com" || window.location.hostname.endsWith(".thirdweb.com");
var getPaperOriginUrl = () => {
  if (isDev()) {
...
var PAPER_APP_URL = getPaperOriginUrl();
var CHECKOUT_WITH_CARD_IFRAME_URL = "/sdk/2022-08-12/checkout-with-card";
var DEFAULT_BRAND_OPTIONS = {
  colorPrimary: "#cf3781",
...
var PaymentsSDKErrorCode = function(PaymentsSDKErrorCode2) {
  PaymentsSDKErrorCode2["UserAbandonedCheckout"] = "User abandoned the checkout";
  PaymentsSDKErrorCode2["UserLoginFailed"] = "User login failed";
  PaymentsSDKErrorCode2["InvalidProps"] = "The props you passed in to this component are not valid.";
  PaymentsSDKErrorCode2["InvalidCard"] = "The card information is invalid. Please double check that the Card, CVC, and Zip code are all correct.";
  PaymentsSDKErrorCode2["EmailNotVerified"] = "The email was unable to be verified.";
  PaymentsSDKErrorCode2["NotEnoughSupply"] = "There is not enough supply to claim.";
  PaymentsSDKErrorCode2["AddressNotAllowed"] = "This address is not on the allowlist.";
  PaymentsSDKErrorCode2["NoActiveClaimPhase"] = "There is no active claim phase at the moment.";
  return PaymentsSDKErrorCode2;
}({});
var PayWithCryptoErrorCode = function(PayWithCryptoErrorCode2) {
  PayWithCryptoErrorCode2["ErrorConnectingToWallet"] = "Error connecting to wallet";
  PayWithCryptoErrorCode2["ErrorSendingTransaction"] = "Something went wrong sending transaction";
  PayWithCryptoErrorCode2["InsufficientBalance"] = "Insufficient ETH";
  PayWithCryptoErrorCode2["TransactionCancelled"] = "Transaction Cancelled";
  PayWithCryptoErrorCode2["WrongChain"] = "Wrong Chain Detected";
  PayWithCryptoErrorCode2["ChainSwitchUnderway"] = "There is a network switch already underway";
  PayWithCryptoErrorCode2["PendingSignature"] = "Pending Signature";
  return PayWithCryptoErrorCode2;
}({});
var LinksManager = class {
  ...
  addStylingOptions(options) {
    ...
    if (options.borderRadius !== void 0) {
...
var PaperPaymentElement = class {
  ...
  createPaymentElement(_ref2) {
    ...
    iframe.setAttribute("data-thirdweb-sdk-version", `${packageJson2.name}@${packageJson2.version}`);
    if (!this.elementOrId) {
...
`;
var MODAL_ID = "paper-js-sdk-modal";
var Modal = class {
  constructor(container, styles) {
    ...
    this.iframe.setAttribute("data-thirdweb-sdk-version", `${packageJson2.name}@${packageJson2.version}`);
...
var createEmotion = function createEmotion2(options) {
  ...
  cache2.sheet.speedy = function(value) {
    if (import_process.default.env.NODE_ENV !== "production" && this.ctr !== 0) {
...
function useSmartWallet(personalWallet, options) {
  ...
  const predictAddress = (0, import_react3.useCallback)(async (args) => {
  ...
  const connect = (0, import_react3.useCallback)(async (args) => {
    ...
    const sw = create(smartWallet2(personalWallet, options));
    try {
      ...
      children: [(0, import_jsx_runtime.jsx)("input", {
        ...
        children: !uploaded ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
          children: [" ", (0, import_jsx_runtime.jsx)(UploadIconSecondary, {
            ...
            y: "lg"
          }), error ? (0, import_jsx_runtime.jsx)(Text, {
            color: "danger",
            size: "sm",
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(ModalDescription, {
        ...
        children: [(0, import_jsx_runtime.jsx)("input", {
          ...
          children: [isConnecting ? locale.createScreen.connecting : locale.createScreen.createNewWallet, isConnecting && (0, import_jsx_runtime.jsx)(Spinner, {
            size: "sm",
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime.jsx)(Text, {
        ...
        children: [(0, import_jsx_runtime.jsx)("input", {
          ...
          children: [locale.reconnectScreen.continue, isConnecting && (0, import_jsx_runtime.jsx)(Spinner, {
            size: "sm",
            color: "accentButtonText"
          })]
        })]
...
var MagicEdenConnectUI = (props) => {
  const [screen, setScreen] = (0, import_react3.useState)("connecting");
  const locale = useTWLocale().wallets.magicEdenWallet;
  const {
    walletConfig,
    connected
  } = props;
  const [errorConnecting, setErrorConnecting] = (0, import_react3.useState)(false);
  const {
    connect
  } = props;
  ...
  const connectToExtension = (0, import_react3.useCallback)(async () => {
    try {
  ...
  const connectPrompted = (0, import_react3.useRef)(false);
  (0, import_react3.useEffect)(() => {
...
var smartWallet = (walletConfig, config) => {
  return {
    ...walletConfig,
    ...
    selectUI: walletConfig.selectUI ? (props) => (0, import_jsx_runtime.jsx)(SmartSelectUI, {
      ...props,
      personalWalletConfig: walletConfig
    }) : void 0,
...
var SmartSelectUI = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)(PersonalWalletSelectUI, {
    walletConfig: props.personalWalletConfig,
    connect: (options) => {
...
var OKXScan = (props) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react3.useState)();
  const {
    chainToConnect
  } = useWalletContext();
  const scanStarted = (0, import_react3.useRef)(false);
  (0, import_react3.useEffect)(() => {
...
var OKXConnectUI = (props) => {
  ...
  if (screen === "scanning") {
    return (0, import_jsx_runtime.jsx)(OKXScan, {
      onBack: props.goBack,
...
var cryptoDefiWalletUris = {
  ios: "dfw://",
  android: "dfw://",
  other: "dfw://"
};
var cryptoDefiWallet = (options) => {
  return {
...
var RabbyConnectUI = (props) => {
  ...
  if (screen === "scanning") {
    return (0, import_jsx_runtime.jsx)(RabbyScan, {
      onBack: props.goBack,
      onConnected: props.connected,
      onGetStarted: () => {
        setScreen("get-started");
...
var coin98WalletUris = {
  ios: "coin98://",
  android: "coin98://",
  other: "coin98://"
};
var coin98Wallet = (options) => {
  return {
    id: Coin98Wallet.id,
    recommended: options?.recommended,
    meta: {
...
var imTokenWalletUris = {
  ios: "imtokenv2://",
  android: "imtokenv2://"
};
var imTokenWallet = (options) => {
  return {
    id: ImTokenWallet.id,
    recommended: options?.recommended,
    meta: {
...
function jaDefault() {
  return {
    ...
    wallets: {
      ...
      magicEdenWallet: extensionAndQRScanScreens$1("Magic Eden"),
      ...
      imTokenWallet: extensionAndQRScanScreens$1("imToken"),
...
function extensionAndQRScanScreens(walletName) {
  return {
    connectionScreen: {
      inProgress: "Esperando confirmaci\xF3n",
      failed: "Conexi\xF3n fallida",
      instruction: `Acepta la solicitud de conexi\xF3n en tu cartera ${walletName}`,
      retry: "Intentar de nuevo"
    },
    getStartedScreen: {
      instruction: `Escanea el c\xF3digo QR para descargar la aplicaci\xF3n ${walletName}`
    },
    scanScreen: {
      instruction: `Escanea el c\xF3digo QR con la aplicaci\xF3n de cartera ${walletName} para conectarte`
    },
    getStartedLink: `\xBFNo tienes la cartera ${walletName}?`
  };
}
function esDefault() {
  return {
    connectWallet: {
      ...
      newToWallets: "\xBFNuevo en carteras?",
      getStarted: "Comenzar",
      guest: "Invitado",
      send: "Enviar",
      receive: "Recibir",
      ...
      goBackButton: "Atras",
      download: {
        chrome: "Descargar extensi\xF3n para Chrome",
      ...
      receiveFundsScreen: {
        ...
        instruction: "Copia la direcci\xF3n de la cartera para enviar fondos a esta cartera"
      },
      sendFundsScreen: {
        title: "Enviar fondos",
        submitButton: "Enviar",
        ...
        sendTo: "Enviar a",
        amount: "Cantidad",
        successMessage: "Transacci\xF3n exitosa",
        invalidAddress: "Direcci\xF3n inv\xE1lida",
        noTokensFound: "No se encontraron tokens",
        searchToken: "Buscar o pegar la direcci\xF3n del token",
        transactionFailed: "Transacci\xF3n fallida",
        transactionRejected: "Transacci\xF3n rechazada",
      ...
      signatureScreen: {
        instructionScreen: {
          ...
          signInButton: "Iniciar sesi\xF3n",
          disconnectWallet: "Desconectar cartera"
        },
        signingScreen: {
          title: "Iniciando sesi\xF3n",
          prompt: "Firma la solicitud de firma en tu cartera",
          promptForSafe: "Firma la solicitud de firma en tu cartera y aprueba la transacci\xF3n en Safe",
          approveTransactionInSafe: "Aprobar transacci\xF3n en Safe",
          tryAgain: "Intentar de nuevo",
          failedToSignIn: "Error al iniciar sesi\xF3n",
          inProgress: "Esperando confirmaci\xF3n"
        }
      }
    },
    wallets: {
      walletConnect: {
        scanInstruction: "Escanea esto con tu aplicaci\xF3n de cartera para conectar"
      },
      smartWallet: {
        ...
        wrongNetworkScreen: {
          ...
          subtitle: "Tu cartera no est\xE1 conectada a la red requerida",
          failedToSwitch: "Error al cambiar de red"
        }
      },
      safeWallet: {
        connectWalletScreen: {
          ...
          learnMoreLink: "Saber m\xE1s"
        },
        accountDetailsScreen: {
          title: "Introduce los detalles de tu safe",
          findSafeAddressIn: "Puedes encontrar tu direcci\xF3n de safe en",
          dashboardLink: "Tablero de Safe",
          network: "Red de Safe",
          selectNetworkPlaceholder: "Red a la que se ha desplegado tu safe",
          invalidChainConfig: "No se puede usar Safe: No hay cadenas compatibles con Safe configuradas en la aplicaci\xF3n",
          failedToConnect: "No se pudo conectar con Safe. Aseg\xFArate de que la direcci\xF3n y red del safe son correctas",
          failedToSwitch: "Error al cambiar de red",
          ...
          mainnets: "Redes principales",
          testnets: "Redes de prueba",
          safeAddress: "Direcci\xF3n de Safe"
        }
      },
      ...
      paperWallet: {
        signIn: "Iniciar sesi\xF3n",
        signInWithGoogle: "Iniciar sesi\xF3n con Google",
        emailPlaceholder: "Ingresa tu direcci\xF3n de correo electr\xF3nico",
        submitEmail: "Continuar",
        invalidEmail: "Direcci\xF3n de correo electr\xF3nico inv\xE1lida",
        emailRequired: "Se requiere direcci\xF3n de correo electr\xF3nico",
        googleLoginScreen: {
          title: "Iniciar sesi\xF3n",
          instruction: "Selecciona tu cuenta de Google en la ventana emergente",
          failed: "Error al iniciar sesi\xF3n",
          retry: "Reintentar"
        },
        emailLoginScreen: {
          title: "Iniciar sesi\xF3n",
          enterCodeSendTo: "Ingresa el c\xF3digo de verificaci\xF3n enviado a",
          newDeviceDetected: "Nuevo dispositivo detectado",
          enterRecoveryCode: "Ingresa el c\xF3digo de recuperaci\xF3n que se te envi\xF3 por correo electr\xF3nico cuando te registraste por primera vez",
          invalidCode: "C\xF3digo de verificaci\xF3n inv\xE1lido",
          invalidCodeOrRecoveryCode: "C\xF3digo de verificaci\xF3n o de recuperaci\xF3n inv\xE1lido",
          verify: "Verificar",
          failedToSendCode: "Error al enviar el c\xF3digo de verificaci\xF3n",
          sendingCode: "Enviando c\xF3digo de verificaci\xF3n",
          resendCode: "Reenviar c\xF3digo de verificaci\xF3n"
        }
      },
      embeddedWallet: {
        signInWithGoogle: "Iniciar sesi\xF3n con Google",
        signInWithFacebook: "Iniciar sesi\xF3n con Facebook",
        signInWithApple: "Iniciar sesi\xF3n con Apple",
        signInWithEmail: "Iniciar sesi\xF3n con correo electr\xF3nico",
        emailPlaceholder: "Ingresa tu direcci\xF3n de correo electr\xF3nico",
        submitEmail: "Continuar",
        signIn: "Iniciar sesi\xF3n",
        emailRequired: "Se requiere direcci\xF3n de correo electr\xF3nico",
        invalidEmail: "Direcci\xF3n de correo electr\xF3nico inv\xE1lida",
        maxAccountsExceeded: "N\xFAmero m\xE1ximo de cuentas alcanzado",
        invalidPhone: "N\xFAmero de tel\xE9fono inv\xE1lido",
        invalidEmailOrPhone: "Direcci\xF3n de correo electr\xF3nico o n\xFAmero de tel\xE9fono inv\xE1lido",
        countryCodeMissing: "Phone number must start with a country code",
        phonePlaceholder: "Ingresa tu n\xFAmero de tel\xE9fono",
        signInWithPhone: "Iniciar sesi\xF3n con n\xFAmero de tel\xE9fono",
        phoneRequired: "Se requiere n\xFAmero de tel\xE9fono",
        socialLoginScreen: {
          title: "Iniciar sesi\xF3n",
          instruction: "Inicie sesi\xF3n en su cuenta en la ventana abierta",
          failed: "Error al iniciar sesi\xF3n",
          retry: "Reintentar"
        },
        otpLoginScreen: {
        ...
        createPassword: {
          title: "Crear contrase\xF1a",
          instruction: "Establezca una contrase\xF1a para su cuenta. Necesitar\xE1 esta contrase\xF1a cuando se conecte desde un nuevo dispositivo.",
          saveInstruction: "Aseg\xFArese de guardarla",
          inputPlaceholder: "Ingrese su contrase\xF1a",
          confirmation: "He guardado mi contrase\xF1a",
          submitButton: "Establecer contrase\xF1a",
          failedToSetPassword: "Error al establecer la contrase\xF1a"
        },
        enterPassword: {
          title: "Ingrese la contrase\xF1a",
          instruction: "Ingrese la contrase\xF1a de su cuenta",
          inputPlaceholder: "Ingrese su contrase\xF1a",
      ...
      magicLink: {
        signIn: "Iniciar sesi\xF3n",
        loginWith: "Iniciar sesi\xF3n con",
        submitEmail: "Continuar",
        loginWithEmailOrPhone: "Iniciar sesi\xF3n con correo electr\xF3nico o n\xFAmero de tel\xE9fono",
        emailOrPhoneRequired: "Se requiere correo electr\xF3nico o n\xFAmero de tel\xE9fono",
        loginWithPhone: "Iniciar sesi\xF3n con n\xFAmero de tel\xE9fono",
        phoneRequired: "Se requiere n\xFAmero de tel\xE9fono",
        invalidEmail: "Direcci\xF3n de correo electr\xF3nico inv\xE1lida",
        invalidPhone: "N\xFAmero de tel\xE9fono inv\xE1lido",
        invalidEmailOrPhone: "Direcci\xF3n de correo electr\xF3nico o n\xFAmero de tel\xE9fono inv\xE1lido",
        countryCodeMissing: "El n\xFAmero de tel\xE9fono debe comenzar con un c\xF3digo de pa\xEDs",
        emailPlaceholder: "Ingresa tu direcci\xF3n de correo electr\xF3nico",
        emailRequired: "Se requiere direcci\xF3n de correo electr\xF3nico"
      },
      localWallet: {
        ...
        enterYourPassword: "Ingresa tu contrase\xF1a",
        warningScreen: {
          title: "Advertencia",
          warning: "Tu cartera actual se eliminar\xE1 si creas una nueva. Haz una copia de seguridad de la cartera en tu dispositivo antes de crear una nueva",
        ...
        createScreen: {
          instruction: "Elige una contrase\xF1a para tu cartera. Podr\xE1s acceder y exportar esta cartera con la misma contrase\xF1a",
          importWallet: "Importar cartera",
          createNewWallet: "Crear nueva cartera",
          connecting: "Conectando"
        },
        exportScreen: {
          description1: "Esto descargar\xE1 un archivo JSON que contiene la informaci\xF3n de la cartera en tu dispositivo cifrado con la contrase\xF1a",
          description2: "Puedes usar este archivo JSON para importar la cuenta en MetaMask usando la misma contrase\xF1a",
          walletAddress: "Direcci\xF3n de la cartera",
          download: "Descargar",
          title: "Respaldar cartera"
        },
        importScreen: {
          title: "Importar cartera",
          description1: "La aplicaci\xF3n puede autorizar cualquier transacci\xF3n en nombre de la cartera sin ninguna aprobaci\xF3n",
          description2: "Recomendamos conectar solo con aplicaciones de confianza",
          import: "Importar",
          uploadJSON: "Por favor sube un archivo JSON",
          uploadedSuccessfully: "Subido con \xE9xito"
        }
      },
      frameWallet: {
        ...
        connectionFailedScreen: {
          ...
          description: "Aseg\xFArate de que la aplicaci\xF3n de escritorio est\xE9 instalada y en funcionamiento. Puedes descargar Frame desde el enlace de abajo. Aseg\xFArate de actualizar esta p\xE1gina una vez que Frame est\xE9 funcionando.",
          downloadFrame: "Descargar Frame",
          supportLink: "\xBFSigues teniendo problemas para conectar?"
        }
      }
    }
  };
...
var PaymentsSDKContext = (0, import_react3.createContext)(defaultContextValue);
var PaymentsSDKProvider = (_ref) => {
  let {
    appName = "",
    chainName = "Polygon",
    clientId = "",
  ...
  const [chainName_, setChainName] = (0, import_react3.useState)(chainName);
  ...
  return (0, import_jsx_runtime.jsx)(PaymentsSDKContext.Provider, {
    value: contextValue,
    children
  });
};
var usePaymentsSDKContext = () => {
  return (0, import_react3.useContext)(PaymentsSDKContext);
};
css`
  opacity: 0;
`;
...
var SpinnerWrapper = () => {
  return (0, import_jsx_runtime.jsx)("div", {
    ...
    children: (0, import_jsx_runtime.jsx)(Spinner2, {
...
function CheckoutWithCard(props) {
  ...
  const [isCardDetailIframeLoading, setIsCardDetailIframeLoading] = (0, import_react3.useState)(true);
  const onCardDetailLoad = (0, import_react3.useCallback)(() => {
    setIsCardDetailIframeLoading(false);
  }, []);
  const CheckoutWithCardIframeContainerRef = (0, import_react3.useRef)(null);
  ...
  return (0, import_jsx_runtime.jsx)("div", {
    ...
    children: isCardDetailIframeLoading && (0, import_jsx_runtime.jsx)(SpinnerWrapper, {})
  });
}
function openCenteredPopup2(_ref) {
  let {
    url,
    target,
    win,
...
var Button2 = (_ref) => {
  ...
  return (0, import_jsx_runtime.jsx)("button", {
    ...
    children: isLoading ? (0, import_jsx_runtime.jsxs)("div", {
      className: css`
            display: flex;
...
var VerifyOwnershipWithPaper = (_ref) => {
  ...
  const onClick = () => {
    const loginWindow = openCenteredPopup2({
      url: url.href,
      target: "_blank",
      win: window,
      w: 400,
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: children && isChildrenFunction ? children({
      ...
      "data-thirdweb-sdk-version": `${packageJson.name}@${packageJson.version}`,
      children
    }) : (0, import_jsx_runtime.jsx)(Button2, {
      onClick,
      className,
      "data-thirdweb-sdk-version": `${packageJson.name}@${packageJson.version}`,
...
var fetchCustomContractArgsFromProps = (props) => {
  const propsToReturn = {};
...
var PaperCheckoutDisplay = function(PaperCheckoutDisplay2) {
  PaperCheckoutDisplay2["POPUP"] = "POPUP";
  PaperCheckoutDisplay2["NEW_TAB"] = "NEW_TAB";
  PaperCheckoutDisplay2["MODAL"] = "MODAL";
  PaperCheckoutDisplay2["DRAWER"] = "DRAWER";
  PaperCheckoutDisplay2["EMBED"] = "EMBED";
  return PaperCheckoutDisplay2;
}({});
var PaperCheckout = (_ref) => {
  let {
    checkoutId,
  ...
  if (mintMethod) {
    checkoutUrl.searchParams.append("mintMethod", import_buffer.Buffer.from(mintMethodStringified, "utf-8").toString("base64"));
  }
  if (eligibilityMethod) {
    checkoutUrl.searchParams.append("eligibilityMethod", import_buffer.Buffer.from(eligibilityMethodStringified, "utf-8").toString("base64"));
  }
  if (contractType2) {
    checkoutUrl.searchParams.append("contractType", contractType2);
  }
  if (contractArgs) {
    checkoutUrl.searchParams.append(
      "contractArgs",
      import_buffer.Buffer.from(contractArgsStringified, "utf-8").toString("base64")
    );
  }
  if (appName) {
  ...
  const clickableElement = children || (0, import_jsx_runtime.jsx)("button", {
    style: {
  ...
  switch (display) {
    ...
    case PaperCheckoutDisplay.MODAL: {
      ...
      return (0, import_jsx_runtime.jsx)(PaperCheckoutModal, {
        clickableElement,
    ...
    case PaperCheckoutDisplay.DRAWER: {
      ...
      return (0, import_jsx_runtime.jsx)(PaperCheckoutDrawer, {
        clickableElement,
        checkoutUrl: checkoutUrl.href,
        width: options.width,
        isOpen,
    ...
    children: [(0, import_jsx_runtime.jsx)("a", {
      ...
      children: (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [(0, import_jsx_runtime.jsx)("button", {
          ...
          children: "\xD7"
        }), isOpen && (0, import_jsx_runtime.jsx)("iframe", {
          src: checkoutUrl,
          width: "100%",
          height: "100%"
        })]
...
var PaperCheckoutModal = (_ref3) => {
  ...
  const [innerHeight, setInnerHeight] = (0, import_react3.useState)(height);
  (0, import_react3.useEffect)(() => setInnerHeight(window.innerHeight), []);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [(0, import_jsx_runtime.jsx)("a", {
      onClick: onOpen,
      children: clickableElement
...
export {
  ...
  ListingType,
  LocalWallet,
  VerifyOwnershipWithPaper as LoginWithPaper,
  MagicLink,
  MarketplaceContractDeploy,
  MarketplaceContractInput,
  MarketplaceContractOutput,
  ...
  useEmbeddedWalletSendVerificationEmail as useInAppWalletSendVerificationEmail,
