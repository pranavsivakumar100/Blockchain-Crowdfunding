...
class ImTokenWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  get walletName() {
    return "imToken";
  }
  constructor(options) {
  ...
  async getConnector() {
    if (!this.connector) {
      if (this.isInjected) {
        ...
        const {
          ImTokenConnector
        } = await Promise.resolve().then(function () { return require('../../../connectors/imtoken/dist/thirdweb-dev-wallets-evm-connectors-imtoken.cjs.prod.js'); });
        ...
        this.connector = new connector.WagmiAdapter(imtokenConnector);
      } else {
        const {
...
defineProperty._defineProperty(ImTokenWallet, "meta", {
  name: "imToken",
...
defineProperty._defineProperty(ImTokenWallet, "id", walletIds.walletIds.imtoken);
