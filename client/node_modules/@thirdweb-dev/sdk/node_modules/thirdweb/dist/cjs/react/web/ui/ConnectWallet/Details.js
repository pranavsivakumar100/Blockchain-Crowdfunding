    ...
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.xxl, height: index_js_1.iconSize.xxl, style: {
                        ...
                        gap: index_js_1.spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, src: dataUris_js_1.genericTokenIcon, client: client }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "View Funds" })] }), (0, jsx_runtime_1.jsx)(SwitchMetamaskAccount, { closeModal: () => setIsOpen(false) }), (props.detailsModal?.showTestnetFaucet ?? false) &&
...
function SwitchMetamaskAccount(props) {
    ...
    const connectLocale = (0, useWalletConnectionCtx_js_1.useConnectUI)().connectLocale;
    ...
    return ((0, jsx_runtime_1.jsxs)(MenuButton, { type: "button", onClick: async () => {
            await injectedMetamaskProvider.request({
                method: "wallet_requestPermissions",
                params: [{ eth_accounts: {} }],
            });
            props.closeModal();
        }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.ShuffleIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: connectLocale.switchAccount })] }));
}
