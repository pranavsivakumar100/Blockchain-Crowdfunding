...
const ThirdwebLocaleContext = /* @__PURE__ */(() => /*#__PURE__*/React.createContext(enDefault()))();
function useTWLocale() {
  return React.useContext(ThirdwebLocaleContext);
}
...
const useSetWalletModalConfig = () => {
  const context = React.useContext(SetModalConfigCtx);
  const enforceCompact = !canFitWideModal();
  const locale = useTWLocale();
  if (context === undefined) {
...
const ScreenSetupContext = /* @__PURE__ */React.createContext(undefined);
...
const TextDivider = props => {
  return /*#__PURE__*/jsxRuntime.jsx(TextDividerEl, {
    style: {
...
exports.ScreenSetupContext = ScreenSetupContext;
...
exports.ThirdwebLocaleContext = ThirdwebLocaleContext;
...
exports.immutableOverride = immutableOverride;
...
exports.useSetWalletModalConfig = useSetWalletModalConfig;
exports.useSetupScreen = useSetupScreen;
exports.useTWLocale = useTWLocale;
