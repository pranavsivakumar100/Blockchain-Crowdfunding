...
require('./QueryParams-9f8e0457.cjs.prod.js');
require('./signature-d916937d.cjs.prod.js');
require('./normalizePriceValue-45f2b228.cjs.prod.js');
...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new contractAppuri.ContractMetadata(this.contractWrapper, index.TokenErc1155ContractSchema, this.storage);
    this.app = new contractAppuri.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractRoles.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new erc1155.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
   ...
   * ```
   */
  mintTo = /* @__PURE__ */transactions.buildTransactionFunction(async (to, metadataWithSupply) => {
   ...
   * @param additionalSupply - the additional amount to mint
   */
  mintAdditionalSupplyTo = /* @__PURE__ */transactions.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
   ...
   * ```
   */
  mintBatchTo = /* @__PURE__ */transactions.buildTransactionFunction(async (to, metadataWithSupply) => {
