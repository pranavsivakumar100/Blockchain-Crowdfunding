...
const CommonWrappableSchema = /* @__PURE__ */(() => zod.z.object({
  contractAddress: index.AddressOrEnsSchema
}))();
...
const ERC20RewardSchema = /* @__PURE__ */(() => ERC20WrappableSchema.omit({
  ...
  quantityPerReward: index.AmountSchema
}))();
...
const ERC1155RewardSchema = /* @__PURE__ */(() => ERC1155WrappableSchema.omit({
  ...
  quantityPerReward: index.BigNumberishSchema
}))();
...
const ERC20RewardContentsSchema = /* @__PURE__ */(() => ERC20RewardSchema.extend({
  totalRewards: index.BigNumberishSchema.default("1")
}))();
...
const PackMetadataInputSchema = /* @__PURE__ */(() => PackRewardsOutputSchema.extend({
  packMetadata: setErc20Allowance.NFTInputOrUriSchema,
  rewardsPerPack: index.BigNumberishSchema.default("1"),
  openStartTime: assertEnabled.RawDateSchema.default(new Date())
}))();
