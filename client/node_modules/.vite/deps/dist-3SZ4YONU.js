import {
  require_immutable,
  require_js
} from "./chunk-EKMJRZEP.js";
import {
  require_semver
} from "./chunk-TA4DZWV7.js";
import "./chunk-JMSNTHOW.js";
import {
  require_sha
} from "./chunk-TPZ4ZNQE.js";
import {
  require_events
} from "./chunk-774J2MD3.js";
import {
  require_eventemitter3
} from "./chunk-RDJCVU2P.js";
import {
  require_bn
...
function O(n2, u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  var a3, h3, p3, v3, w3, _3, g3, m3, x3, C3, M2, P3, $2, I2, H2, L2 = u3.type;
  ...
  n:
    if ("function" == typeof L2)
      try {
        if (m3 = u3.props, x3 = (a3 = L2.contextType) && i3[a3.__c], C3 = a3 ? x3 ? x3.props.value : a3.__ : i3, t3.__c ? g3 = (h3 = u3.__c = t3.__c).__ = h3.__E : ("prototype" in L2 && L2.prototype.render ? u3.__c = h3 = new L2(m3, C3) : (u3.__c = h3 = new b(m3, C3), h3.constructor = L2, h3.render = q), x3 && x3.sub(h3), h3.props = m3, h3.state || (h3.state = {}), h3.context = C3, h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), null == h3.__s && (h3.__s = h3.state), null != L2.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, L2.getDerivedStateFromProps(m3, h3.__s))), v3 = h3.props, w3 = h3.state, h3.__v = u3, p3)
          null == L2.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
        else {
          if (null == L2.getDerivedStateFromProps && m3 !== v3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m3, C3), !h3.__e && (null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m3, h3.__s, C3) || u3.__v === t3.__v)) {
          ...
          null != h3.componentWillUpdate && h3.componentWillUpdate(m3, h3.__s, C3), null != h3.componentDidUpdate && h3.__h.push(function() {
            h3.componentDidUpdate(v3, w3, _3);
          });
        }
        if (h3.context = C3, h3.props = m3, h3.__P = n2, h3.__e = false, P3 = l.__r, $2 = 0, "prototype" in L2 && L2.prototype.render) {
        ...
        h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), p3 || null == h3.getSnapshotBeforeUpdate || (_3 = h3.getSnapshotBeforeUpdate(v3, w3)), S(n2, y(H2 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? H2 : [H2], u3, t3, i3, o3, r4, f3, e3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && f3.push(h3), g3 && (h3.__E = h3.__ = null);
      } catch (n3) {
...
function z(l3, u3, t3, i3, o3, r4, f3, e3, c3) {
  var s3, a3, p3, v3, d3, _3, g3, m3 = t3.props, k3 = u3.props, b3 = u3.type;
  if ("svg" === b3 ? o3 = "http://www.w3.org/2000/svg" : "math" === b3 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != r4) {
    for (s3 = 0; s3 < r4.length; s3++)
      if ((d3 = r4[s3]) && "setAttribute" in d3 == !!b3 && (b3 ? d3.localName === b3 : 3 === d3.nodeType)) {
        l3 = d3, r4[s3] = null;
        break;
      }
  }
  if (null == l3) {
    ...
    l3 = document.createElementNS(o3, b3, k3.is && k3), r4 = null, e3 = false;
  }
  if (null === b3)
    m3 === k3 || e3 && l3.data === k3 || (l3.data = k3);
  else {
    if (r4 = r4 && n.call(l3.childNodes), m3 = t3.props || h, !e3 && null != r4)
    ...
    for (s3 in k3)
      d3 = k3[s3], "children" == s3 ? v3 = d3 : "dangerouslySetInnerHTML" == s3 ? a3 = d3 : "value" == s3 ? _3 = d3 : "checked" == s3 ? g3 = d3 : "key" === s3 || e3 && "function" != typeof d3 || m3[s3] === d3 || A(l3, s3, d3, m3[s3], o3);
    if (a3)
      e3 || p3 && (a3.__html === p3.__html || a3.__html === l3.innerHTML) || (l3.innerHTML = a3.__html), u3.__k = [];
    else if (p3 && (l3.innerHTML = ""), S(l3, y(v3) ? v3 : [v3], u3, t3, i3, "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o3, r4, f3, r4 ? r4[0] : t3.__k && x(t3, 0), e3, c3), null != r4)
      for (s3 = r4.length; s3--; )
        null != r4[s3] && w(r4[s3]);
    e3 || (s3 = "value", void 0 !== _3 && (_3 !== l3[s3] || "progress" === b3 && !_3 || "option" === b3 && _3 !== m3[s3]) && A(l3, s3, _3, m3[s3], o3), s3 = "checked", void 0 !== g3 && g3 !== l3[s3] && A(l3, s3, g3, m3[s3], o3));
  }
  return l3;
}
function N(n2, u3, t3) {
...
var require_WalletLinkRelay = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/relay/walletlink/WalletLinkRelay.js"(exports) {
    ...
    var WalletLinkRelay = class extends RelayAbstract_1.RelayAbstract {
      constructor(options) {
        var _a;
        super();
...
var require_browser = __commonJS({
  "node_modules/debug/src/browser.js"(exports, module) {
    ...
    function load() {
      ...
      if (!r4 && typeof import_process.default !== "undefined" && "env" in import_process.default) {
        r4 = import_process.default.env.DEBUG;
      }
      return r4;
    }
...
//# sourceMappingURL=dist-3SZ4YONU.js.map
