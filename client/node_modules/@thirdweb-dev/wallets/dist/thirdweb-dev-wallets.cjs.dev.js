...
var wc = require('./wc-6f95118d.cjs.dev.js');
var jsonrpcUtils = require('@walletconnect/jsonrpc-utils');
var evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase = require('./base-9ad330f5.cjs.dev.js');
var walletIds = require('./walletIds-a0be5020.cjs.dev.js');
var WagmiConnector = require('./WagmiConnector-6ff7d562.cjs.dev.js');
var errors = require('./errors-a8e8ea7b.cjs.dev.js');
var normalizeChainId = require('./normalizeChainId-5da85f42.cjs.dev.js');
var connector = require('./connector-a63dd9e7.cjs.dev.js');
var constants = require('./constants-b7a310b2.cjs.dev.js');
...
var supportedSmsCountries = require('./supported-sms-countries-0545c8a6.cjs.dev.js');
...
var getInjectedXDEFIProvider = require('./getInjectedXDEFIProvider-c2cf0aa1.cjs.dev.js');
var evm_wallets_okx_dist_thirdwebDevWalletsEvmWalletsOkx = require('../evm/wallets/okx/dist/thirdweb-dev-wallets-evm-wallets-okx.cjs.dev.js');
var getInjectedOKXProvider = require('./getInjectedOKXProvider-061eeec5.cjs.dev.js');
var evm_wallets_coreWallet_dist_thirdwebDevWalletsEvmWalletsCoreWallet = require('../evm/wallets/core-wallet/dist/thirdweb-dev-wallets-evm-wallets-core-wallet.cjs.dev.js');
var getInjectedCoreWalletProvider = require('./getInjectedCoreWalletProvider-40994347.cjs.dev.js');
var evm_wallets_onekey_dist_thirdwebDevWalletsEvmWalletsOnekey = require('../evm/wallets/onekey/dist/thirdweb-dev-wallets-evm-wallets-onekey.cjs.dev.js');
var getInjectedOneKeyProvider = require('./getInjectedOneKeyProvider-0a528a5e.cjs.dev.js');
var evm_wallets_cryptoDefiWallet_dist_thirdwebDevWalletsEvmWalletsCryptoDefiWallet = require('../evm/wallets/crypto-defi-wallet/dist/thirdweb-dev-wallets-evm-wallets-crypto-defi-wallet.cjs.dev.js');
var getInjectedCryptoDefiWalletProvider = require('./getInjectedCryptoDefiWalletProvider-0c32c7a6.cjs.dev.js');
var evm_wallets_rabby_dist_thirdwebDevWalletsEvmWalletsRabby = require('../evm/wallets/rabby/dist/thirdweb-dev-wallets-evm-wallets-rabby.cjs.dev.js');
var getInjectedRabbyProvider = require('./getInjectedRabbyProvider-6848be5c.cjs.dev.js');
var evm_wallets_coin98_dist_thirdwebDevWalletsEvmWalletsCoin98 = require('../evm/wallets/coin98/dist/thirdweb-dev-wallets-evm-wallets-coin98.cjs.dev.js');
var getInjectedCoin98Provider = require('./getInjectedCoin98Provider-8ce651ee.cjs.dev.js');
var getInjectedMagicEdenProvider = require('./getInjectedMagicEdenProvider-528a94a3.cjs.dev.js');
var getInjectedMetamaskProvider = require('./getInjectedMetamaskProvider-ac276221.cjs.dev.js');
var getInjectedPhantomProvider = require('./getInjectedPhantomProvider-231d1eba.cjs.dev.js');
var getInjectedRainbowProvider = require('./getInjectedRainbowProvider-c2c5c73f.cjs.dev.js');
var getInjectedCoinbaseProvider = require('./getInjectedCoinbaseProvider-4b26612d.cjs.dev.js');
var assertWindowEthereum = require('./assertWindowEthereum-0709ee9e.cjs.dev.js');
var evm_wallets_engine_dist_thirdwebDevWalletsEvmWalletsEngine = require('./engine-4ba3f686.cjs.dev.js');
...
var evm_wallets_imtoken_dist_thirdwebDevWalletsEvmWalletsImtoken = require('../evm/wallets/imtoken/dist/thirdweb-dev-wallets-evm-wallets-imtoken.cjs.dev.js');
...
var evm_wallets_xdefi_dist_thirdwebDevWalletsEvmWalletsXdefi = require('../evm/wallets/xdefi/dist/thirdweb-dev-wallets-evm-wallets-xdefi.cjs.dev.js');
...
var evm_wallets_tokenBoundSmartWallet_dist_thirdwebDevWalletsEvmWalletsTokenBoundSmartWallet = require('../evm/wallets/token-bound-smart-wallet/dist/thirdweb-dev-wallets-evm-wallets-token-bound-smart-wallet.cjs.dev.js');
var evm_wallets_magicEden_dist_thirdwebDevWalletsEvmWalletsMagicEden = require('../evm/wallets/magic-eden/dist/thirdweb-dev-wallets-evm-wallets-magic-eden.cjs.dev.js');
var embeddedWallet = require('./embedded-wallet-f887e0c5.cjs.dev.js');
require('@thirdweb-dev/chains');
require('../evm/wallets/abstract/dist/thirdweb-dev-wallets-evm-wallets-abstract.cjs.dev.js');
require('./defineProperty-9051a5d3.cjs.dev.js');
require('@thirdweb-dev/sdk');
require('./headers-ca627549.cjs.dev.js');
...
class WalletConnectV2Handler extends WalletConnectHandler {
  ...
  async init() {
    this._wcWallet = await web3wallet.Web3Wallet.init({
      core: this._core,
...
exports.checkContractWalletSignature = constants.checkContractWalletSignature;
