import { a$ as getChainProvider, aJ as fetchPublishedContractFromPolygon, aI as THIRDWEB_DEPLOYER$1, aK as fetchAndCacheDeployMetadata, ax as getCreate2FactoryAddress, aG as encodeConstructorParamsForImplementation, aF as computeDeploymentInfo, av as isContractDeployed, a6 as resolveImplementation, K as fetchContractMetadataFromAddress, ao as fetchSourceFilesFromMetadata, a1 as extractConstructorParamsFromAbi, a4 as resolveContractUriFromAddress, aR as getContractPublisherAddress, aa as fetchExtendedReleaseMetadata, cr as RPCConnectionHandler, aM as resolveAddress, aN as signTypedDataInternal, aT as ChainId, cs as ContractWrapper, aW as NATIVE_TOKEN_ADDRESS, ct as extractFeatures, ab as detectFeatures, aS as getMultichainRegistryAddress, bk as AbiSchema, ay as computeCreate2FactoryTransaction, aP as CONTRACT_ADDRESSES, cu as AddressZero, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, aD as computeForwarderAddress, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bH as CommonPlatformFeeSchema, bG as CommonPrimarySaleSchema, bI as CommonTrustedForwarderSchema, bD as CommonContractSchema, bF as CommonRoyaltySchema, bJ as CommonSymbolSchema, aB as computeDeploymentAddress, aA as getInitBytecodeWithSalt, aU as setSupportedChains, j as getContractTypeForRemoteName, b4 as getSignerAndProvider, ak as getCompositeABI, b2 as isChainConfig, aQ as getContractAddressByChainId, cv as getProcessEnv, bT as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, a_ as EventType } from './index-454de556.browser.esm.js';
import { isBrowser, ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-325971b7.browser.esm.js';
...
import { g as getDefaultGasOverrides, f as buildTransactionFunction, T as Transaction, h as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-eae32dda.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-f87e5d3a.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-8ce073fb.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-672a3924.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-96faff43.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
