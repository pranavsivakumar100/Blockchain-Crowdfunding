...
const coinbaseSDKWallet_js_1 = require("../coinbase/coinbaseSDKWallet.js");
...
const index_js_4 = require("../wallet-connect/index.js");
/**
...
async function sendCalls(options) {
    ...
    if ((0, coinbaseSDKWallet_js_1.isCoinbaseSDKWallet)(wallet)) {
        const { coinbaseSDKWalletSendCalls } = await Promise.resolve().then(() => require("../coinbase/coinbaseSDKWallet.js"));
        return coinbaseSDKWalletSendCalls({
            wallet,
            params: injectedWalletCallParams,
        });
    }
    if ((0, index_js_4.isWalletConnect)(wallet)) {
