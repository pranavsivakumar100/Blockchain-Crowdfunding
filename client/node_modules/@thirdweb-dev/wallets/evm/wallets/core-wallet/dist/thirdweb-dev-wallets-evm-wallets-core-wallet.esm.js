...
import { g as getInjectedCoreWalletProvider } from '../../../../dist/getInjectedCoreWalletProvider-ebe9ab09.esm.js';
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        const {
          CoreWalletConnector
        } = await import('../../../connectors/core-wallet/dist/thirdweb-dev-wallets-evm-connectors-core-wallet.esm.js');
