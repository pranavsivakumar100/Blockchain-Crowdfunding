...
class ContractPlatformFee {
  featureName = index.FEATURE_PLATFORM_FEE.name;
  ...
  async get() {
    ...
    return index.CommonPlatformFeeSchema.parseAsync({
   ...
   * @twfeature PlatformFee
   */
  set = /* @__PURE__ */transactions.buildTransactionFunction(async platformFeeInfo => {
    const parsed = await index.CommonPlatformFeeSchema.parseAsync(platformFeeInfo);
