...
import { g as getInjectedRabbyProvider } from '../../../../dist/getInjectedRabbyProvider-71aa751e.esm.js';
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        const {
          RabbyConnector
        } = await import('../../../connectors/rabby/dist/thirdweb-dev-wallets-evm-connectors-rabby.esm.js');
