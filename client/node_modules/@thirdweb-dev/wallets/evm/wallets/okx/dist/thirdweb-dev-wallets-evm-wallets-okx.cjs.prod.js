 ...
 * @wallet
 */
class OKXWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  /**
   * @internal
   */
  get walletName() {
  ...
  constructor(options) {
    ...
    this.isInjected = !!getInjectedOKXProvider.getInjectedOKXProvider();
  }
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        const {
          OKXConnector
        } = await Promise.resolve().then(function () { return require('../../../connectors/okx/dist/thirdweb-dev-wallets-evm-connectors-okx.cjs.prod.js'); });
        ...
        this.connector = new connector.WagmiAdapter(this.OKXConnector);
      } else {
        const {
 ...
 * @internal
 */
defineProperty._defineProperty(OKXWallet, "id", walletIds.walletIds.okx);
