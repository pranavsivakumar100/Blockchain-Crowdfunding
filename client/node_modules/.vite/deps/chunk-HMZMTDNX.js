...
var BaseError2 = class extends Error {
  constructor(shortMessage, args = {}) {
    ...
    const docsPath3 = args.cause instanceof BaseError2 ? args.cause.docsPath || args.docsPath : args.docsPath;
    const message = [
      shortMessage || "An error occurred.",
      "",
      ...args.metaMessages ? [...args.metaMessages, ""] : [],
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-HFYNU3YB.js");
...
//# sourceMappingURL=chunk-HMZMTDNX.js.map
