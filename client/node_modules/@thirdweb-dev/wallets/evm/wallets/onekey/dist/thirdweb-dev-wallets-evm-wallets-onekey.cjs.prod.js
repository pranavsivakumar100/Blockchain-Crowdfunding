 ...
 * @wallet
 */
class OneKeyWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  /**
   * @internal
   */
  get walletName() {
  ...
  constructor(options) {
    ...
    this.isInjected = !!getInjectedOneKeyProvider.getInjectedOneKeyProvider();
  }
  async getConnector() {
    if (!this.connector) {
      ...
      if (this.isInjected) {
        ...
        const {
          OneKeyConnector
        } = await Promise.resolve().then(function () { return require('../../../connectors/onekey/dist/thirdweb-dev-wallets-evm-connectors-onekey.cjs.prod.js'); });
        ...
        this.connector = new connector.WagmiAdapter(this.OneKeyConnector);
      } else {
        const {
 ...
 * @internal
 */
defineProperty._defineProperty(OneKeyWallet, "id", walletIds.walletIds.oneKey);
