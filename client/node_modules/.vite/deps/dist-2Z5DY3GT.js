...
var c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e, o) {
  ...
  const { walletConnectUri: o } = p.state, { mobile: r, name: a2 } = e, t = r?.native, l = r?.universal;
  c.setRecentWallet(e);
  function i(s) {
    let $ = "";
  ...
  const { desktop: e, mobile: o } = a.getWalletRouterData(), r = Boolean(e?.native), a2 = Boolean(e?.universal), t = Boolean(o?.native) || Boolean(o?.universal);
...
var G = { manualWallets() {
  var e, o;
  const { mobileWallets: r, desktopWallets: a2 } = y.state, t = (e = G.recentWallet()) == null ? void 0 : e.id, l = a.isMobile() ? r : a2, i = l?.filter((s) => t !== s.id);
  return (o = a.isMobile() ? i?.map(({ id: s, name: $, links: f }) => ({ id: s, name: $, mobile: f, links: f })) : i?.map(({ id: s, name: $, links: f }) => ({ id: s, name: $, desktop: f, links: f }))) != null ? o : [];
}, recentWallet() {
...
var me = class extends LitElement {
  ...
  onFormatAndRedirect(e) {
    const { desktop: o, name: r } = a.getWalletRouterData(), a2 = o?.native;
    if (a2) {
...
var he = class extends LitElement {
  ...
  onFormatAndRedirect(e, o = false) {
    const { mobile: r, name: a2 } = a.getWalletRouterData(), t = r?.native, l = r?.universal;
    if (t && !o) {
  ...
  render() {
    const { name: e, id: o, image_id: r, app: a2, mobile: t } = a.getWalletRouterData(), { isWeb: l } = c.getCachedRouterWalletPlatforms(), i = a2?.ios, s = t?.universal;
...
var we = class extends LitElement {
  ...
  onFormatAndRedirect(e) {
    const { desktop: o, name: r } = a.getWalletRouterData(), a2 = o?.universal;
    if (a2) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=dist-2Z5DY3GT.js.map
