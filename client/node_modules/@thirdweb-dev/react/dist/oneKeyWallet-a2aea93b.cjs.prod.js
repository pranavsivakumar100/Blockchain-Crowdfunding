...
var formElements = require('./formElements-91b0967f.cjs.prod.js');
...
var Tooltip = require('./Tooltip-f7119a2a.cjs.prod.js');
var coinbaseWallet = require('./safeChainSlug-46fceacf.cjs.prod.js');
...
const EmbeddedWalletFormUI = props => {
  ...
  const [inputMode, setInputMode] = React.useState(selectDefaultInputMode());
  ...
  const switchInputModeText = inputMode === "email" ? locale.signInWithPhone : locale.signInWithEmail;
  const switchInputMode = React.useCallback(() => {
    setInputMode(prev => prev === "email" ? "phone" : "email");
  }, []);
  const allowSwitchInputMode = isEmailEnabled && isPhoneEnabled;
  const socialLogins = props.authOptions.filter(x => x !== "email" && x !== "phone");
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [hasSocialLogins && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: socialLogins.map(loginMethod => {
        const imgIconSize = showOnlyIcons ? formElements.iconSize.lg : formElements.iconSize.md;
        return /*#__PURE__*/jsxRuntime.jsxs(SocialButton, {
    ...
    }), props.modalSize === "wide" && hasSocialLogins && isEmailEnabled && /*#__PURE__*/jsxRuntime.jsx(formElements.TextDivider, {
      text: twLocale.connectWallet.or
    }), inputMode !== "none" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      children: [inputMode === "email" ? /*#__PURE__*/jsxRuntime.jsx(Tooltip.InputSelectionUI, {
        type: type,
        onSelect: value => {
          props.onSelect({
            email: value
        ...
        name: "email",
        errorMessage: input => {
          const isValidEmail = Tooltip.validateEmail(input.toLowerCase());
          if (!isValidEmail) {
...
const EmbeddedWalletFormUIScreen = props => {
  const locale = formElements.useTWLocale().wallets.embeddedWallet.otpLoginScreen;
...
const EmbeddedWalletSocialLogin = props => {
  const ewLocale = formElements.useTWLocale().wallets.embeddedWallet;
  ...
  const onConnectCalled = React.useRef(false);
  React.useEffect(() => {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
        ...
        children: [connectionStatus === "connecting" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          ...
          }), authError && /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            color: "danger",
            children: authError
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "lg"
...
const FadeIn = /* @__PURE__ */formElements.StyledDiv({
...
const OTPInputBox = /* @__PURE__ */styled__default["default"](formElements.Input)(() => {
  const theme = formElements.useCustomTheme();
  return {
    appearance: "none",
...
function CreatePassword(props) {
  const locale = formElements.useTWLocale().wallets.embeddedWallet.createPassword;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: [props.modalSize === "compact" && /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "xxl"
      }), /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        flex: "row",
        center: "x",
        color: "accentText",
        children: /*#__PURE__*/jsxRuntime.jsx(BounceContainer, {
          children: /*#__PURE__*/jsxRuntime.jsx(reactIcons.LockOpen1Icon, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Input, {
            ...
            children: showPassword ? /*#__PURE__*/jsxRuntime.jsx(reactIcons.EyeClosedIcon, {}) : /*#__PURE__*/jsxRuntime.jsx(reactIcons.EyeOpenIcon, {})
          })]
        }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "lg"
        }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          ...
          type: "submit",
          children: loading ? /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
            size: "md",
            color: "accentButtonText"
          }) : locale.submitButton
        }), error && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "lg"
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            size: "sm",
...
const CheckboxButton = /* @__PURE__ */styled__default["default"](formElements.IconButton)(() => {
  const theme = formElements.useCustomTheme();
  return {
...
const bounceAnimation = react.keyframes`
from {
...
`;
const BounceContainer = /* @__PURE__ */formElements.StyledDiv({
  animation: `${bounceAnimation} 1s ease-in-out infinite alternate`
});

function EnterPasswordOrRecovery(props) {
  const locale = formElements.useTWLocale().wallets.embeddedWallet.enterPassword;
  const [loading, setLoading] = React.useState(false);
  const [showPassword, setShowPassword] = React.useState(false);
  const [password, setPassword] = React.useState("");
  const [error, setError] = React.useState(false);
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("form", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        ...
        }), error && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "sm"
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            color: "danger",
          ...
          type: "submit",
          disabled: loading,
          children: loading ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
            children: /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
              size: "md",
              color: "accentButtonText"
            })
...
const EmbeddedWalletOTPLoginUI = props => {
  ...
  const locale = formElements.useTWLocale().wallets.embeddedWallet;
  ...
  const [accountStatus, setAccountStatus] = React.useState("sending");
  const [screen, setScreen] = React.useState("base");
  const sendEmailOrSms = React.useCallback(async () => {
    setOtpInput("");
  ...
  const verify = async otp => {
    ...
    try {
      ...
      setConnectionStatus("connecting");
      const needsRecoveryCode = accountStatus.recoveryShareManagement === "USER_MANAGED" && (accountStatus.isNewUser || accountStatus.isNewDevice);
  ...
  if (screen === "create-password") {
    return /*#__PURE__*/jsxRuntime.jsx(CreatePassword, {
      modalSize: props.modalSize,
      goBack: props.goBack,
  ...
  if (screen === "enter-password-or-recovery-code") {
    return /*#__PURE__*/jsxRuntime.jsx(EnterPasswordOrRecovery, {
      modalSize: props.modalSize,
      goBack: props.goBack,
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs("form", {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            ...
            children: [!isWideModal && /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              ...
              children: locale.otpLoginScreen.enterCodeSendTo
            }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              y: "sm"
            }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
              color: "primaryText",
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              ...
              color: "danger",
              center: true,
              children: locale.otpLoginScreen.invalidCode
            })]
          }), verifyStatus === "payment_required" && /*#__PURE__*/jsxRuntime.jsxs(FadeIn, {
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              y: "md"
            }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
              size: "sm",
            ...
            children: verifyStatus === "verifying" ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
              ...
              children: /*#__PURE__*/jsxRuntime.jsx(formElements.Button, {
                ...
                children: locale.otpLoginScreen.verify
              })
            }, "btn-container")
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "xl"
            ...
            children: [accountStatus === "error" && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
              children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
                size: "sm",
                center: true,
                color: "danger",
                children: locale.otpLoginScreen.failedToSendCode
              })
            }), accountStatus === "sending" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
              flex: "row",
              center: "both",
              gap: "xs",
              style: {
              ...
              children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
                size: "sm",
                children: locale.otpLoginScreen.sendingCode
              }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
                size: "xs",
                color: "secondaryText"
              })]
            }), typeof accountStatus === "object" && /*#__PURE__*/jsxRuntime.jsx(LinkButton, {
              onClick: sendEmailOrSms,
              type: "button",
              children: locale.otpLoginScreen.resendCode
            })]
          })]
        })
      })]
...
const DEFAULT_AUTH_OPTIONS = ["email", "phone", "google", "apple", "facebook"];
...
const embeddedWallet = options => {
  ...
  const isSocialsEnabled = authOptions.some(x => x !== "email" && x !== "phone");
  function getName() {
    // only email
...
const EmbeddedWalletConnectUI = props => {
  ...
  if (loginType) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(EmbeddedWalletSocialLogin, {
      ...props,
      goBack: handleBack,
      strategy: loginType
    });
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs("form", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalDescription, {
          ...
          children: reactCore.shortenAddress(savedAddress)
...
const SavedWalletAddress = /* @__PURE__ */formElements.StyledP(() => {
  const theme = formElements.useCustomTheme();
  return {
    fontSize: formElements.fontSize.md,
...
const ChainIcon = props => {
  ...
  const getSrc = () => {
    ...
    try {
      return storage ? storage.resolveScheme(url) : url.replace("ipfs://", "https://ipfs.io/ipfs/");
    } catch {
      return fallbackChainIcon;
    }
  };
...
const ActiveDot$1 = /* @__PURE__ */formElements.StyledDiv({
  width: "28%",
  height: "28%",
  borderRadius: "50%",
  position: "absolute",
...
const CheckIconStyled = /* @__PURE__ */styled__default["default"](reactIcons.CheckIcon)(() => {
  const theme = formElements.useCustomTheme();
  return {
...
`;
const Overlay = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
...
const Modal = props => {
    ...
    if (!props.open) {
      if (contentRef.current) {
        const animationConfig = {
          duration: formElements.modalCloseFadeOutDuration,
          fill: "forwards",
          easing: "ease"
        };
        ...
        overlayRef.current?.animate([{
          ...
          ...animationConfig,
          duration: formElements.modalCloseFadeOutDuration + 100
        });
      } else {
        setOpen(props.open);
      }
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Dialog__namespace.Root, {
    ...
    children: [props.trigger && /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Trigger, {
      ...
      children: [!props.hide && /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Overlay, {
        asChild: true,
        children: /*#__PURE__*/jsxRuntime.jsx(Overlay, {
          ref: overlayRef
        })
      }), /*#__PURE__*/jsxRuntime.jsx(reactFocusScope.FocusScope, {
        trapped: !props.hide,
        children: /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Content, {
          asChild: true,
...
const CrossContainer = /* @__PURE__ */formElements.StyledDiv({
  position: "absolute",
...
`;
const DialogContent = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    zIndex: 10000,
    ...
    boxShadow: formElements.shadow.lg,
    lineHeight: "normal",
    ...
    [formElements.media.mobile]: {
      ...
      borderRadius: formElements.radius.xxl,
...
function useEmbeddedWallet() {
  ...
  const wallets$1 = reactCore.useWallets();
  const connect = React.useCallback(async authParams => {
    setStatus("connecting");
    const config = wallets$1.find(w => w.id === wallets.walletIds.embeddedWallet);
    ...
    try {
      ...
      if (authParams.strategy === "apple" || authParams.strategy === "facebook" || authParams.strategy === "google") {
    ...
    return wallet;
  }, [setStatus, wallets$1, create, setWallet]);
  const sendVerificationEmail = React.useCallback(async _ref => {
    let {
      email
    } = _ref;
    ...
    return wallets.EmbeddedWallet.sendVerificationEmail({
      email,
      clientId
    });
  }, [context]);
...
function useEmbeddedWalletUserEmail() {
  ...
  const emailQuery = reactQuery.useQuery([wallet?.walletId, address, "embeddedWallet-email"], () => {
    if (wallet && wallet.walletId === wallets.walletIds.embeddedWallet) {
      return wallet.getEmail() ?? "";
    }
    return "";
  }, {
    retry: false,
    enabled: wallet?.walletId === wallets.walletIds.embeddedWallet
  });
  return emailQuery;
}
 ...
 * @returns Hook's `data` property contains the `string` email if `EmbeddedWallet` is connected, otherwise `undefined`
 */
function useEmbeddedWalletUserPhoneNumber() {
  const wallet = reactCore.useWallet();
  const address = reactCore.useAddress();
  const emailQuery = reactQuery.useQuery([wallet?.walletId, address, "embeddedWallet-phone-number"], () => {
    if (wallet && wallet.walletId === wallets.walletIds.embeddedWallet) {
      return wallet.getPhoneNumber() ?? "";
    }
    return "";
  }, {
    retry: false,
...
function NetworkSelector(props) {
  const themeFromContext = formElements.useCustomTheme();
  const theme = props.theme || themeFromContext || "dark";
  const {
    onClose
  } = props;
  return /*#__PURE__*/jsxRuntime.jsx(formElements.CustomThemeProvider, {
    theme: theme,
    children: /*#__PURE__*/jsxRuntime.jsx(Modal, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(NetworkSelectorContent, {
        ...props
      })
    })
  });
...
function NetworkSelectorContent(props) {
  ...
  const locale = formElements.useTWLocale().connectWallet.networkSelector;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      p: "lg",
      children: props.onBack ? /*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
        title: locale.title,
        onBack: props.onBack
      ...
      className: "TabsRoot",
      defaultValue: "all",
      children: [props.showTabs !== false && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          px: "lg",
      ...
      }), props.showTabs === false && /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "xxs"
...
const NetworkTab = props => {
  ...
  const locale = formElements.useTWLocale().connectWallet.networkSelector.categoryLabel;
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    scrollY: true,
    animate: "fadein",
    style: {
...
const NetworkList = /* @__PURE__ */React.memo(function NetworkList(props) {
  ...
  if (isLoading) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      px: "xxs",
      children: /*#__PURE__*/jsxRuntime.jsx(NetworkListUl, {
        children: new Array(10).fill(0).map((_, i) => /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
          height: "48px"
        }, i))
      })
    });
  ...
  return /*#__PURE__*/jsxRuntime.jsx(NetworkListUl, {
    children: props.chains.map(chain => {
      ...
      return /*#__PURE__*/jsxRuntime.jsx("li", {
        children: RenderChain ? /*#__PURE__*/jsxRuntime.jsx(RenderChain, {
          switchChain: () => {
            handleSwitch(chain);
          },
          chain: chain,
          ...
          close: props.close
        }) : /*#__PURE__*/jsxRuntime.jsx(ChainButton, {
          chain: chain,
...
const ChainButton = /* @__PURE__ */React.memo(function ChainButton(props) {
  const twLocale = formElements.useTWLocale();
  const {
    confirming,
    onClick,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(NetworkButton, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(ChainIcon, {
      ...
      children: [chainName, /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        }), switchingFailed && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          animate: "fadein",
          children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            size: "xs",
            color: "danger",
...
const TabButton = /* @__PURE__ */(() => styled__default["default"](Tabs__namespace.Trigger)(() => {
  const theme = formElements.useCustomTheme();
  return {
    all: "unset",
    fontSize: formElements.fontSize.sm,
    ...
    borderRadius: formElements.radius.lg,
...
const SectionLabel = /* @__PURE__ */formElements.StyledP(() => {
  const theme = formElements.useCustomTheme();
  return {
    fontSize: formElements.fontSize.sm,
    color: theme.colors.secondaryText,
...
const NetworkListUl = /* @__PURE__ */formElements.StyledUl({
  padding: 0,
  margin: 0,
  listStyle: "none",
  display: "flex",
...
const NetworkButton = /* @__PURE__ */formElements.StyledButton(() => {
  const theme = formElements.useCustomTheme();
  return {
    all: "unset",
    display: "flex",
...
const StyledMagnifyingGlassIcon = /* @__PURE__ */styled__default["default"](reactIcons.MagnifyingGlassIcon)(() => {
  const theme = formElements.useCustomTheme();
  return {
    color: theme.colors.secondaryText,
    position: "absolute",
...
function ReceiveFunds(props) {
  ...
  const locale = formElements.useTWLocale().connectWallet.receiveFundsScreen;
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    p: "lg",
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      title: locale.title,
      ...
      y: "xl"
    }), /*#__PURE__*/jsxRuntime.jsxs(WalletAddressContainer, {
      onClick: onCopy,
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        color: "primaryText",
        size: "md",
        children: reactCore.shortenString(address || "")
...
const WalletAddressContainer = /* @__PURE__ */formElements.StyledButton(() => {
  const theme = formElements.useCustomTheme();
  return {
    all: "unset",
    width: "100%",
 ...
 * @internal
 */
function isNativeToken$1(token) {
 ...
 * @internal
 */
function useChainQuery(chainId) {
  return reactQuery.useQuery({
    ...
    queryFn: async () => {
      ...
      const chain = await chains.fetchChain(chainId);
      if (!chain) {
...
function TokenIcon(props) {
  ...
  if (isNativeToken$1(token)) {
    return /*#__PURE__*/jsxRuntime.jsx(NativeTokenIcon, {
      chainId: props.chainId,
      nativeToken: token,
      size: props.size
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Img, {
    src: token.icon,
    width: formElements.iconSize[props.size],
    height: formElements.iconSize[props.size],
    fallbackImage: Tooltip.genericTokenIcon
  });
}
 ...
 * @returns
 */
function formatTokenBalance(balanceData) {
  let showSymbol = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
function useMultiChainBalance(options) {
  const address = reactCore.useAddress();
  return reactQuery.useQuery({
    ...
    queryFn: async () => {
      ...
      if (cachedSDK) {
        ...
        sdk$1 = new sdk.ThirdwebSDK(options.chainId);
        sdkCache.set(options.chainId, sdk$1);
      }
      if (!options.tokenAddress) {
        return sdk$1.getBalance(address);
      }
      const contract = await sdk$1.getContract(options.tokenAddress);
...
function TokenSelector(props) {
  ...
  const locale = formElements.useTWLocale().connectWallet.sendFundsScreen;
  ...
  if (screen === "select-chain" && chainSelection) {
    return /*#__PURE__*/jsxRuntime.jsx(NetworkSelectorContent, {
      showTabs: false,
      ...
      renderChain: renderChainProps => {
        return /*#__PURE__*/jsxRuntime.jsx(ChainButton, {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "md"
      }), props.chainSelection && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
        children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          px: "lg",
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            size: "sm",
            ...
            y: "xxs"
          }), /*#__PURE__*/jsxRuntime.jsxs(SelectTokenBtn, {
            fullWidth: true,
            variant: "secondary",
            onClick: () => {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(ChainIcon, {
              ...
              size: formElements.iconSize.lg,
              fallbackImage: fallbackChainIcon
            }), chainQuery.data ? /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
              color: "primaryText",
              size: "sm",
              children: [" ", chainQuery.data.name]
            }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
              height: formElements.fontSize.md
            }), /*#__PURE__*/jsxRuntime.jsx(reactIcons.ChevronDownIcon, {
              width: formElements.iconSize.sm,
              height: formElements.iconSize.sm,
              style: {
                marginLeft: "auto"
        ...
        y: "md"
      }), (filteredList.length > 0 || !input) && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        flex: "column",
        gap: "xs",
        px: "lg",
        scrollY: true,
        ...
        children: [!input && /*#__PURE__*/jsxRuntime.jsx(SelectTokenButton, {
          onClick: () => {
      ...
      }), filteredList.length === 0 && tokenQuery.isLoading && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
      ...
      }), filteredList.length === 0 && !tokenQuery.isLoading && input && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
...
function SelectTokenButton(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SelectTokenBtn, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(TokenIcon, {
      token: props.token,
      chainId: props.chainId,
      size: "lg"
    }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      children: [tokenName ? /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        ...
        height: formElements.fontSize.md,
        width: "150px"
      }), tokenBalanceQuery.data ? /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
        size: "xs",
...
const SelectTokenBtn = /* @__PURE__ */styled__default["default"](formElements.Button)(() => {
  const theme = formElements.useCustomTheme();
  return {
...
function SendFunds(props) {
  ...
  let defaultToken = NATIVE_TOKEN$1;
  if (
  // if we know chainId
  chainId &&
...
function SendFundsForm(props) {
  ...
  const isValidReceiverAddress = React.useMemo(() => {
    return ethers.utils.isAddress(receiverAddress);
  }, [receiverAddress]);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Label, {
        ...
        children: [sendTokenMutation.isLoading ? locale.sending : locale.submitButton, sendTokenMutation.isLoading && /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
          size: "sm",
          color: "accentButtonText"
        })]
      })]
...
const CurrencyBadge = /* @__PURE__ */formElements.StyledDiv({
  position: "absolute",
  top: "50%",
...
const Drawer = /* @__PURE__ */React.forwardRef(function Drawer_(props, ref) {
  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: /*#__PURE__*/jsxRuntime.jsxs(DrawerContainer, {
      ref: ref,
      children: [/*#__PURE__*/jsxRuntime.jsx(CrossContainer, {
        children: /*#__PURE__*/jsxRuntime.jsx(formElements.IconButton, {
          type: "button",
          "aria-label": "Close",
          onClick: props.close,
...
const DrawerContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    zIndex: 10000,
    padding: formElements.spacing.lg,
    borderTopLeftRadius: formElements.radius.xl,
    borderTopRightRadius: formElements.radius.xl,
    background: theme.colors.modalBg,
    position: "fixed",
    bottom: 0,
    left: 0,
...
const drawerOpenAnimation = react.keyframes`
  from {
    opacity: 0;
...
`;
const DrawerOverlay = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    backgroundColor: theme.colors.modalOverlayBg,
    zIndex: 9999,
    position: "absolute",
    inset: 0,
    animation: `${formElements.fadeInAnimation} 400ms cubic-bezier(0.16, 1, 0.3, 1)`
  };
});
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
      ...
      style: {
        ...
        gridGap: formElements.spacing.sm
      },
      children: [/*#__PURE__*/jsxRuntime.jsx(CheckButton, {
        isChecked: true,
        variant: "outline",
        children: /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          gap: "xxs",
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(FloatingBadge, {
...
const CheckButton = /* @__PURE__ */styled__default["default"](formElements.Button)(props => {
  const theme = formElements.useCustomTheme();
  return {
    fontSize: formElements.fontSize.sm,
    borderColor: props.isChecked ? theme.colors.accentText : theme.colors.borderColor,
    gap: formElements.spacing.xs,
    paddingInline: formElements.spacing.xxs,
    paddingBlock: formElements.spacing.sm,
    width: "100%"
  };
});
const FloatingBadge = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    position: "absolute",
    top: 0,
    ...
    paddingBlock: "3px",
    paddingInline: formElements.spacing.xs,
    fontSize: formElements.fontSize.xs,
...
function TokenSymbol(props) {
  if (!isNativeToken$1(props.token)) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
      size: props.size,
      color: props.color || "primaryText",
      children: props.token.symbol
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx(NativeTokenSymbol, {
    chainId: props.chainId,
    size: props.size,
    color: props.color
  });
...
function NativeTokenSymbol(props) {
  ...
  if (!data) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
      width: "70px",
      height: formElements.fontSize[props.size]
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
    size: props.size,
    color: props.color || "primaryText",
    children: data.nativeCurrency.symbol
  });
}
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Input, {
          ...
          style: {
            border: "none",
            fontSize: props.value.length > 10 ? "26px" : props.value.length > 6 ? "34px" : "50px",
            boxShadow: "none",
            padding: "0",
            paddingBlock: "2px",
            fontWeight: 600,
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(TokenSymbol, {
          token: props.token,
          chainId: props.chainId,
          size: "lg",
          color: "secondaryText"
      ...
      flex: "row",
      center: "x",
      children: /*#__PURE__*/jsxRuntime.jsxs(TokenButton$1, {
        variant: "secondary",
        fullWidth: true,
        style: {
          fontSize: formElements.fontSize.sm
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(TokenIcon, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(TokenSymbol, {
              token: props.token,
              chainId: props.chainId,
              size: "sm"
            }), chainQuery.data?.name ? /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
              size: "xs",
              color: "secondaryText",
              children: chainQuery.data.name
            }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
...
const TokenButton$1 = /* @__PURE__ */styled__default["default"](formElements.Button)(() => {
  const theme = formElements.useCustomTheme();
  return {
    background: theme.colors.walletSelectorButtonHoverBg,
    border: `1px solid ${theme.colors.borderColor}`,
...
function SwapFees(props) {
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
    ...
    children: props.quote.processingFees.map((fee, i) => {
      ...
      return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
          ...
          color: "secondaryText",
          size: "sm",
          children: ["($", fee.amountUSDCents / 100, ")"]
        })]
      }, i);
    })
  });
...
const swapTransactionsStore = /* @__PURE__ */createStore([]);

/**
 * @internal
 */
const addPendingSwapTransaction = (clientId, txInfo) => {
  ...
  async function tryToGetStatus() {
    ...
    await coinbaseWallet.wait(5000);
    try {
      retryCount++;
      const res = await sdk.getBuyWithCryptoStatus({
        clientId: clientId,
...
function ConfirmationScreen(props) {
  const signer = reactCore.useSigner();
  const [swapTx, setSwapTx] = React.useState();
  const isApprovalRequired = props.buyWithCryptoQuote.approval !== undefined;
  const [step, setStep] = React.useState(isApprovalRequired ? "approval" : "swap");
  const [status, setStatus] = React.useState("idle");
  const fromChain = useChainQuery(props.fromChainId);
  const toChain = useChainQuery(props.toChainId);
  const fromTokenSymbol = isNativeToken(props.fromToken) ? fromChain.data?.nativeCurrency?.symbol : props.fromToken?.symbol;
  const toTokenSymbol = isNativeToken(props.toToken) ? toChain.data?.nativeCurrency?.symbol : props.toToken?.symbol;
  if (swapTx) {
    return /*#__PURE__*/jsxRuntime.jsx(WaitingForConfirmation, {
      onBack: () => {
        props.onBack();
      },
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      ...
      y: "lg"
    }), /*#__PURE__*/jsxRuntime.jsx(ConfirmItem, {
      label: "Receive",
      children: /*#__PURE__*/jsxRuntime.jsx(TokenInfo, {
      ...
      label: "Fees",
      children: /*#__PURE__*/jsxRuntime.jsx(SwapFees, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        color: "primaryText",
        children: reactCore.shortenString(props.accountAddress, false)
      })
    }), /*#__PURE__*/jsxRuntime.jsx(ConfirmItem, {
      label: "Time",
      children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
        color: "primaryText",
        children: ["~", formatSeconds(props.buyWithCryptoQuote.swapDetails.estimated.durationSeconds || 0)]
      })
    }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
      y: "lg"
    }), isApprovalRequired && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        gap: "sm",
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(ConnectorLine, {}), /*#__PURE__*/jsxRuntime.jsx(Step, {
          isDone: false,
          label: "Confirm",
          isActive: step === "swap"
        })]
    ...
    }), status === "error" && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        flex: "row",
        gap: "xs",
        center: "y",
      ...
      onClick: async () => {
        ...
        if (step === "approval" && props.buyWithCryptoQuote.approval) {
          try {
            setStatus("pending");
            const tx = await signer.sendTransaction(props.buyWithCryptoQuote.approval);
            await tx.wait();
        ...
        if (step === "swap") {
          setStatus("pending");
          try {
            const _swapTx = await signer.sendTransaction(props.buyWithCryptoQuote.transactionRequest);
      ...
      gap: "xs",
      children: [step === "approval" ? "Approve" : "Confirm", status === "pending" && /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
        size: "sm",
        color: "accentButtonText"
      })]
    })]
...
const ConnectorLine = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    height: "4px",
...
function Step(props) {
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(Circle, {
      children: props.isDone ? /*#__PURE__*/jsxRuntime.jsx(reactIcons.CheckIcon, {
        width: formElements.iconSize.sm,
        height: formElements.iconSize.sm
      }) : /*#__PURE__*/jsxRuntime.jsx(PulsingDot, {
...
`;
const PulsingDot = /* @__PURE__ */formElements.StyledDiv(() => {
  return {
...
const Circle = /* @__PURE__ */formElements.StyledDiv(() => {
  return {
...
function TokenInfo(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(TokenIcon, {
        token: props.token,
        chainId: props.chainId,
        size: "sm"
      })]
    }), chainQuery.data ? /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
      size: "sm",
      children: chainQuery.data.name
    }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
      width: "100px",
...
function ConfirmItem(props) {
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(formElements.Line, {})]
  });
}
function WaitingForConfirmation(props) {
  const swapStatus = reactCore.useBuyWithCryptoStatus(props.swapTx);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "xxl"
        }), isSuccess ? /*#__PURE__*/jsxRuntime.jsx(reactIcons.CheckCircledIcon, {
          width: formElements.iconSize["4xl"],
          height: formElements.iconSize["4xl"]
        }) : isFailed ? /*#__PURE__*/jsxRuntime.jsx(AccentFailIcon, {
          size: formElements.iconSize["4xl"]
        }) : /*#__PURE__*/jsxRuntime.jsxs("div", {
          style: {
            position: "relative"
          },
          ...
          color: "primaryText",
          size: "lg",
          children: isSuccess ? "Buy Success" : isFailed ? "Transaction Failed" : "Buy Pending"
        }), !isFailed && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "lg"
          }), /*#__PURE__*/jsxRuntime.jsxs("div", {
            children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
              size: "md",
              inline: true,
              children: [" ", isSuccess ? "Bought" : "Buy", " "]
            }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
              size: "md",
              color: "primaryText",
              inline: true,
              children: props.destinationAmount
            }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
              size: "md",
              inline: true,
              children: [" ", "for", " "]
        ...
        y: "xl"
      }), !isFailed && /*#__PURE__*/jsxRuntime.jsx(formElements.Button, {
        variant: "accent",
        fullWidth: true,
...
function PayWithCrypto(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(TokenButton, {
        variant: "secondary",
        onClick: props.onSelectToken,
        children: [/*#__PURE__*/jsxRuntime.jsx(TokenIcon, {
          token: props.token,
          ...
          }), chainQuery.data?.name ? /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
            size: "xs",
            children: [" ", chainQuery.data.name]
          }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
            width: "90px",
        ...
        style: {
          ...
          whiteSpace: "nowrap",
          justifyContent: "center",
          paddingRight: formElements.spacing.sm
        },
        children: [props.isLoading ? /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
          width: "120px",
          height: formElements.fontSize.md
        }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
          size: "md",
          ...
          style: {},
          children: formatNumber(Number(props.value), 4) || "--"
        }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          flex: "row",
          gap: "xxs",
          center: "y",
          color: "secondaryText",
          children: [/*#__PURE__*/jsxRuntime.jsx(WalletIcon, {
            size: formElements.fontSize.xs
          }), balanceQuery.data ? /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            size: "xs",
            color: "secondaryText",
            weight: 500,
            children: formatTokenBalance(balanceQuery.data, true)
          }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
            width: "70px",
            height: formElements.fontSize.xs
          })]
...
const TokenButton = /* @__PURE__ */styled__default["default"](formElements.Button)(() => {
  const theme = formElements.useCustomTheme();
  return {
    ...
    gap: formElements.spacing.sm,
    paddingInline: formElements.spacing.sm,
    paddingBlock: formElements.spacing.sm,
    color: theme.colors.primaryText,
    borderRadius: formElements.radius.md,
    minWidth: "50%"
 ...
 * @internal
 */
function useSwapSupportedChains(clientId) {
  return reactQuery.useQuery({
    ...
    queryFn: async () => {
      ...
      const chains$1 = await Promise.all(chainIds.map(chains.fetchChain));
      return chains$1.filter(chain => chain !== null);
    }
  });
}
...
function SwapScreen(props) {
  ...
  const activeAddress = reactCore.useAddress();
  const supportedChainsQuery = useSwapSupportedChains(clientId || "");
  const supportedChains = supportedChainsQuery.data;

  // this should never happen
  if (!chainId || !activeWallet || !clientId || !activeAddress || !activeWalletConfig || !supportedChains) {
    return /*#__PURE__*/jsxRuntime.jsx(LoadingScreen, {});
  }
  return /*#__PURE__*/jsxRuntime.jsx(SwapScreenContent, {
    ...props,
...
function SwapScreenContent(props) {
  ...
  const switchActiveWalletChain = reactCore.useSwitchChain();
  const walletSupportedChains = reactCore.useSupportedChains();

  // prefetch chains metadata

  // screens
  const [screen, setScreen] = React.useState("main");
  const [drawerScreen, setDrawerScreen] = React.useState();
  const {
    drawerRef,
    drawerOverlayRef,
    onClose
  ...
  const [hasEditedAmount, setHasEditedAmount] = React.useState(false);
  const isChainSupported = React.useMemo(() => supportedChains.find(c => c.chainId === activeChainId), [activeChainId, supportedChains]);

  // selected chain
  const defaultChainId = isChainSupported ? activeChainId : 1;
  const [fromChainId, setFromChainId] = React.useState(defaultChainId);
  const [toChainId, setToChainId] = React.useState(defaultChainId);
  const [address, setAddress] = React.useState(activeAddress);

  // selected tokens
  const [fromToken, setFromToken] = React.useState(NATIVE_TOKEN);
  const [toToken, setToToken] = React.useState(props.supportedTokens[toChainId]?.[0] || NATIVE_TOKEN);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const fromTokenBalanceQuery = useMultiChainBalance({
    tokenAddress: isNativeToken$1(fromToken) ? undefined : fromToken.address,
    chainId: fromChainId
  });

  // when a quote is finalized ( approve sent if required or swap sent )
  // we save it here to stop refetching the quote query
  const [finalizedQuote, setFinalizedQuote] = React.useState();
  const buyWithCryptoParams = deferredTokenAmount && !finalizedQuote && !(fromChainId === toChainId && fromToken === toToken) ? {
    // wallet
    fromAddress: address,
    // from token
    fromChainId: fromChainId,
    fromTokenAddress: isNativeToken$1(fromToken) ? sdk.NATIVE_TOKEN_ADDRESS : fromToken.address,
    toChainId: toChainId,
    // to
    toTokenAddress: isNativeToken$1(toToken) ? sdk.NATIVE_TOKEN_ADDRESS : toToken.address,
    toAmount: deferredTokenAmount,
    clientId
  } : undefined;
  const buyWithCryptoQuoteQuery = reactCore.useBuyWithCryptoQuote(buyWithCryptoParams, {
  ...
  if (screen === "confirmation" && quoteToConfirm) {
    return /*#__PURE__*/jsxRuntime.jsx(ConfirmationScreen, {
      clientId: clientId,
  ...
  const estimatedSeconds = buyWithCryptoQuoteQuery.data?.swapDetails.estimated.durationSeconds;
  return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
    animate: "fadein",
    children: /*#__PURE__*/jsxRuntime.jsxs("div", {
      onClick: e => {
      ...
      children: [drawerScreen && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(DrawerOverlay, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
          ...
          y: "lg"
        }), !hasEditedAmount && /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "xl"
        }), /*#__PURE__*/jsxRuntime.jsx(BuyTokenInput, {
          value: tokenAmount,
        ...
        px: "lg",
        children: [hasEditedAmount && /*#__PURE__*/jsxRuntime.jsxs("div", {
          children: [/*#__PURE__*/jsxRuntime.jsx(PaymentSelection, {}), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "md"
          }), /*#__PURE__*/jsxRuntime.jsx(PayWithCrypto, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
              ...
              color: "accentText",
              p: "sm",
              children: [/*#__PURE__*/jsxRuntime.jsx(reactIcons.ClockIcon, {
                width: formElements.iconSize.sm,
                height: formElements.iconSize.sm
              }), buyWithCryptoQuoteQuery.isLoading ? /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
                height: formElements.fontSize.xs,
                width: "50px"
              }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
                size: "xs",
                color: "secondaryText",
                children: estimatedSeconds ? "~" + formatSeconds(estimatedSeconds) : "--"
              })]
            }), /*#__PURE__*/jsxRuntime.jsxs(FeesButton, {
              variant: "secondary",
              onClick: () => {
              ...
              children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
                ...
                flex: "row",
                center: "both",
                children: /*#__PURE__*/jsxRuntime.jsx(ViewFeeIcon, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
              ...
              y: "xxs"
            }), /*#__PURE__*/jsxRuntime.jsx(WalletSelectorButton, {
              activeAddress: activeAddress,
              activeWalletConfig: props.activeWalletConfig,
              address: address,
              activeWallet: activeWallet,
            ...
            flex: "column",
            gap: "md",
            children: isSwapQuoteError && /*#__PURE__*/jsxRuntime.jsxs("div", {
              children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
                flex: "row",
                gap: "xs",
                center: "y",
        ...
        }), switchChainRequired && /*#__PURE__*/jsxRuntime.jsx(formElements.Button, {
          fullWidth: true,
          variant: "accent",
          ...
          onClick: async () => {
            ...
            try {
              ...
              if (!walletSupportedChains.find(c => c.chainId === fromChainId)) {
                const chain = supportedChains.find(c => c.chainId === fromChainId);
                if (chain) {
                  activeWallet.updateChains([...walletSupportedChains, chain]);
                }
              }
          ...
          children: hasEditedAmount ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [isSwitching && /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
              size: "sm",
              color: "accentButtonText"
          ...
          gap: "sm",
          children: isNotEnoughBalance ? "Not Enough Funds" : "Continue"
        })]
      }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "lg"
      })]
...
function DrawerContent(props) {
  ...
  const isValidAddress = React.useMemo(() => utils.isAddress(address), [address]);
  const showError = !!address && !isValidAddress;
  return /*#__PURE__*/jsxRuntime.jsxs(DynamicHeight, {
    children: [drawerScreen === "fees" && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        size: "lg",
        color: "primaryText",
        children: "Fees"
        ...
        y: "lg"
      }), quote && /*#__PURE__*/jsxRuntime.jsx(SwapFees, {
        quote: quote,
        align: "left"
      })]
    }), drawerScreen === "address" && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        size: "lg",
        color: "primaryText",
        children: "Send to"
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(StyledInput, {
...
const StyledInput = /* @__PURE__ */styled__default["default"](formElements.Input)(() => {
  const theme = formElements.useCustomTheme();
  return {
...
function WalletSelectorButton(props) {
  return /*#__PURE__*/jsxRuntime.jsxs(AccountButton, {
    variant: "secondary",
    fullWidth: true,
    onClick: props.onClick,
    children: [props.activeAddress === props.address ? /*#__PURE__*/jsxRuntime.jsx(formElements.Img, {
      ...
      size: "sm",
      color: "primaryText",
      children: reactCore.shortenString(props.address, false)
    }), props.chevron && /*#__PURE__*/jsxRuntime.jsx(reactIcons.ChevronDownIcon, {
      width: formElements.iconSize.sm,
      height: formElements.iconSize.sm,
      style: {
        marginLeft: "auto"
...
const FeesButton = /* @__PURE__ */styled__default["default"](formElements.Button)(() => {
  const theme = formElements.useCustomTheme();
  return {
    background: "transparent",
    border: `1px solid transparent`,
...
const AccountButton = /* @__PURE__ */styled__default["default"](formElements.Button)(() => {
  const theme = formElements.useCustomTheme();
  return {
    background: theme.colors.walletSelectorButtonHoverBg,
    border: `1px solid ${theme.colors.borderColor}`,
...
function SwapTransactionsScreen(props) {
  ...
  const inMemoryPendingTxs = React.useSyncExternalStore(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  const txInfosToShow = [];
  ...
  const hidePagination = !_historyQuery.data || _historyQuery.data && !_historyQuery.data.hasNextPage && pageIndex === 0;
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    animate: "fadein",
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      p: "lg",
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        px: "lg",
        expand: true,
        children: [noTransactions && !_historyQuery.isLoading && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          flex: "column",
          gap: "md",
          center: "both",
          color: "secondaryText",
        ...
        }), noTransactions && _historyQuery.isLoading && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          flex: "row",
          center: "both",
          style: {
            minHeight: "250px"
          ...
          return /*#__PURE__*/jsxRuntime.jsx(TransactionInfo, {
            txInfo: txInfo
          }, txInfo.transactionHash);
        }), _historyQuery.isLoading && txInfosToShow.length > 0 && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
            width: "100%",
            height: "68px"
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
            width: "100%",
        ...
        p: "lg",
        children: _historyQuery.data && !hidePagination && /*#__PURE__*/jsxRuntime.jsxs("div", {
          style: {
            display: "grid",
            gridTemplateColumns: "1fr 1fr",
            gap: formElements.spacing.sm
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
            ...
            children: ["Next", /*#__PURE__*/jsxRuntime.jsx(reactIcons.ArrowRightIcon, {
              width: formElements.iconSize.sm,
              height: formElements.iconSize.sm
            })]
          })]
      ...
      p: "lg",
      children: /*#__PURE__*/jsxRuntime.jsx(ButtonLink, {
        fullWidth: true,
        variant: "accent",
 ...
 * @internal
 */
function useSwapTransactions(pageIndex) {
  const {
    clientId
  } = reactCore.useWalletContext();
  const address = reactCore.useAddress();
  const historyQuery = reactCore.useBuyWithCryptoHistory({
...
function TransactionInfo(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TxHashLink, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      center: "y",
      gap: "md",
      children: [/*#__PURE__*/jsxRuntime.jsxs(IconBox, {
        "data-box": true,
        children: [/*#__PURE__*/jsxRuntime.jsx(BuyIcon, {
          size: formElements.iconSize.sm
        }), /*#__PURE__*/jsxRuntime.jsx("div", {
          style: {
            position: "absolute",
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(CryptoIcon, {
            size: formElements.iconSize.sm
          })
        })]
      }), /*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            ...
            size: "sm",
            color: "primaryText",
            children: ["+ ", formatNumber(Number(boughtTokenAmount), 4), " ", boughtTokenSymbol]
          }), " "]
        }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "xs"
        }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            ...
            }), statusMeta.loading && /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
              size: "xs",
              color: "accentText"
            })]
          }), chainQuery.data?.name ? /*#__PURE__*/jsxRuntime.jsxs(formElements.Text, {
...
const ButtonLink = /* @__PURE__ */(() => formElements.Button.withComponent("a"))();
const IconBox = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    color: theme.colors.secondaryText,
    padding: formElements.spacing.sm,
...
const TxHashLink = /* @__PURE__ */formElements.StyledAnchor(() => {
  const theme = formElements.useCustomTheme();
  return {
    unset: "all",
    padding: formElements.spacing.sm,
...
const ConnectedWalletDetails = props => {
  const locale = formElements.useTWLocale().connectWallet;
  const chain = reactCore.useChain();
  const walletChainId = reactCore.useChainId();
  const chainQuery = useChainQuery(walletChainId);
  const swapTxs = React.useSyncExternalStore(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  ...
  const activeWallet = reactCore.useWallet();
  const activeWalletConfig = reactCore.useWalletConfig();
  const ensQuery = reactCore.useENS();
  ...
  const [overrideWalletIconUrl, setOverrideWalletIconUrl] = React.useState(undefined);
  const [screen, setScreen] = React.useState("main");
  ...
  const shortAddress = address ? reactCore.shortenString(address, false) : "";
  const addressOrENS = ensQuery.data?.ens || shortAddress;
  const avatarUrl = ensQuery.data?.avatarUrl;
  React.useEffect(() => {
    if (activeWallet) {
      if (activeWallet.walletId === wallets.walletIds.embeddedWallet) {
        activeWallet.getLastUsedAuthStrategy().then(auth => {
          if (auth === "apple") {
            setOverrideWalletIconUrl(Tooltip.appleIconUri);
          } else if (auth === "google") {
            setOverrideWalletIconUrl(Tooltip.googleIconUri);
          } else if (auth === "facebook") {
            setOverrideWalletIconUrl(Tooltip.facebookIconUri);
          } else {
            setOverrideWalletIconUrl(undefined);
          }
        });
      } else if (activeWallet.walletId === wallets.walletIds.smartWallet) {
        setOverrideWalletIconUrl(Tooltip.smartWalletIcon);
      } else {
        setOverrideWalletIconUrl(undefined);
      }
    } else {
  ...
  const networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      color: "primaryText",
      multiline: true,
      children: chain?.name || chainQuery.data?.name || `chain #${walletChainId}`
  ...
  let content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
      y: "xl"
    }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      px: "lg",
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Img, {
        ...
        weight: 500,
        size: "sm",
        children: [" ", balanceQuery.data ? Number(balanceQuery.data.displayValue).toFixed(3) : /*#__PURE__*/jsxRuntime.jsx(formElements.Skeleton, {
          height: "1em",
          width: "100px"
      ...
      px: "lg",
      children: [/*#__PURE__*/jsxRuntime.jsx(ConnectedToSmartWallet, {}), /*#__PURE__*/jsxRuntime.jsx(EmbeddedWalletDetails, {}), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        style: {
          display: "grid",
          gridTemplateColumns: `repeat(${buttonsToShow}, 1fr)`,
          gap: formElements.spacing.sm
        },
        children: [props.hideSendButton !== true && /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
          variant: "outline",
          style: {
            fontSize: formElements.fontSize.sm,
            display: "flex",
        ...
        }), props.hideReceiveButton !== true && /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
          variant: "outline",
          style: {
            fontSize: formElements.fontSize.sm,
            display: "flex",
        ...
        }), props.hideBuyButton !== true && /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
          variant: "outline",
          style: {
            fontSize: formElements.fontSize.sm,
            display: "flex",
    ...
    }), buttonsToShow === 0 ? null : /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
      y: "md"
    }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      px: "md",
      children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        children: [networkSwitcherButton, /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
          onClick: () => {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(reactIcons.TextAlignJustifyIcon, {
            width: formElements.iconSize.md,
            height: formElements.iconSize.md
          }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            flex: "row",
            ...
            }), pendingSwapTxs && pendingSwapTxs.length > 0 && /*#__PURE__*/jsxRuntime.jsx(BadgeCount, {
              children: pendingSwapTxs.length
            })]
          })]
        }), personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && /*#__PURE__*/jsxRuntime.jsx(WalletSwitcher, {
          wallet: personalWallet,
          name: locale.personalWallet
        }), wrapperWalletConfig && wrapperWallet && /*#__PURE__*/jsxRuntime.jsx(WalletSwitcher, {
          name: wrapperWallet.walletId === wallets.walletIds.smartWallet ? locale.smartWallet : wrapperWalletConfig.meta.name,
          wallet: wrapperWallet
        }), isActuallyMetaMask && activeWalletConfig && activeWalletConfig.isInstalled && activeWalletConfig.isInstalled() && !coinbaseWallet.isMobile() && /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
          type: "button",
          onClick: () => {
        ...
        }), showFaucet && (chain?.faucets && chain.faucets.length > 0 || chain?.chainId === chains.Localhost.chainId) && /*#__PURE__*/jsxRuntime.jsxs(MenuLink, {
        ...
        }), activeWallet?.walletId === wallets.walletIds.localWallet && /*#__PURE__*/jsxRuntime.jsx("div", {
        ...
        }), props.detailsModalFooter && /*#__PURE__*/jsxRuntime.jsx(props.detailsModalFooter, {
          close: () => setIsOpen(false)
        })]
      }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "md"
      })]
    }), props.hideDisconnect !== true && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Line, {}), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        px: "md",
        children: /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(reactIcons.ExitIcon, {
            width: formElements.iconSize.md,
            height: formElements.iconSize.md
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            color: "primaryText",
    ...
    }), activeWallet?.walletId === wallets.walletIds.localWallet && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Line, {}), /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        py: "md",
        children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
          size: "xs",
  ...
  if (screen === "network-switcher") {
    content = /*#__PURE__*/jsxRuntime.jsx(NetworkSelectorContent, {
      open: true,
      theme: props.theme,
      chains: chains$1,
    ...
    content = /*#__PURE__*/jsxRuntime.jsx(ExportLocalWallet, {
      modalSize: "compact",
    ...
    content = /*#__PURE__*/jsxRuntime.jsx(SendFunds, {
    ...
    content = /*#__PURE__*/jsxRuntime.jsx(SwapTransactionsScreen, {
      onBack: () => setScreen("main")
    });
  }
  ...
  // swap tokens
    ...
    content = /*#__PURE__*/jsxRuntime.jsx(SwapScreen, {
      onBack: () => setScreen("main"),
      supportedTokens: props.supportedTokens,
      onViewPendingTx: () => setScreen("pending-tx")
    });
  } else if (screen === "receive") {
    content = /*#__PURE__*/jsxRuntime.jsx(ReceiveFunds, {
...
const WalletInfoButton = /* @__PURE__ */formElements.StyledButton(() => {
  const theme = formElements.useCustomTheme();
  return {
    all: "unset",
...
const MenuButton = /* @__PURE__ */formElements.StyledButton(() => {
  const theme = formElements.useCustomTheme();
  return {
    all: "unset",
    padding: `${formElements.spacing.sm} ${formElements.spacing.sm}`,
...
const StyledChevronRightIcon = /* @__PURE__ */styled__default["default"]( reactIcons.ChevronRightIcon)(() => {
  const theme = formElements.useCustomTheme();
  return {
    color: theme.colors.secondaryText
  };
...
const ActiveDot = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    width: "8px",
    height: "8px",
...
function ConnectedToSmartWallet() {
  ...
  const address = reactCore.useAddress();
  const locale = formElements.useTWLocale().connectWallet;
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = React.useState(false);
  React.useEffect(() => {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    flex: "row",
    gap: "xxs",
    center: "both",
    children: [/*#__PURE__*/jsxRuntime.jsx(ActiveDot, {}), locale.connectedToSmartWallet]
  });
  if (chain && address && activeWallet?.walletId === wallets.walletIds.smartWallet) {
    return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [isSmartWalletDeployed ? /*#__PURE__*/jsxRuntime.jsx(formElements.Link, {
        color: "secondaryText",
...
function EmbeddedWalletDetails() {
  ...
  if (emailQuery.data || phoneNumberQuery.data) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      center: "x",
      style: {
        paddingBottom: formElements.spacing.md
      },
      children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
        size: "sm",
        children: emailQuery.data || phoneNumberQuery.data
      })
    });
  }
  return undefined;
}
const BadgeCount = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
...
const SignatureScreen = _ref => {
  ...
  const locale = formElements.useTWLocale().connectWallet.signatureScreen;
  ...
  const disconnect = reactCore.useDisconnect();
  const isSafeWallet = wallet?.walletId === wallets.walletIds.safe;
  const chainId = reactCore.useChainId();
  const address = reactCore.useAddress();
  const safeChainSlug = chainId && chainId in coinbaseWallet.safeChainIdToSlug ? coinbaseWallet.safeChainIdToSlug[chainId] : undefined;
  ...
  if (walletConfig?.isHeadless) {
    return /*#__PURE__*/jsxRuntime.jsx(HeadlessSignIn, {
      signIn: signIn,
      status: status
    });
  }
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      style: {
        paddingTop: 0,
        paddingBottom: formElements.spacing.xl
      },
      flex: "column",
      px: modalSize === "compact" ? "lg" : "xxl",
      center: "y",
      expand: true,
      children: status === "idle" ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          flex: "row",
          center: "x",
          animate: "fadein",
          py: "3xl",
          children: /*#__PURE__*/jsxRuntime.jsx(PulsatingContainer, {
            children: /*#__PURE__*/jsxRuntime.jsx(formElements.Img, {
        ...
        children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          py: "3xl",
          children: /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.WalletLogoSpinner, {
            error: status === "failed",
          ...
          }), status === "signing" && /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            center: true,
            multiline: true,
            balance: true,
            children: isSafeWallet ? /*#__PURE__*/jsxRuntime.jsx(SafeWalletInstruction, {}) : /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
              children: locale.signingScreen.prompt
            })
          }), isSafeWallet && status === "signing" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              y: "sm"
            }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
              fullWidth: true,
              ...
              children: [" ", locale.signingScreen.approveTransactionInSafe, /*#__PURE__*/jsxRuntime.jsx(reactIcons.ExternalLinkIcon, {
                width: formElements.iconSize.sm,
                height: formElements.iconSize.sm
              })]
            })]
          }), status === "failed" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              y: "sm"
            }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
              fullWidth: true,
    ...
    }), (termsOfServiceUrl || privacyPolicyUrl) && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      p: "md",
      animate: "fadein",
      children: /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.TOS, {
...
function SafeWalletInstruction() {
  const locale = formElements.useTWLocale().connectWallet.signatureScreen.signingScreen;
  const {
    getWalletConfig
  } = reactCore.useWalletContext();
  const wallet = reactCore.useWallet();
  ...
  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: isSafePersonalWalletHeadless ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
...
function HeadlessSignIn(_ref2) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      ...
      children: [status === "signing" && /*#__PURE__*/jsxRuntime.jsx(formElements.Spinner, {
        size: "xl",
        color: "accentText"
      }), status === "failed" && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
        children: /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "lg"
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            ...
            center: true,
            color: "danger",
            children: locale.signingScreen.failedToSignIn
          }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
            y: "lg"
          }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Button, {
            fullWidth: true,
...
`;
const PulsatingContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    position: "relative",
    "&::before": {
...
function ConnectWallet(props) {
  const activeWallet = reactCore.useWallet();
  const contextTheme = formElements.useCustomTheme();
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.CustomThemeProvider, {
    theme: theme,
    children: [/*#__PURE__*/jsxRuntime.jsx(Modal, {
      size: "compact",
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
        modalSize: "compact",
      ...
      if (!activeWallet) {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(AnimatedButton, {
          ...
          onClick: () => {
            ...
            if (!formElements.canFitWideModal() || walletConfigs.length === 1) {
              modalSize = "compact";
            }
            setModalConfig({
      ...
      // sign in button
        ...
        return /*#__PURE__*/jsxRuntime.jsx(formElements.Button, {
          variant: "primary",
          onClick: () => {
            if (activeWallet) {
...
const AnimatedButton = /* @__PURE__ */styled__default["default"](formElements.Button)({
  animation: `${formElements.fadeInAnimation} 300ms ease`
});
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        ...
        y: "lg"
      }), /*#__PURE__*/jsxRuntime.jsx(formElements.Link, {
        target: "_blank",
        center: true,
      ...
      gap: "lg",
      children: /*#__PURE__*/jsxRuntime.jsxs("div", {
        children: [showTOS && /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.TOS, {
          termsOfServiceUrl: termsOfServiceUrl,
          privacyPolicyUrl: privacyPolicyUrl
        }), showThirdwebBranding !== false && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          style: {
            paddingTop: formElements.spacing.xl
          },
          children: /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.PoweredByThirdweb, {})
        })]
      })
    })]
  });
...
`;
const GlobalContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    color: theme.colors.accentText,
...
const ConnectModalContent = props => {
  ...
  const authConfig = reactCore.useThirdwebAuthContext();
  const [handleConnectedPending, setIsHandleConnectedPending] = React.useState(false);
  const handleConnected = React.useCallback(_wallet => {
    if (onConnect) {
      onConnect(_wallet);
    }
    ...
    if (requiresSignIn) {
      setScreen(formElements.reservedScreens.signIn);
    }
  ...
  const walletList = /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.WalletSelector, {
    title: title,
  ...
  const signatureScreen = /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
    onDone: onClose,
    modalSize: modalSize,
    termsOfServiceUrl: modalConfig.termsOfServiceUrl,
    privacyPolicyUrl: modalConfig.privacyPolicyUrl
  });
  return /*#__PURE__*/jsxRuntime.jsx(formElements.ScreenSetupContext.Provider, {
    ...
    children: isWideModal ? /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === formElements.reservedScreens.signIn && signatureScreen, screen === formElements.reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
          children: getStarted
      ...
      children: [screen === formElements.reservedScreens.signIn && signatureScreen, screen === formElements.reservedScreens.main && walletList, screen === formElements.reservedScreens.getStarted && getStarted, typeof screen !== "string" && getWalletUI(screen)]
    })
  });
};
const ConnectModal = () => {
  ...
  const screenSetup = formElements.useSetupScreen();
  const {
    screen,
    setScreen,
    initialScreen
  ...
  const onHide = React.useCallback(() => setHideModal(true), []);
  const onShow = React.useCallback(() => setHideModal(false), []);
  return /*#__PURE__*/jsxRuntime.jsx(formElements.CustomThemeProvider, {
    theme: theme,
    children: /*#__PURE__*/jsxRuntime.jsx(Modal, {
      hide: hideModal,
...
const LeftContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    display: "flex",
    flexDirection: "column",
...
function ConnectEmbed(props) {
  ...
  const walletUIStatesProps = {
    theme: props.theme || contextTheme || formElements.defaultTheme,
    modalSize: "compact",
    title: undefined,
    termsOfServiceUrl: props.termsOfServiceUrl,
    privacyPolicyUrl: props.privacyPolicyUrl,
  ...
  if (show) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
      ...walletUIStatesProps,
      children: /*#__PURE__*/jsxRuntime.jsxs(formElements.CustomThemeProvider, {
        theme: walletUIStatesProps.theme,
        children: [/*#__PURE__*/jsxRuntime.jsx(ConnectEmbedContent, {
          ...props,
          onConnect: props.onConnect
        }), /*#__PURE__*/jsxRuntime.jsx(SyncedWalletUIStates, {
          ...walletUIStatesProps
        })]
      })
    });
...
const ConnectEmbedContent = props => {
  ...
  React.useEffect(() => {
    if (requiresSignIn && screen === formElements.reservedScreens.main) {
      setScreen(formElements.reservedScreens.signIn);
    }
  ...
  if (isAutoConnecting || connectionStatus === "unknown") {
    content = /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      flex: "column",
      center: "both",
      style: {
        minHeight: "300px"
    ...
    content = /*#__PURE__*/jsxRuntime.jsx(ConnectModalContent, {
      screenSetup: screenSetup,
      isOpen: true,
      onClose: () => {
        setScreen(initialScreen);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(EmbedContainer, {
    className: props.className,
    style: {
      height: "auto",
      maxWidth: formElements.modalMaxWidthCompact,
      ...props.style
    },
    children: /*#__PURE__*/jsxRuntime.jsxs(DynamicHeight, {
      children: [" ", content, " "]
    })
  });
};
function SyncedWalletUIStates(props) {
  ...
  React.useEffect(() => {
    setModalConfig(c => ({
      ...
      modalSize: (!formElements.canFitWideModal() ? "compact" : props.modalSize) || "wide",
      termsOfServiceUrl: props.termsOfServiceUrl,
      privacyPolicyUrl: props.privacyPolicyUrl,
      welcomeScreen: props.welcomeScreen,
  ...
  }, [props.title, props.theme, props.modalSize, props.termsOfServiceUrl, props.privacyPolicyUrl, props.welcomeScreen, props.titleIconUrl, setModalConfig, locale.connectWallet.defaultModalTitle, props.showThirdwebBranding]);
  return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
    ...props
  });
}
const EmbedContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    color: theme.colors.primaryText,
    background: theme.colors.modalBg,
...
const ConnectModalInline = props => {
  const walletConfigs = reactCore.useWallets();
  const modalSize = !formElements.canFitWideModal() || walletConfigs.length === 1 ? "compact" : props.modalSize;
  const ctxTheme = formElements.useCustomTheme();
  const walletUIStatesProps = {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(formElements.CustomThemeProvider, {
      theme: walletUIStatesProps.theme,
      children: [/*#__PURE__*/jsxRuntime.jsx(ConnectModalInlineContent, {
        className: props.className,
        modalSize: modalSize
      }), /*#__PURE__*/jsxRuntime.jsx(SyncedWalletUIStates, {
        ...walletUIStatesProps
...
function ConnectModalInlineContent(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ConnectModalInlineContainer, {
    className: props.className,
    style: {
      height: props.modalSize === "compact" ? "auto" : formElements.wideModalMaxHeight,
      maxWidth: props.modalSize === "compact" ? formElements.modalMaxWidthCompact : formElements.modalMaxWidthWide,
      ...props.style
    },
...
const ConnectModalInlineContainer = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
    background: theme.colors.modalBg,
    color: theme.colors.primaryText,
...
const ModelViewer = /* @__PURE__ */React.lazy(() => Promise.resolve().then(function () { return require('./ModelViewer-5faddc56.cjs.prod.js'); }));
...
const VideoPlayer = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Video_Player(_ref2, ref) {
  let {
    src,
    alt,
    poster,
...
const AudioPlayer = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Audio_Player(_ref3, ref) {
  let {
    src,
    alt,
    poster,
...
const IframePlayer = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Iframe_Player(_ref4, ref) {
  let {
    src,
    alt,
    poster,
...
const LinkPlayer = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Link_Player(_ref5, ref) {
  let {
    src,
    alt,
    style,
 ...
 * ```
 */
const MediaRenderer = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Media_Renderer(_ref6, ref) {
  let {
    src,
    poster,
    alt,
 ...
 * Apply custom CSS styles to the button using an inline style.
 */
const ThirdwebNftMedia = /* @__PURE__ */(() => /*#__PURE__*/React__default["default"].forwardRef(function Thirdweb_NftMedia(_ref, ref) {
  let {
    metadata,
    width = "300px",
    height = "300px",
...
`;
const PopoverContent = /* @__PURE__ */(() => styled__default["default"](RXPopover__namespace.Content)(() => {
  const theme = formElements.useCustomTheme();
  return {
    borderRadius: formElements.radius.sm,
    padding: `${formElements.spacing.sm} ${formElements.spacing.md}`,
    backgroundColor: theme.colors.tooltipBg,
    boxShadow: formElements.shadow.md,
...
const PopoverArrow = /* @__PURE__ */(() => styled__default["default"](RXPopover__namespace.Arrow)(() => {
  const theme = formElements.useCustomTheme();
  return {
...
const signerWallet = signer => {
  return {
    ...
    create: options => new wallets.SignerWallet({
      ...options,
      signer
    })
  };
...
function getAnalyticsGlobals() {
  if (typeof globalThis === "undefined") {
    return {
      ...
      x_sdk_os: coinbaseWallet.detectOS(),
      app_bundle_id: undefined
    };
  }
  if (globalThis.X_SDK_NAME === undefined) {
    globalThis.X_SDK_NAME = packageJson.name;
    globalThis.X_SDK_PLATFORM = "browser";
    globalThis.X_SDK_VERSION = packageJson.version;
    globalThis.X_SDK_OS = coinbaseWallet.detectOS();
...
const ThirdwebProvider = props => {
  ...
  getAnalyticsGlobals();
  const wallets$1 = supportedWallets || coinbaseWallet.defaultWallets;
  const theme = _theme || "dark";
  const signerWalletConfig = React.useMemo(() => signer ? signerWallet(signer) : undefined, [signer]);

  // preload the embeddedWallet SDK if present in supportedWallets
  const ewsRef = React.useRef(false);
  React.useEffect(() => {
    if (ewsRef.current) {
      return;
    }
    ...
    const preloadEmbeddedWallet = async () => {
      const hasEmbeddedWallet = wallets$1.find(w => w.id === wallets.walletIds.embeddedWallet);
      if (hasEmbeddedWallet && restProps.clientId) {
        // TODO only preload the iframe instead of creating the SDK
        const {
          EmbeddedWalletSdk
        } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/wallets')); });
  ...
  }, [restProps.clientId, wallets$1]);
  return /*#__PURE__*/jsxRuntime.jsx(formElements.ThirdwebLocaleContext.Provider, {
    value: restProps.locale || formElements.en(),
    children: /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
      theme: theme,
      children: /*#__PURE__*/jsxRuntime.jsx(formElements.CustomThemeProvider, {
        theme: theme,
        children: /*#__PURE__*/jsxRuntime.jsxs(reactCore.ThirdwebProviderCore, {
          ...restProps,
          theme: typeof theme === "string" ? theme : theme.type,
          supportedWallets: wallets$1,
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-46fceacf.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-46fceacf.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async options => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-46fceacf.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-46fceacf.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-e31b92ab.cjs.prod.js'); });
...
function useBloctoWallet() {
  ...
  return React.useCallback(async options => {
    const {
      bloctoWallet
    } = await Promise.resolve().then(function () { return require('./bloctoWallet-136abd18.cjs.prod.js'); });
...
const useEmbeddedWalletSendVerificationEmail = () => {
  const context = reactCore.useWalletContext();
  const sendVerificationEmail = React.useCallback(async email => {
    if (!context.clientId) {
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-b65bee17.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-1855361a.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-46fceacf.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
...
const oneKeyWallet = options => {
  return {
    ...
    create: walletOptions => {
      const wallet = new wallets.OneKeyWallet({
        ...walletOptions,
...
function isInstalled() {
  return !!wallets.getInjectedOneKeyProvider();
}
function ConnectUI(props) {
  const locale = formElements.useTWLocale();
  return /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.ExtensionOrWCConnectionUI, {
...
exports.oneKeyWallet = oneKeyWallet;
...
exports.useEmbeddedWalletSendVerificationEmail = useEmbeddedWalletSendVerificationEmail;
exports.useEmbeddedWalletUserEmail = useEmbeddedWalletUserEmail;
