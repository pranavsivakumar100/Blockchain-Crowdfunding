...
class IFrameWallet {
    ...
    async getUserWalletStatus() {
        ...
        if (userStatus.status === type_js_1.UserWalletStatus.LOGGED_IN_WALLET_INITIALIZED) {
            return {
        ...
        if (userStatus.status === type_js_1.UserWalletStatus.LOGGED_IN_NEW_DEVICE) {
            return {
                status: type_js_1.UserWalletStatus.LOGGED_IN_WALLET_UNINITIALIZED,
                ...userStatus.user,
            };
        }
        if (userStatus.status === type_js_1.UserWalletStatus.LOGGED_IN_WALLET_UNINITIALIZED) {
            return {
                status: type_js_1.UserWalletStatus.LOGGED_IN_WALLET_UNINITIALIZED,
                ...userStatus.user,
            };
...
exports.IFrameWallet = IFrameWallet;
