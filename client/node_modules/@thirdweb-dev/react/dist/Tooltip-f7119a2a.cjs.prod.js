...
function CountrySelector(_ref) {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/wallets/evm/connectors/embedded-wallet/implementations')); });
...
const Option = /* @__PURE__ */formElements.StyledOption(() => {
...
const Select = /* @__PURE__ */formElements.StyledSelect(() => {
  const theme = formElements.useCustomTheme();
  return {
...
function InputSelectionUI(props) {
  const [countryCodeInfo, setCountryCodeInfo] = React.useState("US +1");
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [props.format === "phone" && /*#__PURE__*/jsxRuntime.jsx(CountrySelector, {
...
exports.genericTokenIcon = genericTokenIcon;
